...
import { List, Button, Group, Label } from "plugins/@fuse-labs/core-ui";
import Popover from "plugins/@fuse-labs/core-ui/components/shared/Popover/Popover";
...
export default function SerialPortListItem({
  ...
  const deviceDisplayText = useMemo(_ => {
  ...
  return <List.Item>
    ...
    <div className="flex items-center">
      <Popover>
        ...
        <Popover.Content align="end" side="bottom" sideOffset={5} className="min-w-[300px]">
