...
import { Group, Label} from "plugins/@fuse-labs/core-ui"
...
import DeviceProfilesList from "../DeviceProfilesList/DevicesProfilesList"

export default function DeviceProfilePicker({
  ...props
}) {
  return <DeviceProfilesList itemComponent={DeviceProfileListItem} />
}
