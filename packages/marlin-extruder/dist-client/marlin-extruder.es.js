...
import { ChevronRightIcon, CaretDownIcon, ChevronDownIcon, QuestionMarkCircledIcon, CheckIcon, ChevronLeftIcon, ReloadIcon } from "@radix-ui/react-icons";
import classNames from "classnames";
import * as s$3 from "react";
import s__default, { createContext as createContext$1, forwardRef, createElement, useContext, useState, useRef, useEffect, useMemo } from "react";
import e$4 from "react-dom";
function useCallbackRef$1(r2) {
  const t2 = s$3.useRef(r2);
  return s$3.useEffect(() => {
    t2.current = r2;
  }), s$3.useMemo(() => (...e2) => {
    var r3;
...
function useComposedRefs(...e2) {
  return s$3.useCallback(composeRefs(...e2), e2);
}
function _extends$4() {
...
const Slot = /* @__PURE__ */ s$3.forwardRef((e2, o2) => {
  const _a = e2, { children: a2 } = _a, s2 = __objRest(_a, ["children"]);
  return s$3.Children.toArray(a2).some(l$4) ? /* @__PURE__ */ s$3.createElement(s$3.Fragment, null, s$3.Children.map(a2, (e3) => l$4(e3) ? /* @__PURE__ */ s$3.createElement(n$8, _extends$4({}, s2, { ref: o2 }), e3.props.children) : e3)) : /* @__PURE__ */ s$3.createElement(n$8, _extends$4({}, s2, { ref: o2 }), a2);
});
Slot.displayName = "Slot";
const n$8 = /* @__PURE__ */ s$3.forwardRef((r2, n2) => {
  const _a = r2, { children: l2 } = _a, a2 = __objRest(_a, ["children"]);
  return s$3.isValidElement(l2) ? /* @__PURE__ */ s$3.cloneElement(l2, __spreadProps(__spreadValues({}, o$4(a2, l2.props)), { ref: composeRefs(n2, l2.ref) })) : s$3.Children.count(l2) > 1 ? s$3.Children.only(null) : null;
});
n$8.displayName = "SlotClone";
const Slottable = ({ children: e2 }) => /* @__PURE__ */ s$3.createElement(s$3.Fragment, null, e2);
function l$4(e2) {
  return s$3.isValidElement(e2) && e2.type === Slottable;
}
function o$4(e2, t2) {
...
const Primitive = ["a", "button", "div", "h2", "h3", "img", "li", "nav", "ol", "p", "span", "svg", "ul"].reduce((o2, i2) => __spreadProps(__spreadValues({}, o2), { [i2]: /* @__PURE__ */ s$3.forwardRef((o3, m2) => {
  const _a = o3, { asChild: a2 } = _a, s2 = __objRest(_a, ["asChild"]), n2 = a2 ? Slot : i2;
  return s$3.useEffect(() => {
    window[Symbol.for("radix-ui")] = true;
  }, []), /* @__PURE__ */ s$3.createElement(n2, _extends$4({}, s2, { ref: m2 }));
}) }), {});
...
const useLayoutEffect = Boolean(globalThis === null || globalThis === void 0 ? void 0 : globalThis.document) ? s$3.useLayoutEffect : () => {
};
const r$4 = s$3["useId".toString()] || (() => {
});
let n$7 = 0;
function useId(o2) {
  const [u2, i2] = s$3.useState(r$4());
  return useLayoutEffect(() => {
    o2 || i2((t2) => t2 != null ? t2 : String(n$7++));
  }, [o2]), o2 || (u2 ? `radix-${u2}` : "");
}
function createContext(t2, n2) {
  const o2 = /* @__PURE__ */ s$3.createContext(n2);
  function r2(t3) {
    const _a = t3, { children: n3 } = _a, r3 = __objRest(_a, ["children"]), c2 = s$3.useMemo(() => r3, Object.values(r3));
    return s$3.createElement(o2.Provider, { value: c2 }, n3);
  }
  return r2.displayName = t2 + "Provider", [r2, function(r3) {
    const c2 = s$3.useContext(o2);
    if (c2)
      return c2;
    if (n2 !== void 0)
      return n2;
...
function createContextScope(n2, o2 = []) {
  let r2 = [];
  const c2 = () => {
    const t2 = r2.map((t3) => /* @__PURE__ */ s$3.createContext(t3));
    return function(o3) {
      const r3 = (o3 == null ? void 0 : o3[n2]) || t2;
      return s$3.useMemo(() => ({ [`__scope${n2}`]: __spreadProps(__spreadValues({}, o3), { [n2]: r3 }) }), [o3, r3]);
    };
  };
  return c2.scopeName = n2, [function(t2, o3) {
    const c3 = /* @__PURE__ */ s$3.createContext(o3), u2 = r2.length;
    function s2(t3) {
      const _a = t3, { scope: o4, children: r3 } = _a, s3 = __objRest(_a, ["scope", "children"]), i2 = (o4 == null ? void 0 : o4[n2][u2]) || c3, a2 = s$3.useMemo(() => s3, Object.values(s3));
      return s$3.createElement(i2.Provider, { value: a2 }, r3);
    }
    return r2 = [...r2, o3], s2.displayName = t2 + "Provider", [s2, function(r3, s3) {
      const i2 = (s3 == null ? void 0 : s3[n2][u2]) || c3, a2 = s$3.useContext(i2);
      if (a2)
        return a2;
      if (o3 !== void 0)
        return o3;
...
function t$4(...t2) {
  ...
  const o2 = () => {
    ...
    return function(t3) {
      ...
      return s$3.useMemo(() => ({ [`__scope${n2.scopeName}`]: r2 }), [r2]);
    };
  };
...
const f$9 = { bubbles: false, cancelable: true }, [p$7, l$3, m$8] = createCollection("RovingFocusGroup"), [d$5, v$3] = createContextScope("RovingFocusGroup", [m$8]);
const [g$8, F$1] = d$5("RovingFocusGroup");
const RovingFocusGroup = /* @__PURE__ */ s$3.forwardRef((e2, o2) => /* @__PURE__ */ s$3.createElement(p$7.Provider, { scope: e2.__scopeRovingFocusGroup }, /* @__PURE__ */ s$3.createElement(p$7.Slot, { scope: e2.__scopeRovingFocusGroup }, /* @__PURE__ */ s$3.createElement(w$5, _extends$4({}, e2, { ref: o2 })))));
const w$5 = /* @__PURE__ */ s$3.forwardRef((t2, n2) => {
  const _a = t2, { __scopeRovingFocusGroup: c2, orientation: p2, dir: m2 = "ltr", loop: d2 = false, currentTabStopId: v2, defaultCurrentTabStopId: F2, onCurrentTabStopIdChange: w2, onEntryFocus: b2 } = _a, x2 = __objRest(_a, ["__scopeRovingFocusGroup", "orientation", "dir", "loop", "currentTabStopId", "defaultCurrentTabStopId", "onCurrentTabStopIdChange", "onEntryFocus"]), E2 = s$3.useRef(null), I2 = useComposedRefs(n2, E2), [G2 = null, h] = useControllableState({ prop: v2, defaultProp: F2, onChange: w2 }), [T2, A2] = s$3.useState(false), y2 = useCallbackRef$1(b2), D2 = l$3(c2), S2 = s$3.useRef(false);
  return s$3.useEffect(() => {
    const e2 = E2.current;
    if (e2)
      return e2.addEventListener("rovingFocusGroup.onEntryFocus", y2), () => e2.removeEventListener("rovingFocusGroup.onEntryFocus", y2);
  }, [y2]), /* @__PURE__ */ s$3.createElement(g$8, { scope: c2, orientation: p2, dir: m2, loop: d2, currentTabStopId: G2, onItemFocus: s$3.useCallback((e2) => h(e2), [h]), onItemShiftTab: s$3.useCallback(() => A2(true), []) }, /* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({ tabIndex: T2 ? -1 : 0, "data-orientation": p2 }, x2, { ref: I2, style: __spreadValues({ outline: "none" }, t2.style), onMouseDown: composeEventHandlers(t2.onMouseDown, () => {
    S2.current = true;
  }), onFocus: composeEventHandlers(t2.onFocus, (e2) => {
    const o2 = !S2.current;
    if (e2.target === e2.currentTarget && o2 && !T2) {
      const o3 = new Event("rovingFocusGroup.onEntryFocus", f$9);
      if (e2.currentTarget.dispatchEvent(o3), !o3.defaultPrevented) {
        const e3 = D2().filter((e4) => e4.focusable);
        R$4([e3.find((e4) => e4.active), e3.find((e4) => e4.id === G2), ...e3].filter(Boolean).map((e4) => e4.ref.current));
      }
    }
    S2.current = false;
  }), onBlur: composeEventHandlers(t2.onBlur, () => A2(false)) })));
});
const RovingFocusGroupItem = /* @__PURE__ */ s$3.forwardRef((e2, o2) => {
  ...
  return s$3.createElement(p$7.ItemSlot, { scope: n2, id: m2, focusable: i2, active: c2 }, /* @__PURE__ */ s$3.createElement(Primitive.span, _extends$4({ tabIndex: v2 ? 0 : -1, "data-orientation": d2.orientation }, f2, { ref: o2, onMouseDown: composeEventHandlers(e2.onMouseDown, (e3) => {
    ...
    const o3 = function(e4, o4, r3) {
      ...
      return o4 === "vertical" && ["ArrowLeft", "ArrowRight"].includes(t3) || o4 === "horizontal" && ["ArrowUp", "ArrowDown"].includes(t3) ? void 0 : b$4[t3];
...
const b$4 = { ArrowLeft: "prev", ArrowUp: "prev", ArrowRight: "next", ArrowDown: "next", PageUp: "first", Home: "first", PageDown: "last", End: "last" };
function R$4(e2) {
...
const Root$8 = RovingFocusGroup;
const Item$2 = RovingFocusGroupItem;
function useSize(r2) {
  const [i2, t2] = s$3.useState(void 0);
  return s$3.useEffect(() => {
    if (r2) {
...
function usePrevious(r2) {
  const u2 = s$3.useRef({ value: r2, previous: r2 });
  return s$3.useMemo(() => (u2.current.value !== r2 && (u2.current.previous = u2.current.value, u2.current.value = r2), u2.current.previous), [r2]);
}
function useDirection(t2, n2) {
  const [r2, o2] = s$3.useState("ltr"), [i2, u2] = s$3.useState(), c2 = s$3.useRef(0);
  return s$3.useEffect(() => {
    if (n2 === void 0 && t2 != null && t2.parentElement) {
      const e2 = getComputedStyle(t2.parentElement);
      u2(e2);
    }
  }, [t2, n2]), s$3.useEffect(() => (n2 === void 0 && function e2() {
...
const m$7 = ["PageUp", "PageDown"], f$8 = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"], p$6 = { ltr: ["ArrowDown", "Home", "ArrowLeft", "PageDown"], rtl: ["ArrowDown", "Home", "ArrowRight", "PageDown"] }, [S$2, h$6, v$2] = createCollection("Slider"), [w$4, g$7] = createContextScope("Slider", [v$2]);
const [x$4, b$3] = w$4("Slider");
const Slider$1 = /* @__PURE__ */ s$3.forwardRef((e2, t2) => {
  const _a = e2, { name: n2, min: r2 = 0, max: o2 = 100, step: a2 = 1, orientation: d2 = "horizontal", disabled: p2 = false, minStepsBetweenThumbs: h = 0, defaultValue: v2 = [r2], value: w2, onValueChange: g2 = () => {
  } } = _a, b2 = __objRest(_a, ["name", "min", "max", "step", "orientation", "disabled", "minStepsBetweenThumbs", "defaultValue", "value", "onValueChange"]), [E2, y2] = s$3.useState(null), _2 = useComposedRefs(t2, (e3) => y2(e3)), M2 = s$3.useRef(/* @__PURE__ */ new Set()), K2 = s$3.useRef(0), T2 = d2 === "horizontal", k2 = !E2 || Boolean(E2.closest("form")), C2 = T2 ? R$3 : D$3, [I2 = [], z2] = useControllableState({ prop: w2, defaultProp: v2, onChange: (e3) => {
    var t3;
  ...
  function A2(e3, t3) {
    ...
    z2((e4 = []) => {
      ...
      return function(e5, t4) {
        ...
        return true;
      }(n4, h * a2) ? (K2.current = n4.indexOf(l2), String(n4) === String(e4) ? e4 : n4) : e4;
    });
  }
  return s$3.createElement(x$4, { scope: e2.__scopeSlider, disabled: p2, min: r2, max: o2, valueIndexToChangeRef: K2, thumbs: M2.current, values: I2, orientation: d2 }, /* @__PURE__ */ s$3.createElement(S$2.Provider, { scope: e2.__scopeSlider }, /* @__PURE__ */ s$3.createElement(S$2.Slot, { scope: e2.__scopeSlider }, /* @__PURE__ */ s$3.createElement(C2, _extends$4({ "aria-disabled": p2, "data-disabled": p2 ? "" : void 0 }, b2, { ref: _2, min: r2, max: o2, onSlideStart: p2 ? void 0 : function(e3) {
    ...
    if (!p2) {
      const n3 = m$7.includes(e3.key) || e3.shiftKey && f$8.includes(e3.key) ? 10 : 1, r3 = K2.current;
      A2(I2[r3] + a2 * n3 * t3, r3);
    }
  } })))), k2 && I2.map((e3, t3) => /* @__PURE__ */ s$3.createElement(P$2, { key: t3, name: n2 ? n2 + (I2.length > 1 ? "[]" : "") : void 0, value: e3 })));
});
const [E$2, y$2] = w$4("Slider", { startEdge: "left", endEdge: "right", size: "width", direction: 1 }), R$3 = /* @__PURE__ */ s$3.forwardRef((e2, t2) => {
  const _a = e2, { min: n2, max: r2, dir: i2, onSlideStart: a2, onSlideMove: d2, onStepKeyDown: s2 } = _a, m2 = __objRest(_a, ["min", "max", "dir", "onSlideStart", "onSlideMove", "onStepKeyDown"]), [f2, S2] = s$3.useState(null), h = useComposedRefs(t2, (e3) => S2(e3)), v2 = s$3.useRef(), w2 = useDirection(f2, i2), g2 = w2 === "ltr";
  function x2(e3) {
    const t3 = v2.current || f2.getBoundingClientRect(), o2 = T$2([0, t3.width], g2 ? [n2, r2] : [r2, n2]);
    return v2.current = t3, o2(e3 - t3.left);
  }
  return s$3.createElement(E$2, { scope: e2.__scopeSlider, startEdge: g2 ? "left" : "right", endEdge: g2 ? "right" : "left", direction: g2 ? 1 : -1, size: "width" }, /* @__PURE__ */ s$3.createElement(_$1, _extends$4({ "data-orientation": "horizontal" }, m2, { ref: h, style: __spreadProps(__spreadValues({}, m2.style), { "--radix-slider-thumb-transform": "translateX(-50%)" }), onSlideStart: (e3) => {
    ...
    const t3 = p$6[w2].includes(e3.key);
    s2 == null || s2({ event: e3, direction: t3 ? -1 : 1 });
  } })));
}), D$3 = /* @__PURE__ */ s$3.forwardRef((e2, t2) => {
  const _a = e2, { min: n2, max: r2, onSlideStart: o2, onSlideMove: i2, onStepKeyDown: a2 } = _a, d2 = __objRest(_a, ["min", "max", "onSlideStart", "onSlideMove", "onStepKeyDown"]), s2 = s$3.useRef(null), m2 = useComposedRefs(t2, s2), f2 = s$3.useRef();
  function S2(e3) {
    const t3 = f2.current || s2.current.getBoundingClientRect(), o3 = T$2([0, t3.height], [r2, n2]);
    return f2.current = t3, o3(e3 - t3.top);
  }
  return s$3.createElement(E$2, { scope: e2.__scopeSlider, startEdge: "bottom", endEdge: "top", size: "height", direction: 1 }, /* @__PURE__ */ s$3.createElement(_$1, _extends$4({ "data-orientation": "vertical" }, d2, { ref: m2, style: __spreadProps(__spreadValues({}, d2.style), { "--radix-slider-thumb-transform": "translateY(50%)" }), onSlideStart: (e3) => {
    ...
    const t3 = p$6.ltr.includes(e3.key);
    a2 == null || a2({ event: e3, direction: t3 ? -1 : 1 });
  } })));
}), _$1 = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeSlider: r2, onSlideStart: o2, onSlideMove: i2, onSlideEnd: a2, onHomeKeyDown: l2, onEndKeyDown: s2, onStepKeyDown: p2 } = _a, S2 = __objRest(_a, ["__scopeSlider", "onSlideStart", "onSlideMove", "onSlideEnd", "onHomeKeyDown", "onEndKeyDown", "onStepKeyDown"]), h = b$3("Slider", r2);
  return s$3.createElement(Primitive.span, _extends$4({}, S2, { ref: n2, onKeyDown: composeEventHandlers(e2.onKeyDown, (e3) => {
    e3.key === "Home" ? (l2(e3), e3.preventDefault()) : e3.key === "End" ? (s2(e3), e3.preventDefault()) : m$7.concat(f$8).includes(e3.key) && (p2(e3), e3.preventDefault());
  }), onPointerDown: composeEventHandlers(e2.onPointerDown, (e3) => {
    const t2 = e3.target;
    t2.setPointerCapture(e3.pointerId), e3.preventDefault(), h.thumbs.has(t2) ? t2.focus() : o2(e3);
...
const SliderTrack = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeSlider: r2 } = _a, o2 = __objRest(_a, ["__scopeSlider"]), i2 = b$3("SliderTrack", r2);
  return s$3.createElement(Primitive.span, _extends$4({ "data-disabled": i2.disabled ? "" : void 0, "data-orientation": i2.orientation }, o2, { ref: n2 }));
});
const SliderRange = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeSlider: r2 } = _a, o2 = __objRest(_a, ["__scopeSlider"]), i2 = b$3("SliderRange", r2), a2 = y$2("SliderRange", r2), d2 = s$3.useRef(null), s2 = useComposedRefs(n2, d2), m2 = i2.values.length, f2 = i2.values.map((e3) => K$1(e3, i2.min, i2.max)), p2 = m2 > 1 ? Math.min(...f2) : 0, S2 = 100 - Math.max(...f2);
  return s$3.createElement(Primitive.span, _extends$4({ "data-orientation": i2.orientation, "data-disabled": i2.disabled ? "" : void 0 }, o2, { ref: s2, style: __spreadProps(__spreadValues({}, e2.style), { [a2.startEdge]: p2 + "%", [a2.endEdge]: S2 + "%" }) }));
});
const SliderThumb = /* @__PURE__ */ s$3.forwardRef((e2, t2) => {
  const n2 = h$6(e2.__scopeSlider), [r2, o2] = s$3.useState(null), i2 = useComposedRefs(t2, (e3) => o2(e3)), a2 = s$3.useMemo(() => r2 ? n2().findIndex((e3) => e3.ref.current === r2) : -1, [n2, r2]);
  return s$3.createElement(M$1, _extends$4({}, e2, { ref: i2, index: a2 }));
});
const M$1 = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  const _a = e2, { __scopeSlider: o2, index: i2 } = _a, a2 = __objRest(_a, ["__scopeSlider", "index"]), s2 = b$3("SliderThumb", o2), m2 = y$2("SliderThumb", o2), [f2, p2] = s$3.useState(null), h = useComposedRefs(r2, (e3) => p2(e3)), v2 = useSize(f2), w2 = s2.values[i2], g2 = w2 === void 0 ? 0 : K$1(w2, s2.min, s2.max), x2 = function(e3, t2) {
    ...
    const r3 = e3 / 2, o3 = T$2([0, 50], [0, r3]);
  ...
  }, [f2, s2.thumbs]), /* @__PURE__ */ s$3.createElement("span", { style: { transform: "var(--radix-slider-thumb-transform)", position: "absolute", [m2.startEdge]: `calc(${g2}% + ${R2}px)` } }, /* @__PURE__ */ s$3.createElement(S$2.ItemSlot, { scope: e2.__scopeSlider }, /* @__PURE__ */ s$3.createElement(Primitive.span, _extends$4({ role: "slider", "aria-label": e2["aria-label"] || x2, "aria-valuemin": s2.min, "aria-valuenow": w2, "aria-valuemax": s2.max, "aria-orientation": s2.orientation, "data-orientation": s2.orientation, "data-disabled": s2.disabled ? "" : void 0, tabIndex: s2.disabled ? void 0 : 0 }, a2, { ref: h, style: w2 === void 0 ? { display: "none" } : e2.style, onFocus: composeEventHandlers(e2.onFocus, () => {
    s2.valueIndexToChangeRef.current = i2;
  }) }))));
}), P$2 = (e2) => {
  const _a = e2, { value: t2 } = _a, n2 = __objRest(_a, ["value"]), o2 = s$3.useRef(null), i2 = usePrevious(t2);
  return s$3.useEffect(() => {
  ...
  }, [i2, t2]), /* @__PURE__ */ s$3.createElement("input", _extends$4({ style: { display: "none" } }, n2, { ref: o2, defaultValue: t2 }));
};
...
const Root$7 = Slider$1;
const Track = SliderTrack;
const Range = SliderRange;
const Thumb = SliderThumb;
const [i$6, a$2] = createContext("Label", { id: void 0, controlRef: { current: null } });
const Label$1 = /* @__PURE__ */ s$3.forwardRef((o2, a2) => {
  const _a = o2, { htmlFor: c2, id: u2 } = _a, s2 = __objRest(_a, ["htmlFor", "id"]), d2 = s$3.useRef(null), f2 = s$3.useRef(null), m2 = useComposedRefs(a2, f2), b2 = useId(u2);
  return s$3.useEffect(() => {
    if (c2) {
  ...
  }, [b2, c2]), /* @__PURE__ */ s$3.createElement(i$6, { id: b2, controlRef: d2 }, /* @__PURE__ */ s$3.createElement(Primitive.span, _extends$4({ role: "label", id: b2 }, s2, { ref: m2, onMouseDown: (e2) => {
    var t2;
 ...
 */
var b$2 = typeof Symbol === "function" && Symbol.for, c$4 = b$2 ? Symbol.for("react.element") : 60103, d$4 = b$2 ? Symbol.for("react.portal") : 60106, e$3 = b$2 ? Symbol.for("react.fragment") : 60107, f$7 = b$2 ? Symbol.for("react.strict_mode") : 60108, g$6 = b$2 ? Symbol.for("react.profiler") : 60114, h$5 = b$2 ? Symbol.for("react.provider") : 60109, k$1 = b$2 ? Symbol.for("react.context") : 60110, l$2 = b$2 ? Symbol.for("react.async_mode") : 60111, m$6 = b$2 ? Symbol.for("react.concurrent_mode") : 60111, n$6 = b$2 ? Symbol.for("react.forward_ref") : 60112, p$5 = b$2 ? Symbol.for("react.suspense") : 60113, q$3 = b$2 ? Symbol.for("react.suspense_list") : 60120, r$3 = b$2 ? Symbol.for("react.memo") : 60115, t$3 = b$2 ? Symbol.for("react.lazy") : 60116, v$1 = b$2 ? Symbol.for("react.block") : 60121, w$3 = b$2 ? Symbol.for("react.fundamental") : 60117, x$3 = b$2 ? Symbol.for("react.responder") : 60118, y$1 = b$2 ? Symbol.for("react.scope") : 60119;
function z$1(a2) {
...
reactIs_production_min.ForwardRef = n$6;
...
reactIs_production_min.isValidElementType = function(a2) {
  return typeof a2 === "string" || typeof a2 === "function" || a2 === e$3 || a2 === m$6 || a2 === g$6 || a2 === f$7 || a2 === p$5 || a2 === q$3 || typeof a2 === "object" && a2 !== null && (a2.$$typeof === t$3 || a2.$$typeof === r$3 || a2.$$typeof === h$5 || a2.$$typeof === k$1 || a2.$$typeof === n$6 || a2.$$typeof === w$3 || a2.$$typeof === x$3 || a2.$$typeof === y$1 || a2.$$typeof === v$1);
};
...
var SideCar$1 = function(_a) {
  ...
  return s$3.createElement(Target, __assign({}, rest));
};
...
var RemoveScroll = s$3.forwardRef(function(props, parentRef) {
  var ref = s$3.useRef(null);
  var _a = s$3.useState({
  ...
  return s$3.createElement(s$3.Fragment, null, enabled && s$3.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref }), forwardProps ? s$3.cloneElement(s$3.Children.only(children), __assign$1({}, containerProps, { ref: containerRef })) : s$3.createElement(Container, __assign$1({}, containerProps, { className, ref: containerRef }), children));
});
...
var RemoveScrollBar = function(props) {
  var _a = s$3.useState(getGapWidth(props.gapMode)), gap = _a[0], setGap = _a[1];
  s$3.useEffect(function() {
    setGap(getGapWidth(props.gapMode));
  }, [props.gapMode]);
  var noRelative = props.noRelative, noImportant = props.noImportant, _b = props.gapMode, gapMode = _b === void 0 ? "margin" : _b;
  return s$3.createElement(Style, { styles: getStyles(gap, !noRelative, gapMode, !noImportant ? "!important" : "") });
};
...
function RemoveScrollSideCar(props) {
  var shouldPreventQueue = s$3.useRef([]);
  var touchStartRef = s$3.useRef([0, 0]);
  var activeAxis = s$3.useRef();
  var id = s$3.useState(idCounter++)[0];
  var Style2 = s$3.useState(function() {
    return styleSingleton();
  })[0];
  var lastProps = s$3.useRef(props);
  s$3.useEffect(function() {
  ...
  var shouldCancelEvent = s$3.useCallback(function(event, parent) {
  ...
  var shouldPrevent = s$3.useCallback(function(_event) {
    var event = _event;
  ...
  var shouldCancel = s$3.useCallback(function(name, delta, target, should) {
  ...
  var scrollTouchStart = s$3.useCallback(function(event) {
    touchStartRef.current = getTouchXY(event);
    activeAxis.current = void 0;
  }, []);
  var scrollWheel = s$3.useCallback(function(event) {
    shouldCancel(event.type, getDeltaXY(event), event.target, shouldCancelEvent(event, props.lockRef.current));
  }, []);
  var scrollTouchMove = s$3.useCallback(function(event) {
  ...
  return s$3.createElement(s$3.Fragment, null, inert ? s$3.createElement(Style2, { styles: generateStyle(id) }) : null, removeScrollBar ? s$3.createElement(RemoveScrollBar, { gapMode: "margin" }) : null);
}
var SideCar = exportSidecar(effectCar, RemoveScrollSideCar);
var ReactRemoveScroll = s$3.forwardRef(function(props, ref) {
  return s$3.createElement(RemoveScroll, __assign$1({}, props, { ref, sideCar: SideCar }));
});
...
const Presence = (u2) => {
  const { present: o2, children: i2 } = u2, s2 = function(n2) {
    const [u3, o3] = s$3.useState(), i3 = s$3.useRef({}), s3 = s$3.useRef(n2), c3 = s$3.useRef("none"), a3 = n2 ? "mounted" : "unmounted", [d2, m2] = function(e2, n3) {
      return s$3.useReducer((e3, t2) => {
        const r2 = n3[e3][t2];
    ...
    return s$3.useEffect(() => {
      ...
      m2("ANIMATION_END");
    }, [u3, m2]), { isPresent: ["mounted", "unmountSuspended"].includes(d2), ref: s$3.useCallback((e2) => {
      e2 && (i3.current = getComputedStyle(e2)), o3(e2);
    }, []) };
  }(o2), c2 = typeof i2 == "function" ? i2({ present: s2.isPresent }) : s$3.Children.only(i2), a2 = useComposedRefs(s2.ref, c2.ref);
  return typeof i2 == "function" || s2.isPresent ? /* @__PURE__ */ s$3.cloneElement(c2, { ref: a2 }) : null;
};
function r$2(e2) {
  return (e2 == null ? void 0 : e2.animationName) || "none";
}
Presence.displayName = "Presence";
const Portal = /* @__PURE__ */ s$3.forwardRef((a2, i2) => {
  var n2, d2;
  const _a = a2, { containerRef: s2, style: u2 } = _a, c2 = __objRest(_a, ["containerRef", "style"]), m2 = (n2 = s2 == null ? void 0 : s2.current) !== null && n2 !== void 0 ? n2 : globalThis === null || globalThis === void 0 || (d2 = globalThis.document) === null || d2 === void 0 ? void 0 : d2.body, [, f2] = s$3.useState({});
  return useLayoutEffect(() => {
    f2({});
  }, []), m2 ? /* @__PURE__ */ e$4.createPortal(/* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({ "data-radix-portal": "" }, c2, { ref: i2, style: m2 === document.body ? __spreadValues({ position: "absolute", top: 0, left: 0, zIndex: 2147483647 }, u2) : void 0 })), m2) : null;
});
const c$3 = { bubbles: false, cancelable: true };
const FocusScope = /* @__PURE__ */ s$3.forwardRef((i2, f2) => {
  const _a = i2, { loop: l2 = false, trapped: m2 = false, onMountAutoFocus: p2, onUnmountAutoFocus: v2 } = _a, E2 = __objRest(_a, ["loop", "trapped", "onMountAutoFocus", "onUnmountAutoFocus"]), [F2, S2] = s$3.useState(null), b2 = useCallbackRef$1(p2), T2 = useCallbackRef$1(v2), y2 = s$3.useRef(null), L2 = useComposedRefs(f2, (e2) => S2(e2)), h = s$3.useRef({ paused: false, pause() {
    this.paused = true;
  }, resume() {
    this.paused = false;
  } }).current;
    ...
    if (F2) {
      ...
      return () => {
        F2.removeEventListener("focusScope.autoFocusOnMount", b2), setTimeout(() => {
          ...
          F2.addEventListener("focusScope.autoFocusOnUnmount", T2), F2.dispatchEvent(e3), e3.defaultPrevented || a$1(t2 != null ? t2 : document.body, { select: true }), F2.removeEventListener("focusScope.autoFocusOnUnmount", T2), d$3.remove(h);
        }, 0);
      };
    }
    var e2;
  }, [F2, b2, T2, h]);
  const N = s$3.useCallback((e2) => {
    if (!l2 && !m2)
      return;
    if (h.paused)
      return;
    ...
    if (t2 && n2) {
      const t3 = e2.currentTarget, [o2, u2] = function(e3) {
        const t4 = r$1(e3), n3 = s$2(t4, e3), o3 = s$2(t4.reverse(), e3);
        return [n3, o3];
      }(t3);
  ...
  return s$3.createElement(Primitive.div, _extends$4({ tabIndex: -1 }, E2, { ref: L2, onKeyDown: N }));
});
function r$1(e2) {
...
const u$1 = /* @__PURE__ */ s$3.createContext({ layers: /* @__PURE__ */ new Set(), layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(), branches: /* @__PURE__ */ new Set() });
const DismissableLayer = /* @__PURE__ */ s$3.forwardRef((l2, m2) => {
  const _a = l2, { disableOutsidePointerEvents: f2 = false, onEscapeKeyDown: p2, onPointerDownOutside: v2, onFocusOutside: b2, onInteractOutside: E2, onDismiss: y2 } = _a, w2 = __objRest(_a, ["disableOutsidePointerEvents", "onEscapeKeyDown", "onPointerDownOutside", "onFocusOutside", "onInteractOutside", "onDismiss"]), h = s$3.useContext(u$1), [D2, x2] = s$3.useState(null), [, C2] = s$3.useState({}), L2 = useComposedRefs(m2, (e2) => x2(e2)), P2 = Array.from(h.layers), [O2] = [...h.layersWithOutsidePointerEventsDisabled].slice(-1), g2 = P2.indexOf(O2), B2 = D2 ? P2.indexOf(D2) : -1, R2 = h.layersWithOutsidePointerEventsDisabled.size > 0, F2 = B2 >= g2, S2 = function(e2) {
    const n2 = useCallbackRef$1(e2), r2 = s$3.useRef(false);
    return s$3.useEffect(() => {
      const e3 = (e4) => {
...
const Separator$1 = /* @__PURE__ */ s$3.forwardRef((n2, a2) => {
  const _a = n2, { decorative: p2, orientation: l2 = e$2 } = _a, c2 = __objRest(_a, ["decorative", "orientation"]), s2 = i$4(l2) ? l2 : e$2, u2 = p2 ? { role: "none" } : { "aria-orientation": s2 === "vertical" ? s2 : void 0, role: "separator" };
  return s$3.createElement(Primitive.div, _extends$4({ "data-orientation": s2 }, u2, c2, { ref: a2 }));
});
function i$4(r2) {
...
Separator$1.propTypes = { orientation(r2, o2, t2) {
  ...
  return n2 && !i$4(n2) ? new Error(function(r3, o3) {
...
function getPlacementData({ anchorRect: p2, popperSize: c2, arrowSize: f2, arrowOffset: l2 = 0, side: d2, sideOffset: h = 0, align: x2, alignOffset: g2 = 0, shouldAvoidCollisions: u2 = true, collisionBoundariesRect: w2, collisionTolerance: m2 = 0 }) {
  ...
  if (u2 === false) {
    const t2 = e(b2);
    let o2 = n$3;
    f2 && (o2 = i$3({ popperSize: c2, arrowSize: f2, arrowOffset: l2, side: d2, align: x2 }));
  ...
  var O2, z2;
  const R2 = s$1(S2, $), M2 = y2[a(d2)][x2], D2 = function(t2, e2, r2) {
    const o2 = a(t2);
    return e2[t2] && !r2[o2] ? o2 : t2;
  }(d2, R2, s$1(DOMRect.fromRect(__spreadValues(__spreadValues({}, c2), M2)), $)), A2 = function(t2, e2, r2, o2, n2) {
  ...
  let C2 = n$3;
  f2 && (C2 = i$3({ popperSize: c2, arrowSize: f2, arrowOffset: l2, side: D2, align: A2 }));
...
function i$3({ popperSize: t2, arrowSize: e2, arrowOffset: r2, side: o2, align: n2 }) {
  const i2 = (t2.width - e2.width) / 2, a2 = (t2.height - e2.width) / 2, s2 = { top: 0, right: 90, bottom: 180, left: -90 }[o2], c2 = Math.max(e2.width, e2.height), f2 = { width: `${c2}px`, height: `${c2}px`, transform: `rotate(${s2}deg)`, willChange: "transform", position: "absolute", [o2]: "100%", direction: p$4(o2, n2) };
...
const [c, l$1] = createContextScope("Popper");
const [f$5, d$1] = c("Popper");
const Popper = (e2) => {
  const { __scopePopper: o2, children: r2 } = e2, [t2, n2] = s$3.useState(null);
  return s$3.createElement(f$5, { scope: o2, anchor: t2, onAnchorChange: n2 }, r2);
};
const PopperAnchor = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  const _a = e2, { __scopePopper: t2, virtualRef: n2 } = _a, p2 = __objRest(_a, ["__scopePopper", "virtualRef"]), c2 = d$1("PopperAnchor", t2), l2 = s$3.useRef(null), f2 = useComposedRefs(r2, l2);
  return s$3.useEffect(() => {
    c2.onAnchorChange((n2 == null ? void 0 : n2.current) || l2.current);
  }), n2 ? null : /* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({}, p2, { ref: f2 }));
});
const [u, m$5] = c("PopperContent");
const PopperContent = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopePopper: c2, side: l2 = "bottom", sideOffset: f2, align: m2 = "center", alignOffset: w2, collisionTolerance: h, avoidCollisions: x2 = true } = _a, v2 = __objRest(_a, ["__scopePopper", "side", "sideOffset", "align", "alignOffset", "collisionTolerance", "avoidCollisions"]), P2 = d$1("PopperContent", c2), [A2, g2] = s$3.useState(), E2 = useRect(P2.anchor), [y2, C2] = s$3.useState(null), S2 = useSize(y2), [R2, O2] = s$3.useState(null), _2 = useSize(R2), b2 = useComposedRefs(n2, (e3) => C2(e3)), z2 = function() {
    const [e3, o2] = s$3.useState(void 0);
    return s$3.useEffect(() => {
      let e4;
      function r2() {
  ...
  return s$3.createElement("div", { style: k2, "data-radix-popper-content-wrapper": "" }, /* @__PURE__ */ s$3.createElement(u, { scope: c2, arrowStyles: L2, onArrowChange: O2, onArrowOffsetChange: g2 }, /* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({ "data-side": B2, "data-align": D2 }, v2, { style: __spreadProps(__spreadValues({}, v2.style), { animation: H2 ? void 0 : "none" }), ref: b2 }))));
});
const Root$4 = Popper;
const Anchor$1 = PopperAnchor;
const Content$3 = PopperContent;
const x$2 = ["Enter", " "], b$1 = ["ArrowUp", "PageDown", "End"], R$2 = ["ArrowDown", "PageUp", "Home", ...b$1], y = { ltr: ["ArrowLeft"], rtl: ["ArrowRight"] }, [I, k, P$1] = createCollection("Menu"), [D$2, S$1] = createContextScope("Menu", [P$1, l$1, v$3]);
const O$1 = l$1(), T$1 = v$3(), [L$1, A$2] = D$2("Menu");
const Menu = (e2) => {
  const { __scopeMenu: n2, open: o2 = false, children: u2, onOpenChange: c2, modal: i2 = true } = e2, s2 = O$1(n2), [l2, d2] = s$3.useState(null), p2 = s$3.useRef(false), f2 = useCallbackRef$1(c2), m2 = useDirection(l2, e2.dir);
  return s$3.useEffect(() => {
    const e3 = () => {
  ...
  }, []), /* @__PURE__ */ s$3.createElement(Root$4, s2, /* @__PURE__ */ s$3.createElement(L$1, { scope: n2, isSubmenu: false, isUsingKeyboardRef: p2, dir: m2, open: o2, onOpenChange: f2, content: l2, onContentChange: d2, onRootClose: s$3.useCallback(() => f2(false), [f2]), modal: i2 }, u2));
};
const MenuSub = (n2) => {
  const { __scopeMenu: r2, children: o2, open: u2 = false, onOpenChange: c2 } = n2, i2 = A$2("MenuSub", r2), s2 = O$1(r2), [l2, d2] = s$3.useState(null), [p2, f2] = s$3.useState(null), m2 = useCallbackRef$1(c2);
  return s$3.useEffect(() => (i2.open === false && m2(false), () => m2(false)), [i2.open, m2]), /* @__PURE__ */ s$3.createElement(Root$4, s2, /* @__PURE__ */ s$3.createElement(L$1, { scope: r2, isSubmenu: true, isUsingKeyboardRef: i2.isUsingKeyboardRef, dir: i2.dir, open: u2, onOpenChange: m2, content: p2, onContentChange: f2, onRootClose: i2.onRootClose, contentId: useId(), trigger: l2, onTriggerChange: d2, triggerId: useId(), modal: false }, o2));
};
const MenuAnchor = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeMenu: t2 } = _a, r2 = __objRest(_a, ["__scopeMenu"]), o2 = O$1(t2);
  return s$3.createElement(Anchor$1, _extends$4({}, o2, r2, { ref: n2 }));
});
const [F, K] = D$2("MenuContent");
const MenuContent$1 = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { forceMount: t2 } = _a, r2 = __objRest(_a, ["forceMount"]), o2 = A$2("MenuContent", e2.__scopeMenu);
  return s$3.createElement(I.Provider, { scope: e2.__scopeMenu }, /* @__PURE__ */ s$3.createElement(Presence, { present: t2 || o2.open }, /* @__PURE__ */ s$3.createElement(I.Slot, { scope: e2.__scopeMenu }, o2.isSubmenu ? /* @__PURE__ */ s$3.createElement(X, _extends$4({}, r2, { ref: n2 })) : /* @__PURE__ */ s$3.createElement(G, _extends$4({}, r2, { ref: n2 })))));
});
const G = /* @__PURE__ */ s$3.forwardRef((e2, n2) => A$2("MenuContent", e2.__scopeMenu).modal ? /* @__PURE__ */ s$3.createElement(U, _extends$4({}, e2, { ref: n2 })) : /* @__PURE__ */ s$3.createElement(V, _extends$4({}, e2, { ref: n2 }))), U = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const t2 = A$2("MenuContent", e2.__scopeMenu), r2 = s$3.useRef(null), o2 = useComposedRefs(n2, r2);
  return s$3.useEffect(() => {
    const e3 = r2.current;
    if (e3)
      return hideOthers(e3);
  }, []), /* @__PURE__ */ s$3.createElement(B, _extends$4({}, e2, { ref: o2, trapFocus: t2.open, disableOutsidePointerEvents: t2.open, disableOutsideScroll: true, onFocusOutside: composeEventHandlers(e2.onFocusOutside, (e3) => e3.preventDefault(), { checkForDefaultPrevented: false }), onDismiss: () => t2.onOpenChange(false) }));
}), V = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const t2 = A$2("MenuContent", e2.__scopeMenu);
  return s$3.createElement(B, _extends$4({}, e2, { ref: n2, trapFocus: false, disableOutsidePointerEvents: false, disableOutsideScroll: false, onDismiss: () => t2.onOpenChange(false) }));
}), X = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const t2 = A$2("MenuContent", e2.__scopeMenu), r2 = s$3.useRef(null), o2 = useComposedRefs(n2, r2);
  return t2.isSubmenu ? /* @__PURE__ */ s$3.createElement(B, _extends$4({ id: t2.contentId, "aria-labelledby": t2.triggerId }, e2, { ref: o2, align: "start", side: t2.dir === "rtl" ? "left" : "right", portalled: true, disableOutsidePointerEvents: false, disableOutsideScroll: false, trapFocus: false, onOpenAutoFocus: (e3) => {
    var n3;
...
}), B = /* @__PURE__ */ s$3.forwardRef((e2, t2) => {
  const _a = e2, { __scopeMenu: r2, loop: u2 = false, trapFocus: i2, onOpenAutoFocus: s2, onCloseAutoFocus: l2, disableOutsidePointerEvents: f2, onEscapeKeyDown: v2, onPointerDownOutside: g2, onFocusOutside: h, onInteractOutside: x2, onDismiss: _2, disableOutsideScroll: y2, allowPinchZoom: I2, portalled: P2 } = _a, D2 = __objRest(_a, ["__scopeMenu", "loop", "trapFocus", "onOpenAutoFocus", "onCloseAutoFocus", "disableOutsidePointerEvents", "onEscapeKeyDown", "onPointerDownOutside", "onFocusOutside", "onInteractOutside", "onDismiss", "disableOutsideScroll", "allowPinchZoom", "portalled"]), S2 = A$2("MenuContent", r2), L2 = O$1(r2), K2 = T$1(r2), G2 = k(r2), [U2, V2] = s$3.useState(null), X2 = s$3.useRef(null), B2 = useComposedRefs(t2, X2, S2.onContentChange), Y2 = s$3.useRef(0), Z = s$3.useRef(""), z2 = s$3.useRef(0), H2 = s$3.useRef(null), W = s$3.useRef("right"), q2 = s$3.useRef(0), N = P2 ? Portal : s$3.Fragment, Q = y2 ? o$3 : s$3.Fragment, $ = y2 ? { allowPinchZoom: I2 } : void 0, ee = (e3) => {
    var n2, t3;
  ...
  s$3.useEffect(() => () => window.clearTimeout(Y2.current), []), useFocusGuards();
  const ne = s$3.useCallback((e3) => {
    var n2, t3;
  ...
  return s$3.createElement(N, null, /* @__PURE__ */ s$3.createElement(Q, $, /* @__PURE__ */ s$3.createElement(F, { scope: r2, searchRef: Z, onItemEnter: s$3.useCallback((e3) => {
    ne(e3) && e3.preventDefault();
  }, [ne]), onItemLeave: s$3.useCallback((e3) => {
    var n2;
    ne(e3) || ((n2 = X2.current) === null || n2 === void 0 || n2.focus(), V2(null));
  }, [ne]), onTriggerLeave: s$3.useCallback((e3) => {
    ne(e3) && e3.preventDefault();
  }, [ne]), pointerGraceTimerRef: z2, onPointerGraceIntentChange: s$3.useCallback((e3) => {
    H2.current = e3;
  }, []) }, /* @__PURE__ */ s$3.createElement(FocusScope, { asChild: true, trapped: i2, onMountAutoFocus: composeEventHandlers(s2, (e3) => {
    var n2;
    e3.preventDefault(), (n2 = X2.current) === null || n2 === void 0 || n2.focus();
  }), onUnmountAutoFocus: l2 }, /* @__PURE__ */ s$3.createElement(DismissableLayer, { asChild: true, disableOutsidePointerEvents: f2, onEscapeKeyDown: v2, onPointerDownOutside: g2, onFocusOutside: h, onInteractOutside: x2, onDismiss: _2 }, /* @__PURE__ */ s$3.createElement(Root$8, _extends$4({ asChild: true }, K2, { dir: S2.dir, orientation: "vertical", loop: u2, currentTabStopId: U2, onCurrentTabStopIdChange: V2, onEntryFocus: (e3) => {
    S2.isUsingKeyboardRef.current || e3.preventDefault();
  } }), /* @__PURE__ */ s$3.createElement(Content$3, _extends$4({ role: "menu", "aria-orientation": "vertical", "data-state": j(S2.open), dir: S2.dir }, L2, D2, { ref: B2, style: __spreadValues({ outline: "none" }, D2.style), onKeyDown: composeEventHandlers(D2.onKeyDown, (e3) => {
...
const MenuItem = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { disabled: t2 = false, onSelect: r2 } = _a, o2 = __objRest(_a, ["disabled", "onSelect"]), u2 = s$3.useRef(null), c2 = A$2("MenuItem", e2.__scopeMenu), a2 = K("MenuItem", e2.__scopeMenu), i2 = useComposedRefs(n2, u2), s2 = s$3.useRef(false);
  return s$3.createElement(Y, _extends$4({}, o2, { ref: i2, disabled: t2, onClick: composeEventHandlers(e2.onClick, () => {
    const e3 = u2.current;
    if (!t2 && e3) {
    ...
    t2 || n3 && e3.key === " " || x$2.includes(e3.key) && (e3.currentTarget.click(), e3.preventDefault());
  }) }));
});
const Y = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeMenu: t2, disabled: r2 = false, textValue: u2 } = _a, c2 = __objRest(_a, ["__scopeMenu", "disabled", "textValue"]), a2 = K("MenuItem", t2), i2 = T$1(t2), l2 = s$3.useRef(null), d2 = useComposedRefs(n2, l2), [p2, f2] = s$3.useState("");
  return s$3.useEffect(() => {
    const e3 = l2.current;
    var n3;
    e3 && f2(((n3 = e3.textContent) !== null && n3 !== void 0 ? n3 : "").trim());
  }, [c2.children]), /* @__PURE__ */ s$3.createElement(I.ItemSlot, { scope: t2, disabled: r2, textValue: u2 != null ? u2 : p2 }, /* @__PURE__ */ s$3.createElement(Item$2, _extends$4({ asChild: true }, i2, { focusable: !r2 }), /* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({ role: "menuitem", "aria-disabled": r2 || void 0, "data-disabled": r2 ? "" : void 0 }, c2, { ref: d2, onPointerMove: composeEventHandlers(e2.onPointerMove, J((e3) => {
    if (r2)
      a2.onItemLeave(e3);
...
D$2("MenuRadioGroup", { value: void 0, onValueChange: () => {
} });
D$2("MenuItemIndicator", { checked: false });
function j(e2) {
...
const [s, i$2] = createContextScope("DropdownMenu", [S$1]);
const l = S$1(), [m$4, w$2] = s("DropdownMenu");
const DropdownMenu = (e2) => {
  const { __scopeDropdownMenu: n2, children: r2, open: p2, defaultOpen: d2, onOpenChange: a2 } = e2, s2 = M("DropdownMenu", n2), i2 = l(n2), [w2 = false, D2] = useControllableState({ prop: p2, defaultProp: d2, onChange: a2 }), g2 = s$3.useCallback(() => D2((e3) => !e3), [D2]);
  return s2.isInsideContent ? /* @__PURE__ */ s$3.createElement(m$4, { scope: n2, isRootMenu: false, open: w2, onOpenChange: D2, onOpenToggle: g2 }, /* @__PURE__ */ s$3.createElement(Sub, _extends$4({}, i2, { open: w2, onOpenChange: D2 }), r2)) : /* @__PURE__ */ s$3.createElement(f$4, _extends$4({}, e2, { open: w2, onOpenChange: D2, onOpenToggle: g2 }), r2);
};
const f$4 = (n2) => {
  const { __scopeDropdownMenu: r2, children: t2, dir: p2, open: d2, onOpenChange: a2, onOpenToggle: s2, modal: i2 = true } = n2, w2 = l(r2), f2 = s$3.useRef(null);
  return s$3.createElement(m$4, { scope: r2, isRootMenu: true, triggerId: useId(), triggerRef: f2, contentId: useId(), open: d2, onOpenChange: a2, onOpenToggle: s2, modal: i2 }, /* @__PURE__ */ s$3.createElement(Root$3, _extends$4({}, w2, { open: d2, onOpenChange: a2, dir: p2, modal: i2 }), t2));
};
const DropdownMenuTrigger = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeDropdownMenu: t2, disabled: p2 = false } = _a, s2 = __objRest(_a, ["__scopeDropdownMenu", "disabled"]), i2 = w$2("DropdownMenuTrigger", t2), m2 = l(t2);
  return i2.isRootMenu ? /* @__PURE__ */ s$3.createElement(Anchor, _extends$4({ asChild: true }, m2), /* @__PURE__ */ s$3.createElement(Primitive.button, _extends$4({ type: "button", id: i2.triggerId, "aria-haspopup": "menu", "aria-expanded": !!i2.open || void 0, "aria-controls": i2.open ? i2.contentId : void 0, "data-state": i2.open ? "open" : "closed", "data-disabled": p2 ? "" : void 0, disabled: p2 }, s2, { ref: composeRefs(n2, i2.triggerRef), onPointerDown: composeEventHandlers(e2.onPointerDown, (e3) => {
    p2 || e3.button !== 0 || e3.ctrlKey !== false || (i2.open || e3.preventDefault(), i2.onOpenToggle());
  }), onKeyDown: composeEventHandlers(e2.onKeyDown, (e3) => {
    p2 || (["Enter", " "].includes(e3.key) && i2.onOpenToggle(), e3.key === "ArrowDown" && i2.onOpenChange(true), [" ", "ArrowDown"].includes(e3.key) && e3.preventDefault());
  }) }))) : null;
});
const [D$1, M] = s("DropdownMenuContent", { isInsideContent: false });
const DropdownMenuContent = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeDropdownMenu: r2 } = _a, t2 = __objRest(_a, ["__scopeDropdownMenu"]), p2 = w$2("DropdownMenuContent", r2), d2 = l(r2), a2 = __spreadProps(__spreadValues({}, t2), { style: __spreadProps(__spreadValues({}, e2.style), { "--radix-dropdown-menu-content-transform-origin": "var(--radix-popper-transform-origin)" }) });
  return s$3.createElement(D$1, { scope: r2, isInsideContent: true }, p2.isRootMenu ? /* @__PURE__ */ s$3.createElement(g$5, _extends$4({ __scopeDropdownMenu: r2 }, a2, { ref: n2 })) : /* @__PURE__ */ s$3.createElement(Content$2, _extends$4({}, d2, a2, { ref: n2 })));
});
const g$5 = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeDropdownMenu: r2, portalled: t2 = true } = _a, p2 = __objRest(_a, ["__scopeDropdownMenu", "portalled"]), d2 = w$2("DropdownMenuContent", r2), s2 = l(r2), i2 = s$3.useRef(false);
  return d2.isRootMenu ? /* @__PURE__ */ s$3.createElement(Content$2, _extends$4({ id: d2.contentId, "aria-labelledby": d2.triggerId }, s2, p2, { ref: n2, portalled: t2, onCloseAutoFocus: composeEventHandlers(e2.onCloseAutoFocus, (e3) => {
    var o2;
    i2.current || (o2 = d2.triggerRef.current) === null || o2 === void 0 || o2.focus(), i2.current = false, e3.preventDefault();
  }), onInteractOutside: composeEventHandlers(e2.onInteractOutside, (e3) => {
    const o2 = e3.detail.originalEvent, n3 = o2.button === 0 && o2.ctrlKey === true, r3 = o2.button === 2 || n3;
    d2.modal && !r3 || (i2.current = true);
  }) })) : null;
});
const DropdownMenuItem = /* @__PURE__ */ s$3.forwardRef((e2, n2) => {
  const _a = e2, { __scopeDropdownMenu: r2 } = _a, t2 = __objRest(_a, ["__scopeDropdownMenu"]), p2 = l(r2);
  return s$3.createElement(Item$1, _extends$4({}, p2, t2, { ref: n2 }));
});
const Root$2 = DropdownMenu;
const Trigger$1 = DropdownMenuTrigger;
const Content$1 = DropdownMenuContent;
const Item = DropdownMenuItem;
const [d, p$3] = createContextScope("ScrollArea");
const [f$3, h$4] = d("ScrollArea");
const ScrollArea$1 = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  const _a = e2, { __scopeScrollArea: t2, type: n2 = "hover", scrollHideDelay: i2 = 600 } = _a, a2 = __objRest(_a, ["__scopeScrollArea", "type", "scrollHideDelay"]), [d2, p2] = s$3.useState(null), [h, m2] = s$3.useState(null), [w2, b2] = s$3.useState(null), [v2, S2] = s$3.useState(null), [g2, E2] = s$3.useState(null), [C2, T2] = s$3.useState(0), [y2, A2] = s$3.useState(0), [x2, R2] = s$3.useState(false), [P2, L2] = s$3.useState(false), _2 = useComposedRefs(r2, (e3) => p2(e3)), D2 = useDirection(d2, a2.dir);
  return s$3.createElement(f$3, { scope: t2, type: n2, dir: D2, scrollHideDelay: i2, scrollArea: d2, viewport: h, onViewportChange: m2, content: w2, onContentChange: b2, scrollbarX: v2, onScrollbarXChange: S2, scrollbarXEnabled: x2, onScrollbarXEnabledChange: R2, scrollbarY: g2, onScrollbarYChange: E2, scrollbarYEnabled: P2, onScrollbarYEnabledChange: L2, onCornerWidthChange: T2, onCornerHeightChange: A2 }, /* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({}, a2, { ref: _2, style: __spreadValues({ position: "relative", "--radix-scroll-area-corner-width": C2 + "px", "--radix-scroll-area-corner-height": y2 + "px" }, e2.style) })));
});
const ScrollAreaViewport = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  const _a = e2, { __scopeScrollArea: t2, children: o2 } = _a, n2 = __objRest(_a, ["__scopeScrollArea", "children"]), i2 = h$4("ScrollAreaViewport", t2), a2 = s$3.useRef(null), d2 = useComposedRefs(r2, a2, i2.onViewportChange);
  return s$3.createElement(s$3.Fragment, null, /* @__PURE__ */ s$3.createElement("style", { dangerouslySetInnerHTML: { __html: "[data-radix-scroll-area-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-radix-scroll-area-viewport]::-webkit-scrollbar{display:none}" } }), /* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({ "data-radix-scroll-area-viewport": "" }, n2, { ref: d2, style: __spreadValues({ overflowX: i2.scrollbarXEnabled ? "scroll" : "hidden", overflowY: i2.scrollbarYEnabled ? "scroll" : "hidden" }, e2.style) }), /* @__PURE__ */ s$3.createElement("div", { ref: i2.onContentChange, style: { minWidth: "100%", display: "table" } }, o2)));
});
const ScrollAreaScrollbar = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  ...
  return s$3.useEffect(() => (a2 ? l2(true) : i2(true), () => {
    a2 ? l2(false) : i2(false);
  }), [a2, l2, i2]), n2.type === "hover" ? /* @__PURE__ */ s$3.createElement(m$3, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "scroll" ? /* @__PURE__ */ s$3.createElement(w$1, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "auto" ? /* @__PURE__ */ s$3.createElement(b, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "always" ? /* @__PURE__ */ s$3.createElement(v, _extends$4({}, o2, { ref: r2 })) : null;
});
const m$3 = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  const _a = e2, { forceMount: t2 } = _a, o2 = __objRest(_a, ["forceMount"]), n2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), [l2, i2] = s$3.useState(false);
  return s$3.useEffect(() => {
  ...
  }, [n2.scrollArea, n2.scrollHideDelay]), /* @__PURE__ */ s$3.createElement(Presence, { present: t2 || l2 }, /* @__PURE__ */ s$3.createElement(b, _extends$4({ "data-state": l2 ? "visible" : "hidden" }, o2, { ref: r2 })));
}), w$1 = /* @__PURE__ */ s$3.forwardRef((r2, t2) => {
  const _a = r2, { forceMount: o2 } = _a, n2 = __objRest(_a, ["forceMount"]), l2 = h$4("ScrollAreaScrollbar", r2.__scopeScrollArea), i2 = r2.orientation === "horizontal", c2 = z(() => p2("SCROLL_END"), 100), [d2, p2] = (f2 = "hidden", m2 = { hidden: { SCROLL: "scrolling" }, scrolling: { SCROLL_END: "idle", POINTER_ENTER: "interacting" }, interacting: { SCROLL: "interacting", POINTER_LEAVE: "idle" }, idle: { HIDE: "hidden", SCROLL: "scrolling", POINTER_ENTER: "interacting" } }, s$3.useReducer((e2, r3) => {
    const t3 = m2[e2][r3];
  ...
  }, [d2, l2.scrollHideDelay, p2]), s$3.useEffect(() => {
  ...
  }, [l2.viewport, i2, p2, c2]), /* @__PURE__ */ s$3.createElement(Presence, { present: o2 || d2 !== "hidden" }, /* @__PURE__ */ s$3.createElement(v, _extends$4({ "data-state": d2 === "hidden" ? "hidden" : "visible" }, n2, { ref: t2, onPointerEnter: composeEventHandlers(r2.onPointerEnter, () => p2("POINTER_ENTER")), onPointerLeave: composeEventHandlers(r2.onPointerLeave, () => p2("POINTER_LEAVE")) })));
}), b = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  const t2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), _a = e2, { forceMount: o2 } = _a, n2 = __objRest(_a, ["forceMount"]), [l2, i2] = s$3.useState(false), c2 = e2.orientation === "horizontal", d2 = z(() => {
    if (t2.viewport) {
      const e3 = t2.viewport.offsetWidth < t2.viewport.scrollWidth, r3 = t2.viewport.offsetHeight < t2.viewport.scrollHeight;
      i2(c2 ? e3 : r3);
    }
  }, 10);
  return H(t2.viewport, d2), H(t2.content, d2), /* @__PURE__ */ s$3.createElement(Presence, { present: o2 || l2 }, /* @__PURE__ */ s$3.createElement(v, _extends$4({ "data-state": l2 ? "visible" : "hidden" }, n2, { ref: r2 })));
}), v = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  const _a = e2, { orientation: t2 = "vertical" } = _a, o2 = __objRest(_a, ["orientation"]), n2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), l2 = s$3.useRef(null), i2 = s$3.useRef(0), [a2, c2] = s$3.useState({ content: 0, viewport: 0, scrollbar: { size: 0, paddingStart: 0, paddingEnd: 0 } }), d2 = x$1(a2.viewport, a2.content), p2 = __spreadProps(__spreadValues({}, o2), { sizes: a2, onSizesChange: c2, hasThumb: Boolean(d2 > 0 && d2 < 1), onThumbChange: (e3) => l2.current = e3, onThumbPointerUp: () => i2.current = 0, onThumbPointerDown: (e3) => i2.current = e3 });
  function f2(e3, r3) {
  ...
  return t2 === "horizontal" ? /* @__PURE__ */ s$3.createElement(S, _extends$4({}, p2, { ref: r2, onThumbPositionChange: () => {
  ...
  } })) : t2 === "vertical" ? /* @__PURE__ */ s$3.createElement(g$4, _extends$4({}, p2, { ref: r2, onThumbPositionChange: () => {
    if (n2.viewport && l2.current) {
...
}), g$4 = /* @__PURE__ */ s$3.forwardRef((e2, r2) => {
  const _a = e2, { sizes: t2, onSizesChange: o2 } = _a, n2 = __objRest(_a, ["sizes", "onSizesChange"]), i2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), [a2, c2] = s$3.useState(), d2 = s$3.useRef(null), p2 = useComposedRefs(r2, d2, i2.onScrollbarYChange);
  return s$3.useEffect(() => {
    d2.current && c2(getComputedStyle(d2.current));
  ...
  }, [R2, C2, P2, L2]), s$3.useEffect(_2, [i2, _2]), H(C2, D2), H(g2.content, D2), /* @__PURE__ */ s$3.createElement(E$1, { scope: o2, scrollbar: C2, hasThumb: a2, onThumbChange: useCallbackRef$1(d2), onThumbPointerUp: useCallbackRef$1(p2), onThumbPositionChange: _2, onThumbPointerDown: useCallbackRef$1(f2) }, /* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({}, S2, { ref: y2, style: __spreadValues({ position: "absolute" }, S2.style), onPointerDown: composeEventHandlers(r2.onPointerDown, (e2) => {
    if (e2.button === 0) {
...
const ScrollAreaThumb = /* @__PURE__ */ s$3.forwardRef((r2, t2) => {
  const _a = r2, { __scopeScrollArea: o2, style: n2 } = _a, i2 = __objRest(_a, ["__scopeScrollArea", "style"]), a2 = h$4("ScrollbarThumb", o2), d2 = C$1("ScrollbarThumb", o2), { onThumbPositionChange: p2 } = d2, f2 = useComposedRefs(t2, (e2) => d2.onThumbChange(e2)), m2 = s$3.useRef(), w2 = z(() => {
  ...
  }, [a2.viewport, w2, p2]), d2.hasThumb ? /* @__PURE__ */ s$3.createElement(Primitive.div, _extends$4({}, i2, { ref: f2, style: __spreadValues({ width: "var(--radix-scroll-area-thumb-width)", height: "var(--radix-scroll-area-thumb-height)" }, n2), onPointerDownCapture: composeEventHandlers(r2.onPointerDownCapture, (e2) => {
...
function z(e2, r2) {
  const t2 = useCallbackRef$1(e2), o2 = s$3.useRef(0);
  return s$3.useEffect(() => () => window.clearTimeout(o2.current), []), s$3.useCallback(() => {
...
const [C, g$3] = createContextScope("Popover", [l$1]);
const x = l$1(), [h$3, E] = C("Popover");
const Popover$1 = (e2) => {
  const { __scopePopover: o2, children: t2, open: n2, defaultOpen: c2, onOpenChange: a2, modal: s2 = false } = e2, i2 = x(o2), u2 = s$3.useRef(null), [d2, m2] = s$3.useState(false), [f2 = false, P2] = useControllableState({ prop: n2, defaultProp: c2, onChange: a2 });
  return s$3.createElement(Root$4, i2, /* @__PURE__ */ s$3.createElement(h$3, { scope: o2, contentId: useId(), triggerRef: u2, open: f2, onOpenChange: P2, onOpenToggle: s$3.useCallback(() => P2((e3) => !e3), [P2]), hasCustomAnchor: d2, onCustomAnchorAdd: s$3.useCallback(() => m2(true), []), onCustomAnchorRemove: s$3.useCallback(() => m2(false), []), modal: s2 }, t2));
};
const PopoverTrigger = /* @__PURE__ */ s$3.forwardRef((e2, o2) => {
  const _a = e2, { __scopePopover: r2 } = _a, n2 = __objRest(_a, ["__scopePopover"]), c2 = E("PopoverTrigger", r2), a2 = x(r2), s2 = useComposedRefs(o2, c2.triggerRef), i2 = /* @__PURE__ */ s$3.createElement(Primitive.button, _extends$4({ type: "button", "aria-haspopup": "dialog", "aria-expanded": c2.open, "aria-controls": c2.contentId, "data-state": w(c2.open) }, n2, { ref: s2, onClick: composeEventHandlers(e2.onClick, c2.onOpenToggle) }));
  return c2.hasCustomAnchor ? i2 : /* @__PURE__ */ s$3.createElement(Anchor$1, _extends$4({ asChild: true }, a2), i2);
});
const PopoverContent$1 = /* @__PURE__ */ s$3.forwardRef((e2, o2) => {
  const _a = e2, { forceMount: r2 } = _a, t2 = __objRest(_a, ["forceMount"]), c2 = E("PopoverContent", e2.__scopePopover);
  return s$3.createElement(Presence, { present: r2 || c2.open }, c2.modal ? /* @__PURE__ */ s$3.createElement(A, _extends$4({}, t2, { ref: o2 })) : /* @__PURE__ */ s$3.createElement(O, _extends$4({}, t2, { ref: o2 })));
});
const A = /* @__PURE__ */ s$3.forwardRef((r2, t2) => {
  const _a = r2, { allowPinchZoom: n2, portalled: c2 = true } = _a, s2 = __objRest(_a, ["allowPinchZoom", "portalled"]), i2 = E("PopoverContent", r2.__scopePopover), p2 = s$3.useRef(null), u2 = useComposedRefs(t2, p2), l2 = s$3.useRef(false);
  s$3.useEffect(() => {
    const o2 = p2.current;
    if (o2)
      return hideOthers(o2);
  }, []);
  const d2 = c2 ? Portal : s$3.Fragment;
  return s$3.createElement(d2, null, /* @__PURE__ */ s$3.createElement(o$3, { allowPinchZoom: n2 }, /* @__PURE__ */ s$3.createElement(R, _extends$4({}, s2, { ref: u2, trapFocus: i2.open, disableOutsidePointerEvents: true, onCloseAutoFocus: composeEventHandlers(r2.onCloseAutoFocus, (e2) => {
    var o2;
...
}), O = /* @__PURE__ */ s$3.forwardRef((e2, o2) => {
  const _a = e2, { portalled: r2 = true } = _a, t2 = __objRest(_a, ["portalled"]), n2 = E("PopoverContent", e2.__scopePopover), c2 = s$3.useRef(false), s2 = r2 ? Portal : s$3.Fragment;
  return s$3.createElement(s2, null, /* @__PURE__ */ s$3.createElement(R, _extends$4({}, t2, { ref: o2, trapFocus: false, disableOutsidePointerEvents: false, onCloseAutoFocus: (o3) => {
    var r3, t3;
...
}), R = /* @__PURE__ */ s$3.forwardRef((e2, o2) => {
  ...
  return useFocusGuards(), /* @__PURE__ */ s$3.createElement(FocusScope, { asChild: true, loop: true, trapped: t2, onMountAutoFocus: n2, onUnmountAutoFocus: a2 }, /* @__PURE__ */ s$3.createElement(DismissableLayer, { asChild: true, disableOutsidePointerEvents: u2, onInteractOutside: f2, onEscapeKeyDown: l2, onPointerDownOutside: d2, onFocusOutside: m2, onDismiss: () => g2.onOpenChange(false) }, /* @__PURE__ */ s$3.createElement(Content$3, _extends$4({ "data-state": w(g2.open), role: "dialog", id: g2.contentId }, h, C2, { ref: o2, style: __spreadProps(__spreadValues({}, C2.style), { "--radix-popover-content-transform-origin": "var(--radix-popper-transform-origin)" }) }))));
});
function w(e2) {
  return e2 ? "open" : "closed";
}
...
function baseHas$1(object2, key) {
  return object2 != null && hasOwnProperty$g.call(object2, key);
}
...
var reIsNative$1 = RegExp("^" + funcToString$2.call(hasOwnProperty$e).replace(reRegExpChar$1, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
var isArguments$2 = baseIsArguments(function() {
  ...
  return isObjectLike$2(value) && hasOwnProperty$b.call(value, "callee") && !propertyIsEnumerable$1.call(value, "callee");
};
...
function arrayLikeKeys$1(value, inherited) {
  ...
  for (var key in value) {
    if ((inherited || hasOwnProperty$a.call(value, key)) && !(skipIndexes && (key == "length" || isBuff && (key == "offset" || key == "parent") || isType && (key == "buffer" || key == "byteLength" || key == "byteOffset") || isIndex(key, length2)))) {
      result.push(key);
    }
  }
  return result;
...
class BaseSchema {
  ...
  clone(spec) {
    ...
    next.spec = clone$1(_extends$1({}, this.spec, spec));
    return next;
  }
  label(label) {
    let next = this.clone();
...
function Slider(_i) {
  var _j = _i, {
    className
  } = _j, props = __objRest2(_j, [
    "className"
  ]);
  return /* @__PURE__ */ jsxs$1(Root$7, __spreadProps2(__spreadValues2({}, props), {
...
function Label(_y) {
  ...
  return /* @__PURE__ */ jsx$1(Root$6, __spreadValues2({
...
const Separator = s__default.forwardRef((_C, ref) => {
  ...
  return /* @__PURE__ */ jsx$1(Root$5, __spreadProps2(__spreadValues2({
    ref
  }, props), {
    asChild: true,
...
function SelectOption(props) {
  return /* @__PURE__ */ jsxs$1(Item, __spreadProps2(__spreadValues2({
    ...
    children: [/* @__PURE__ */ jsx$1("div", {
      className: "flex-1",
      children: props.children
    }), props.selected && /* @__PURE__ */ jsx$1("div", {
...
function SelectRaw(_D) {
  ...
  const [selectedOption, setSelectedOption] = useState((_2) => {
    if (!defaultValue)
      return void 0;
  ...
  function getOptionForValue(value) {
    return options == null ? void 0 : options.find((o2) => typeof o2 == "object" ? o2.value == value : o2 === value);
  }
  useEffect((_2) => {
  ...
  let selectedOptionDisplayText = useMemo((_2) => {
    if (!selectedOption)
  ...
  return /* @__PURE__ */ jsx$1("div", {
    children: /* @__PURE__ */ jsxs$1(Root$2, {
      onOpenChange,
      children: [/* @__PURE__ */ jsx$1("div", {
        ref: triggerContainerEl,
        className: classNames("flex flex-row items-center space-x-2", className),
        children: TriggerComponent || props.children ? /* @__PURE__ */ jsx$1(Trigger$1, {
          asChild: true,
          disabled: props.disabled,
          children: TriggerComponent ? /* @__PURE__ */ jsx$1(TriggerComponent, {}) : props.children
        }) : /* @__PURE__ */ jsxs$1(Trigger$1, {
          disabled: props.disabled,
          onBlur,
          ...
          }), /* @__PURE__ */ jsx$1(ChevronDownIcon, {})]
        })
      }), /* @__PURE__ */ jsx$1(Content$1, {
        ...
        align: "end",
        sideOffset: 6,
        children: options == null ? void 0 : options.map((option, i2) => /* @__PURE__ */ jsx$1(SelectOption, {
          value: option.value || option,
          selected: isSelected(option),
          onClick: (_2) => setSelectedOption(option),
...
const ReactComponent$3 = (props) => /* @__PURE__ */ s$3.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
  viewBox: "0 0 15 15"
}, props), /* @__PURE__ */ s$3.createElement("path", {
  d: "M-158.762,87.6l1.484,4.019h2.125l1.391-4.019Z",
  transform: "translate(163.762 -86.099)",
  fill: "currentColor"
}), /* @__PURE__ */ s$3.createElement("path", {
...
const ReactComponent$2 = (props) => /* @__PURE__ */ s$3.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
...
}), /* @__PURE__ */ s$3.createElement("rect", {
  id: "Rettangolo_1",
...
const ReactComponent$1 = (props) => /* @__PURE__ */ s$3.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
  viewBox: "0 0 15 15",
  fill: "currentColor"
}, props), /* @__PURE__ */ s$3.createElement("rect", {
  id: "Rettangolo_1",
  "data-name": "Rettangolo 1",
  width: 7,
  height: 7,
...
const ReactComponent = (props) => /* @__PURE__ */ s$3.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
...
const SidebarMenuItem = s__default.forwardRef((_Sa, ref) => {
  ...
  const contents = /* @__PURE__ */ jsxs$1(Fragment, {
...
function ExtruderWidget() {
  ...
  useEffect((_2) => setDisabled(!motor), [motor]);
