...
import { DeviceTypeIcon, DeviceConnectionStatus } from "../../misc";

const DevicePickerTrigger = React.forwardRef(
  ({ device, open, ...props }, ref) => {
    return (
      <div
        ref={ref}
        {...props}
...
export default function DevicePicker({ devices }) {
