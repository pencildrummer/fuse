...
export default function DeviceProfileForm({ profile }) {
...
function DeviceProfileFormContent({
  ...
  let { values } = useFormikContext<Device.DataType>();
  // useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="flex-1">
        ...
        {deviceType == "msla_printer" && (
          <MSLAPrinterDeviceProfileFormContent />
        )}
      </div>
      <Separator />
