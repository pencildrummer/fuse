...
import React__default, { useContext, createContext, forwardRef, createElement, useState, useMemo, useEffect } from "react";
import { ChevronRightIcon, CaretDownIcon, QuestionMarkCircledIcon, LayersIcon, PauseIcon, StopIcon } from "@radix-ui/react-icons";
 ...
 */
var b$1 = typeof Symbol === "function" && Symbol.for, c$5 = b$1 ? Symbol.for("react.element") : 60103, d$4 = b$1 ? Symbol.for("react.portal") : 60106, e$3 = b$1 ? Symbol.for("react.fragment") : 60107, f$7 = b$1 ? Symbol.for("react.strict_mode") : 60108, g$6 = b$1 ? Symbol.for("react.profiler") : 60114, h$6 = b$1 ? Symbol.for("react.provider") : 60109, k = b$1 ? Symbol.for("react.context") : 60110, l$3 = b$1 ? Symbol.for("react.async_mode") : 60111, m$7 = b$1 ? Symbol.for("react.concurrent_mode") : 60111, n$a = b$1 ? Symbol.for("react.forward_ref") : 60112, p$7 = b$1 ? Symbol.for("react.suspense") : 60113, q$4 = b$1 ? Symbol.for("react.suspense_list") : 60120, r$4 = b$1 ? Symbol.for("react.memo") : 60115, t$4 = b$1 ? Symbol.for("react.lazy") : 60116, v$1 = b$1 ? Symbol.for("react.block") : 60121, w$2 = b$1 ? Symbol.for("react.fundamental") : 60117, x$2 = b$1 ? Symbol.for("react.responder") : 60118, y = b$1 ? Symbol.for("react.scope") : 60119;
function z$1(a2) {
...
reactIs_production_min.ForwardRef = n$a;
...
reactIs_production_min.isValidElementType = function(a2) {
  return typeof a2 === "string" || typeof a2 === "function" || a2 === e$3 || a2 === m$7 || a2 === g$6 || a2 === f$7 || a2 === p$7 || a2 === q$4 || typeof a2 === "object" && a2 !== null && (a2.$$typeof === t$4 || a2.$$typeof === r$4 || a2.$$typeof === h$6 || a2.$$typeof === k || a2.$$typeof === n$a || a2.$$typeof === w$2 || a2.$$typeof === x$2 || a2.$$typeof === y || a2.$$typeof === v$1);
};
...
var m$6 = f$6.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, n$9 = Object.prototype.hasOwnProperty, p$6 = { key: true, ref: true, __self: true, __source: true };
function q$3(c2, a2, k2) {
  ...
  for (b2 in a2)
    n$9.call(a2, b2) && !p$6.hasOwnProperty(b2) && (d2[b2] = a2[b2]);
...
const Slot = /* @__PURE__ */ React.forwardRef((e2, o2) => {
  ...
  return React.Children.toArray(a2).some(l$2) ? /* @__PURE__ */ React.createElement(React.Fragment, null, React.Children.map(a2, (e3) => l$2(e3) ? /* @__PURE__ */ React.createElement(n$8, _extends({}, s2, { ref: o2 }), e3.props.children) : e3)) : /* @__PURE__ */ React.createElement(n$8, _extends({}, s2, { ref: o2 }), a2);
});
Slot.displayName = "Slot";
const n$8 = /* @__PURE__ */ React.forwardRef((r2, n2) => {
  const _a = r2, { children: l2 } = _a, a2 = __objRest(_a, ["children"]);
  return React.isValidElement(l2) ? /* @__PURE__ */ React.cloneElement(l2, __spreadProps(__spreadValues({}, o$5(a2, l2.props)), { ref: composeRefs(n2, l2.ref) })) : React.Children.count(l2) > 1 ? React.Children.only(null) : null;
});
...
function getPlacementData({ anchorRect: p2, popperSize: c2, arrowSize: f2, arrowOffset: l2 = 0, side: d2, sideOffset: h = 0, align: x2, alignOffset: g2 = 0, shouldAvoidCollisions: u2 = true, collisionBoundariesRect: w2, collisionTolerance: m2 = 0 }) {
  ...
  var O2, z2;
  const R2 = s$1(S2, $), M = y2[a(d2)][x2], D2 = function(t2, e2, r2) {
    const o2 = a(t2);
    return e2[t2] && !r2[o2] ? o2 : t2;
  }(d2, R2, s$1(DOMRect.fromRect(__spreadValues(__spreadValues({}, c2), M)), $)), A2 = function(t2, e2, r2, o2, n2) {
...
const [u$1, m$5] = c$1("PopperContent");
...
const [s, i$2] = n$3("Progress");
const Progress$1 = /* @__PURE__ */ React.forwardRef((r2, n2) => {
  const _a = r2, { __scopeProgress: o2, value: i2, max: d2, getValueLabel: v2 = u } = _a, f2 = __objRest(_a, ["__scopeProgress", "value", "max", "getValueLabel"]), x2 = p$4(d2) ? d2 : 100, g2 = c(i2, x2) ? i2 : null, P2 = m$4(g2) ? v2(g2, x2) : void 0;
  return React.createElement(s, { scope: o2, value: g2, max: x2 }, /* @__PURE__ */ React.createElement(Primitive.div, _extends({ "aria-valuemax": x2, "aria-valuemin": 0, "aria-valuenow": m$4(g2) ? g2 : void 0, "aria-valuetext": P2, role: "progressbar", "data-state": l(g2, x2), "data-value": g2 != null ? g2 : void 0, "data-max": x2 }, f2, { ref: n2 })));
});
Progress$1.propTypes = { max(e2, r2, t2) {
  const a2 = e2[r2], n2 = String(a2);
  return a2 && !p$4(a2) ? new Error(function(e3, r3) {
    return `Invalid prop \`max\` of value \`${e3}\` supplied to \`${r3}\`. Only numbers greater than 0 are valid max values. Defaulting to \`100\`.`;
  }(n2, t2)) : null;
}, value(e2, r2, t2) {
  const a2 = e2[r2], n2 = String(a2), o2 = p$4(e2.max) ? e2.max : 100;
...
const ProgressIndicator = /* @__PURE__ */ React.forwardRef((r2, n2) => {
  var o2;
  const _a = r2, { __scopeProgress: s2 } = _a, u2 = __objRest(_a, ["__scopeProgress"]), m2 = i$2("ProgressIndicator", s2);
  return React.createElement(Primitive.div, _extends({ "data-state": l(m2.value, m2.max), "data-value": (o2 = m2.value) !== null && o2 !== void 0 ? o2 : void 0, "data-max": m2.max }, u2, { ref: n2 }));
});
function u(e2, r2) {
...
function p$4(e2) {
  return m$4(e2) && !isNaN(e2) && e2 > 0;
}
function c(e2, r2) {
  return m$4(e2) && !isNaN(e2) && e2 <= r2 && e2 >= 0;
}
const Root$2 = Progress$1;
...
const A = /* @__PURE__ */ React.forwardRef((r2, t2) => {
  ...
  return React.createElement(d2, null, /* @__PURE__ */ React.createElement(o$4, { allowPinchZoom: n2 }, /* @__PURE__ */ React.createElement(R, _extends({}, s2, { ref: u2, trapFocus: i2.open, disableOutsidePointerEvents: true, onCloseAutoFocus: composeEventHandlers(r2.onCloseAutoFocus, (e2) => {
    var o2;
...
function EmptyView(_Pa) {
  var _Qa = _Pa, {
    text
  } = _Qa, props = __objRest2(_Qa, [
    "text"
  ]);
  return /* @__PURE__ */ jsx$1("div", __spreadProps2(__spreadValues2({}, props), {
...
function MarlinJobQueueHandler() {
  ...
  useEffect((_2) => {
    ...
    const handleJobFinish = (job) => {
      ...
      setTimeout((_22) => removeStatus(status.id), 1500);
      if (isElectron()) {
        let notification = new Notification(device.name, {
          body: `${job.name} has been completed`
        });
        notification.onclick = (_22) => console.log("Clicked notification");
      }
    };
...
class MarlinCoreClientPlugin extends ClientPlugin$1 {
  deviceComponents(device) {
    return {
      page: {
