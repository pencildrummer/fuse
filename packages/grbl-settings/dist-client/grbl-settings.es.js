...
import * as s$2 from "react";
import s__default, { createContext as createContext$1, forwardRef, createElement, useContext, useEffect, useState, useMemo } from "react";
import e$5 from "react-dom";
...
function useCallbackRef$1(r2) {
  const t2 = s$2.useRef(r2);
  return s$2.useEffect(() => {
    t2.current = r2;
  }), s$2.useMemo(() => (...e2) => {
    var r3;
...
function useComposedRefs(...e2) {
  return s$2.useCallback(composeRefs(...e2), e2);
}
function _extends$4() {
...
const Slot = /* @__PURE__ */ s$2.forwardRef((e2, o2) => {
  const _a = e2, { children: a2 } = _a, s2 = __objRest(_a, ["children"]);
  return s$2.Children.toArray(a2).some(l$4) ? /* @__PURE__ */ s$2.createElement(s$2.Fragment, null, s$2.Children.map(a2, (e3) => l$4(e3) ? /* @__PURE__ */ s$2.createElement(n$8, _extends$4({}, s2, { ref: o2 }), e3.props.children) : e3)) : /* @__PURE__ */ s$2.createElement(n$8, _extends$4({}, s2, { ref: o2 }), a2);
});
Slot.displayName = "Slot";
const n$8 = /* @__PURE__ */ s$2.forwardRef((r2, n2) => {
  const _a = r2, { children: l2 } = _a, a2 = __objRest(_a, ["children"]);
  return s$2.isValidElement(l2) ? /* @__PURE__ */ s$2.cloneElement(l2, __spreadProps(__spreadValues({}, o$4(a2, l2.props)), { ref: composeRefs(n2, l2.ref) })) : s$2.Children.count(l2) > 1 ? s$2.Children.only(null) : null;
});
n$8.displayName = "SlotClone";
const Slottable = ({ children: e2 }) => /* @__PURE__ */ s$2.createElement(s$2.Fragment, null, e2);
function l$4(e2) {
  return s$2.isValidElement(e2) && e2.type === Slottable;
}
function o$4(e2, t2) {
...
const Primitive = ["a", "button", "div", "h2", "h3", "img", "li", "nav", "ol", "p", "span", "svg", "ul"].reduce((o2, i2) => __spreadProps(__spreadValues({}, o2), { [i2]: /* @__PURE__ */ s$2.forwardRef((o3, m2) => {
  const _a = o3, { asChild: a2 } = _a, s2 = __objRest(_a, ["asChild"]), n2 = a2 ? Slot : i2;
  return s$2.useEffect(() => {
    window[Symbol.for("radix-ui")] = true;
  }, []), /* @__PURE__ */ s$2.createElement(n2, _extends$4({}, s2, { ref: m2 }));
}) }), {});
...
const useLayoutEffect = Boolean(globalThis === null || globalThis === void 0 ? void 0 : globalThis.document) ? s$2.useLayoutEffect : () => {
};
const r$5 = s$2["useId".toString()] || (() => {
});
let n$7 = 0;
function useId(o2) {
  const [u2, i2] = s$2.useState(r$5());
  return useLayoutEffect(() => {
    o2 || i2((t2) => t2 != null ? t2 : String(n$7++));
  }, [o2]), o2 || (u2 ? `radix-${u2}` : "");
}
function createContext(t2, n2) {
  const o2 = /* @__PURE__ */ s$2.createContext(n2);
  function r2(t3) {
    const _a = t3, { children: n3 } = _a, r3 = __objRest(_a, ["children"]), c2 = s$2.useMemo(() => r3, Object.values(r3));
    return s$2.createElement(o2.Provider, { value: c2 }, n3);
  }
  return r2.displayName = t2 + "Provider", [r2, function(r3) {
    const c2 = s$2.useContext(o2);
    if (c2)
      return c2;
    if (n2 !== void 0)
      return n2;
...
function createContextScope(n2, o2 = []) {
  let r2 = [];
  const c2 = () => {
    const t2 = r2.map((t3) => /* @__PURE__ */ s$2.createContext(t3));
    return function(o3) {
      const r3 = (o3 == null ? void 0 : o3[n2]) || t2;
      return s$2.useMemo(() => ({ [`__scope${n2}`]: __spreadProps(__spreadValues({}, o3), { [n2]: r3 }) }), [o3, r3]);
    };
  };
  return c2.scopeName = n2, [function(t2, o3) {
    const c3 = /* @__PURE__ */ s$2.createContext(o3), u2 = r2.length;
    function s2(t3) {
      const _a = t3, { scope: o4, children: r3 } = _a, s3 = __objRest(_a, ["scope", "children"]), i2 = (o4 == null ? void 0 : o4[n2][u2]) || c3, a2 = s$2.useMemo(() => s3, Object.values(s3));
      return s$2.createElement(i2.Provider, { value: a2 }, r3);
    }
    return r2 = [...r2, o3], s2.displayName = t2 + "Provider", [s2, function(r3, s3) {
      const i2 = (s3 == null ? void 0 : s3[n2][u2]) || c3, a2 = s$2.useContext(i2);
      if (a2)
        return a2;
      if (o3 !== void 0)
        return o3;
...
function t$5(...t2) {
  ...
  const o2 = () => {
    ...
    return function(t3) {
      ...
      return s$2.useMemo(() => ({ [`__scope${n2.scopeName}`]: r2 }), [r2]);
    };
  };
  return o2.scopeName = n2.scopeName, o2;
}
function useSize(r2) {
  const [i2, t2] = s$2.useState(void 0);
  return s$2.useEffect(() => {
    if (r2) {
...
function usePrevious(r2) {
  const u2 = s$2.useRef({ value: r2, previous: r2 });
  return s$2.useMemo(() => (u2.current.value !== r2 && (u2.current.previous = u2.current.value, u2.current.value = r2), u2.current.previous), [r2]);
}
function useDirection(t2, n2) {
  const [r2, o2] = s$2.useState("ltr"), [i2, u2] = s$2.useState(), c2 = s$2.useRef(0);
  return s$2.useEffect(() => {
    if (n2 === void 0 && t2 != null && t2.parentElement) {
      const e2 = getComputedStyle(t2.parentElement);
      u2(e2);
    }
  }, [t2, n2]), s$2.useEffect(() => (n2 === void 0 && function e2() {
...
const Label$1 = /* @__PURE__ */ s$2.forwardRef((o2, a2) => {
  const _a = o2, { htmlFor: c2, id: u2 } = _a, s2 = __objRest(_a, ["htmlFor", "id"]), d2 = s$2.useRef(null), f2 = s$2.useRef(null), m2 = useComposedRefs(a2, f2), b2 = useId(u2);
  return s$2.useEffect(() => {
    if (c2) {
  ...
  }, [b2, c2]), /* @__PURE__ */ s$2.createElement(i$5, { id: b2, controlRef: d2 }, /* @__PURE__ */ s$2.createElement(Primitive.span, _extends$4({ role: "label", id: b2 }, s2, { ref: m2, onMouseDown: (e2) => {
    var t2;
...
const [l$3, u$2] = createContextScope("Switch");
const [p$6, m$6] = l$3("Switch");
const Switch$1 = /* @__PURE__ */ s$2.forwardRef((r2, o2) => {
  const _a = r2, { __scopeSwitch: c2, "aria-labelledby": l2, name: u2, checked: m2, defaultChecked: f2, required: x2, disabled: k2, value: w2 = "on", onCheckedChange: v2 } = _a, S2 = __objRest(_a, ["__scopeSwitch", "aria-labelledby", "name", "checked", "defaultChecked", "required", "disabled", "value", "onCheckedChange"]), [y2, E2] = s$2.useState(null), C2 = useComposedRefs(o2, (e2) => E2(e2)), g2 = useLabelContext(y2), R2 = l2 || g2, T2 = s$2.useRef(false), P2 = !y2 || Boolean(y2.closest("form")), [_2 = false, q2] = useControllableState({ prop: m2, defaultProp: f2, onChange: v2 });
  return s$2.createElement(p$6, { scope: c2, checked: _2, disabled: k2 }, /* @__PURE__ */ s$2.createElement(Primitive.button, _extends$4({ type: "button", role: "switch", "aria-checked": _2, "aria-labelledby": R2, "aria-required": x2, "data-state": h$6(_2), "data-disabled": k2 ? "" : void 0, disabled: k2, value: w2 }, S2, { ref: C2, onClick: composeEventHandlers(r2.onClick, (e2) => {
    q2((e3) => !e3), P2 && (T2.current = e2.isPropagationStopped(), T2.current || e2.stopPropagation());
  }) })), P2 && /* @__PURE__ */ s$2.createElement(b$3, { control: y2, bubbles: !T2.current, name: u2, value: w2, checked: _2, required: x2, disabled: k2, style: { transform: "translateX(-100%)" } }));
});
const SwitchThumb = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { __scopeSwitch: o2 } = _a, a2 = __objRest(_a, ["__scopeSwitch"]), c2 = m$6("SwitchThumb", o2);
  return s$2.createElement(Primitive.span, _extends$4({ "data-state": h$6(c2.checked), "data-disabled": c2.disabled ? "" : void 0 }, a2, { ref: r2 }));
});
const b$3 = (e2) => {
  const _a = e2, { control: t2, checked: a2, bubbles: c2 = true } = _a, i2 = __objRest(_a, ["control", "checked", "bubbles"]), n2 = s$2.useRef(null), l2 = usePrevious(a2), u2 = useSize(t2);
  return s$2.useEffect(() => {
    const e3 = n2.current, t3 = window.HTMLInputElement.prototype, r2 = Object.getOwnPropertyDescriptor(t3, "checked").set;
    if (l2 !== a2 && r2) {
      const t4 = new Event("click", { bubbles: c2 });
      r2.call(e3, a2), e3.dispatchEvent(t4);
    }
  }, [l2, a2, c2]), /* @__PURE__ */ s$2.createElement("input", _extends$4({ type: "checkbox", "aria-hidden": true, defaultChecked: a2 }, i2, { tabIndex: -1, ref: n2, style: __spreadProps(__spreadValues(__spreadValues({}, e2.style), u2), { position: "absolute", pointerEvents: "none", opacity: 0, margin: 0 }) }));
};
function h$6(e2) {
  return e2 ? "checked" : "unchecked";
}
const Root$4 = Switch$1;
 ...
 */
var b$2 = typeof Symbol === "function" && Symbol.for, c$5 = b$2 ? Symbol.for("react.element") : 60103, d$5 = b$2 ? Symbol.for("react.portal") : 60106, e$4 = b$2 ? Symbol.for("react.fragment") : 60107, f$6 = b$2 ? Symbol.for("react.strict_mode") : 60108, g$5 = b$2 ? Symbol.for("react.profiler") : 60114, h$5 = b$2 ? Symbol.for("react.provider") : 60109, k$1 = b$2 ? Symbol.for("react.context") : 60110, l$2 = b$2 ? Symbol.for("react.async_mode") : 60111, m$5 = b$2 ? Symbol.for("react.concurrent_mode") : 60111, n$6 = b$2 ? Symbol.for("react.forward_ref") : 60112, p$5 = b$2 ? Symbol.for("react.suspense") : 60113, q$3 = b$2 ? Symbol.for("react.suspense_list") : 60120, r$4 = b$2 ? Symbol.for("react.memo") : 60115, t$4 = b$2 ? Symbol.for("react.lazy") : 60116, v$2 = b$2 ? Symbol.for("react.block") : 60121, w$3 = b$2 ? Symbol.for("react.fundamental") : 60117, x$3 = b$2 ? Symbol.for("react.responder") : 60118, y$1 = b$2 ? Symbol.for("react.scope") : 60119;
function z$2(a2) {
...
reactIs_production_min$1.Element = c$5;
...
reactIs_production_min$1.isValidElementType = function(a2) {
  return typeof a2 === "string" || typeof a2 === "function" || a2 === e$4 || a2 === m$5 || a2 === g$5 || a2 === f$6 || a2 === p$5 || a2 === q$3 || typeof a2 === "object" && a2 !== null && (a2.$$typeof === t$4 || a2.$$typeof === r$4 || a2.$$typeof === h$5 || a2.$$typeof === k$1 || a2.$$typeof === n$6 || a2.$$typeof === w$3 || a2.$$typeof === x$3 || a2.$$typeof === y$1 || a2.$$typeof === v$2);
};
...
var isObject$6 = function isObject(obj) {
...
function useField(propsOrFieldName) {
  ...
  var isAnObject = isObject$6(propsOrFieldName);
...
var SideCar$1 = function(_a) {
  ...
  return s$2.createElement(Target, __assign$1({}, rest));
};
...
var RemoveScroll = s$2.forwardRef(function(props, parentRef) {
  var ref = s$2.useRef(null);
  var _a = s$2.useState({
  ...
  return s$2.createElement(s$2.Fragment, null, enabled && s$2.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref }), forwardProps ? s$2.cloneElement(s$2.Children.only(children), __assign$2({}, containerProps, { ref: containerRef })) : s$2.createElement(Container, __assign$2({}, containerProps, { className, ref: containerRef }), children));
});
...
var RemoveScrollBar = function(props) {
  var _a = s$2.useState(getGapWidth(props.gapMode)), gap = _a[0], setGap = _a[1];
  s$2.useEffect(function() {
    setGap(getGapWidth(props.gapMode));
  }, [props.gapMode]);
  var noRelative = props.noRelative, noImportant = props.noImportant, _b = props.gapMode, gapMode = _b === void 0 ? "margin" : _b;
  return s$2.createElement(Style, { styles: getStyles(gap, !noRelative, gapMode, !noImportant ? "!important" : "") });
};
...
function RemoveScrollSideCar(props) {
  var shouldPreventQueue = s$2.useRef([]);
  var touchStartRef = s$2.useRef([0, 0]);
  var activeAxis = s$2.useRef();
  var id = s$2.useState(idCounter++)[0];
  var Style2 = s$2.useState(function() {
    return styleSingleton();
  })[0];
  var lastProps = s$2.useRef(props);
  s$2.useEffect(function() {
  ...
  var shouldCancelEvent = s$2.useCallback(function(event, parent) {
  ...
  var shouldPrevent = s$2.useCallback(function(_event) {
    var event = _event;
  ...
  var shouldCancel = s$2.useCallback(function(name, delta, target, should) {
  ...
  var scrollTouchStart = s$2.useCallback(function(event) {
    touchStartRef.current = getTouchXY(event);
    activeAxis.current = void 0;
  }, []);
  var scrollWheel = s$2.useCallback(function(event) {
    shouldCancel(event.type, getDeltaXY(event), event.target, shouldCancelEvent(event, props.lockRef.current));
  }, []);
  var scrollTouchMove = s$2.useCallback(function(event) {
  ...
  return s$2.createElement(s$2.Fragment, null, inert ? s$2.createElement(Style2, { styles: generateStyle(id) }) : null, removeScrollBar ? s$2.createElement(RemoveScrollBar, { gapMode: "margin" }) : null);
}
var SideCar = exportSidecar(effectCar, RemoveScrollSideCar);
var ReactRemoveScroll = s$2.forwardRef(function(props, ref) {
  return s$2.createElement(RemoveScroll, __assign$2({}, props, { ref, sideCar: SideCar }));
});
...
function useFocusGuards() {
  s$2.useEffect(() => {
    ...
    return document.body.insertAdjacentElement("afterbegin", (e2 = r2[0]) !== null && e2 !== void 0 ? e2 : o$2()), document.body.insertAdjacentElement("beforeend", (n2 = r2[1]) !== null && n2 !== void 0 ? n2 : o$2()), t$3++, () => {
      t$3 === 1 && document.querySelectorAll("[data-radix-focus-guard]").forEach((e3) => e3.remove()), t$3--;
    };
  }, []);
}
function o$2() {
...
const Presence = (u2) => {
  const { present: o2, children: i2 } = u2, s2 = function(n2) {
    const [u3, o3] = s$2.useState(), i3 = s$2.useRef({}), s3 = s$2.useRef(n2), c3 = s$2.useRef("none"), a3 = n2 ? "mounted" : "unmounted", [d2, m2] = function(e2, n3) {
      return s$2.useReducer((e3, t2) => {
        const r2 = n3[e3][t2];
    ...
    return s$2.useEffect(() => {
      ...
      if (u3) {
        const e2 = (e3) => {
          const n4 = r$3(i3.current).includes(e3.animationName);
          e3.target === u3 && n4 && m2("ANIMATION_END");
        }, n3 = (e3) => {
          e3.target === u3 && (c3.current = r$3(i3.current));
        };
      ...
      m2("ANIMATION_END");
    }, [u3, m2]), { isPresent: ["mounted", "unmountSuspended"].includes(d2), ref: s$2.useCallback((e2) => {
      e2 && (i3.current = getComputedStyle(e2)), o3(e2);
    }, []) };
  }(o2), c2 = typeof i2 == "function" ? i2({ present: s2.isPresent }) : s$2.Children.only(i2), a2 = useComposedRefs(s2.ref, c2.ref);
  return typeof i2 == "function" || s2.isPresent ? /* @__PURE__ */ s$2.cloneElement(c2, { ref: a2 }) : null;
};
function r$3(e2) {
  return (e2 == null ? void 0 : e2.animationName) || "none";
}
Presence.displayName = "Presence";
const Portal = /* @__PURE__ */ s$2.forwardRef((a2, i2) => {
  var n2, d2;
  const _a = a2, { containerRef: s2, style: u2 } = _a, c2 = __objRest(_a, ["containerRef", "style"]), m2 = (n2 = s2 == null ? void 0 : s2.current) !== null && n2 !== void 0 ? n2 : globalThis === null || globalThis === void 0 || (d2 = globalThis.document) === null || d2 === void 0 ? void 0 : d2.body, [, f2] = s$2.useState({});
  return useLayoutEffect(() => {
    f2({});
  }, []), m2 ? /* @__PURE__ */ e$5.createPortal(/* @__PURE__ */ s$2.createElement(Primitive.div, _extends$4({ "data-radix-portal": "" }, c2, { ref: i2, style: m2 === document.body ? __spreadValues({ position: "absolute", top: 0, left: 0, zIndex: 2147483647 }, u2) : void 0 })), m2) : null;
});
const c$4 = { bubbles: false, cancelable: true };
const FocusScope = /* @__PURE__ */ s$2.forwardRef((i2, f2) => {
  const _a = i2, { loop: l2 = false, trapped: m2 = false, onMountAutoFocus: p2, onUnmountAutoFocus: v2 } = _a, E2 = __objRest(_a, ["loop", "trapped", "onMountAutoFocus", "onUnmountAutoFocus"]), [F, S2] = s$2.useState(null), b2 = useCallbackRef$1(p2), T2 = useCallbackRef$1(v2), y2 = s$2.useRef(null), L2 = useComposedRefs(f2, (e2) => S2(e2)), h = s$2.useRef({ paused: false, pause() {
    this.paused = true;
  }, resume() {
    this.paused = false;
  } }).current;
        ...
        F.addEventListener("focusScope.autoFocusOnMount", b2), F.dispatchEvent(n2), n2.defaultPrevented || (!function(e3, { select: t3 = false } = {}) {
          ...
          for (const o2 of e3)
            if (a$1(o2, { select: t3 }), document.activeElement !== n3)
              return;
        }((e2 = r$2(F), e2.filter((e3) => e3.tagName !== "A")), { select: true }), document.activeElement === t2 && a$1(F));
      }
      return () => {
        F.removeEventListener("focusScope.autoFocusOnMount", b2), setTimeout(() => {
          const e3 = new Event("focusScope.autoFocusOnUnmount", c$4);
          F.addEventListener("focusScope.autoFocusOnUnmount", T2), F.dispatchEvent(e3), e3.defaultPrevented || a$1(t2 != null ? t2 : document.body, { select: true }), F.removeEventListener("focusScope.autoFocusOnUnmount", T2), d$4.remove(h);
        }, 0);
      };
    }
    var e2;
  }, [F, b2, T2, h]);
  const N = s$2.useCallback((e2) => {
    if (!l2 && !m2)
      return;
    if (h.paused)
      return;
    ...
    if (t2 && n2) {
      const t3 = e2.currentTarget, [o2, u2] = function(e3) {
        const t4 = r$2(e3), n3 = s$1(t4, e3), o3 = s$1(t4.reverse(), e3);
        return [n3, o3];
      }(t3);
  ...
  return s$2.createElement(Primitive.div, _extends$4({ tabIndex: -1 }, E2, { ref: L2, onKeyDown: N }));
});
function r$2(e2) {
...
const d$4 = function() {
  ...
  return { add(t2) {
    const n2 = e2[0];
    t2 !== n2 && (n2 == null || n2.pause()), e2 = f$5(e2, t2), e2.unshift(t2);
  }, remove(t2) {
    var n2;
    e2 = f$5(e2, t2), (n2 = e2[0]) === null || n2 === void 0 || n2.resume();
  } };
}();
function f$5(e2, t2) {
...
const u$1 = /* @__PURE__ */ s$2.createContext({ layers: /* @__PURE__ */ new Set(), layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(), branches: /* @__PURE__ */ new Set() });
const DismissableLayer = /* @__PURE__ */ s$2.forwardRef((l2, m2) => {
  const _a = l2, { disableOutsidePointerEvents: f2 = false, onEscapeKeyDown: p2, onPointerDownOutside: v2, onFocusOutside: b2, onInteractOutside: E2, onDismiss: y2 } = _a, w2 = __objRest(_a, ["disableOutsidePointerEvents", "onEscapeKeyDown", "onPointerDownOutside", "onFocusOutside", "onInteractOutside", "onDismiss"]), h = s$2.useContext(u$1), [D2, x2] = s$2.useState(null), [, C2] = s$2.useState({}), L2 = useComposedRefs(m2, (e2) => x2(e2)), P2 = Array.from(h.layers), [O2] = [...h.layersWithOutsidePointerEventsDisabled].slice(-1), g2 = P2.indexOf(O2), B = D2 ? P2.indexOf(D2) : -1, R2 = h.layersWithOutsidePointerEventsDisabled.size > 0, F = B >= g2, S2 = function(e2) {
    const n2 = useCallbackRef$1(e2), r2 = s$2.useRef(false);
    return s$2.useEffect(() => {
      const e3 = (e4) => {
...
const e$3 = "horizontal", n$4 = ["horizontal", "vertical"];
const Separator$1 = /* @__PURE__ */ s$2.forwardRef((n2, a2) => {
  const _a = n2, { decorative: p2, orientation: l2 = e$3 } = _a, c2 = __objRest(_a, ["decorative", "orientation"]), s2 = i$3(l2) ? l2 : e$3, u2 = p2 ? { role: "none" } : { "aria-orientation": s2 === "vertical" ? s2 : void 0, role: "separator" };
  return s$2.createElement(Primitive.div, _extends$4({ "data-orientation": s2 }, u2, c2, { ref: a2 }));
});
function i$3(r2) {
...
const Root$3 = Separator$1;
function observeElementRect(n2, o2) {
  const i2 = e$2.get(n2);
  return i2 === void 0 ? (e$2.set(n2, { rect: {}, callbacks: [o2] }), e$2.size === 1 && (t$2 = requestAnimationFrame(c$2))) : (i2.callbacks.push(o2), o2(n2.getBoundingClientRect())), () => {
    const c2 = e$2.get(n2);
    if (c2 === void 0)
      return;
    const i3 = c2.callbacks.indexOf(o2);
    i3 > -1 && c2.callbacks.splice(i3, 1), c2.callbacks.length === 0 && (e$2.delete(n2), e$2.size === 0 && cancelAnimationFrame(t$2));
  };
}
let t$2;
...
function getPlacementData({ anchorRect: p2, popperSize: c2, arrowSize: f2, arrowOffset: l2 = 0, side: d2, sideOffset: h = 0, align: x2, alignOffset: g2 = 0, shouldAvoidCollisions: u2 = true, collisionBoundariesRect: w2, collisionTolerance: m2 = 0 }) {
  ...
  const y2 = function(e2, r2, o2 = 0, n2 = 0, i2) {
    const p3 = i2 ? i2.height : 0, a2 = t$1(r2, e2, "x"), s2 = t$1(r2, e2, "y"), c3 = s2.before - o2 - p3, f3 = s2.after + o2 + p3, l3 = a2.before - o2 - p3, d3 = a2.after + o2 + p3;
  ...
  const R2 = s(S2, $), M = y2[a(d2)][x2], D2 = function(t2, e2, r2) {
    ...
    if ((o2 === "end" || o2 === "center") && (n2[a2] && c3 || n2[p3] && !c3))
      return "start";
    return o2;
  }(c2, p2, d2, x2, R2), I = e$1(y2[D2][A2]);
  let C2 = n$3;
  f2 && (C2 = i$2({ popperSize: c2, arrowSize: f2, arrowOffset: l2, side: D2, align: A2 }));
  return { popperStyles: __spreadProps(__spreadValues({}, I), { "--radix-popper-transform-origin": r$1(c2, D2, A2, l2, f2) }), arrowStyles: C2, placedSide: D2, placedAlign: A2 };
}
...
const [c$1, l$1] = createContextScope("Popper");
const [f$4, d$2] = c$1("Popper");
const Popper = (e2) => {
  const { __scopePopper: o2, children: r2 } = e2, [t2, n2] = s$2.useState(null);
  return s$2.createElement(f$4, { scope: o2, anchor: t2, onAnchorChange: n2 }, r2);
};
const PopperAnchor = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { __scopePopper: t2, virtualRef: n2 } = _a, p2 = __objRest(_a, ["__scopePopper", "virtualRef"]), c2 = d$2("PopperAnchor", t2), l2 = s$2.useRef(null), f2 = useComposedRefs(r2, l2);
  return s$2.useEffect(() => {
    c2.onAnchorChange((n2 == null ? void 0 : n2.current) || l2.current);
  }), n2 ? null : /* @__PURE__ */ s$2.createElement(Primitive.div, _extends$4({}, p2, { ref: f2 }));
});
const [u, m$4] = c$1("PopperContent");
const PopperContent = /* @__PURE__ */ s$2.forwardRef((e2, n2) => {
  const _a = e2, { __scopePopper: c2, side: l2 = "bottom", sideOffset: f2, align: m2 = "center", alignOffset: w2, collisionTolerance: h, avoidCollisions: x2 = true } = _a, v2 = __objRest(_a, ["__scopePopper", "side", "sideOffset", "align", "alignOffset", "collisionTolerance", "avoidCollisions"]), P2 = d$2("PopperContent", c2), [A2, g2] = s$2.useState(), E2 = useRect(P2.anchor), [y2, C2] = s$2.useState(null), S2 = useSize(y2), [R2, O2] = s$2.useState(null), _2 = useSize(R2), b2 = useComposedRefs(n2, (e3) => C2(e3)), z2 = function() {
    const [e3, o2] = s$2.useState(void 0);
    return s$2.useEffect(() => {
      let e4;
      function r2() {
  ...
  return s$2.createElement("div", { style: k2, "data-radix-popper-content-wrapper": "" }, /* @__PURE__ */ s$2.createElement(u, { scope: c2, arrowStyles: L2, onArrowChange: O2, onArrowOffsetChange: g2 }, /* @__PURE__ */ s$2.createElement(Primitive.div, _extends$4({ "data-side": B, "data-align": D2 }, v2, { style: __spreadProps(__spreadValues({}, v2.style), { animation: H2 ? void 0 : "none" }), ref: b2 }))));
});
const Root$2 = Popper;
const Anchor = PopperAnchor;
const Content$1 = PopperContent;
const [d$1, p$3] = createContextScope("ScrollArea");
const [f$3, h$4] = d$1("ScrollArea");
const ScrollArea$1 = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { __scopeScrollArea: t2, type: n2 = "hover", scrollHideDelay: i2 = 600 } = _a, a2 = __objRest(_a, ["__scopeScrollArea", "type", "scrollHideDelay"]), [d2, p2] = s$2.useState(null), [h, m2] = s$2.useState(null), [w2, b2] = s$2.useState(null), [v2, S2] = s$2.useState(null), [g2, E2] = s$2.useState(null), [C2, T2] = s$2.useState(0), [y2, A2] = s$2.useState(0), [x2, R2] = s$2.useState(false), [P2, L2] = s$2.useState(false), _2 = useComposedRefs(r2, (e3) => p2(e3)), D2 = useDirection(d2, a2.dir);
  return s$2.createElement(f$3, { scope: t2, type: n2, dir: D2, scrollHideDelay: i2, scrollArea: d2, viewport: h, onViewportChange: m2, content: w2, onContentChange: b2, scrollbarX: v2, onScrollbarXChange: S2, scrollbarXEnabled: x2, onScrollbarXEnabledChange: R2, scrollbarY: g2, onScrollbarYChange: E2, scrollbarYEnabled: P2, onScrollbarYEnabledChange: L2, onCornerWidthChange: T2, onCornerHeightChange: A2 }, /* @__PURE__ */ s$2.createElement(Primitive.div, _extends$4({}, a2, { ref: _2, style: __spreadValues({ position: "relative", "--radix-scroll-area-corner-width": C2 + "px", "--radix-scroll-area-corner-height": y2 + "px" }, e2.style) })));
});
const ScrollAreaViewport = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { __scopeScrollArea: t2, children: o2 } = _a, n2 = __objRest(_a, ["__scopeScrollArea", "children"]), i2 = h$4("ScrollAreaViewport", t2), a2 = s$2.useRef(null), d2 = useComposedRefs(r2, a2, i2.onViewportChange);
  return s$2.createElement(s$2.Fragment, null, /* @__PURE__ */ s$2.createElement("style", { dangerouslySetInnerHTML: { __html: "[data-radix-scroll-area-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-radix-scroll-area-viewport]::-webkit-scrollbar{display:none}" } }), /* @__PURE__ */ s$2.createElement(Primitive.div, _extends$4({ "data-radix-scroll-area-viewport": "" }, n2, { ref: d2, style: __spreadValues({ overflowX: i2.scrollbarXEnabled ? "scroll" : "hidden", overflowY: i2.scrollbarYEnabled ? "scroll" : "hidden" }, e2.style) }), /* @__PURE__ */ s$2.createElement("div", { ref: i2.onContentChange, style: { minWidth: "100%", display: "table" } }, o2)));
});
const ScrollAreaScrollbar = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  ...
  return s$2.useEffect(() => (a2 ? l2(true) : i2(true), () => {
    a2 ? l2(false) : i2(false);
  }), [a2, l2, i2]), n2.type === "hover" ? /* @__PURE__ */ s$2.createElement(m$3, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "scroll" ? /* @__PURE__ */ s$2.createElement(w$2, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "auto" ? /* @__PURE__ */ s$2.createElement(b$1, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "always" ? /* @__PURE__ */ s$2.createElement(v$1, _extends$4({}, o2, { ref: r2 })) : null;
});
const m$3 = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { forceMount: t2 } = _a, o2 = __objRest(_a, ["forceMount"]), n2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), [l2, i2] = s$2.useState(false);
  return s$2.useEffect(() => {
  ...
  }, [n2.scrollArea, n2.scrollHideDelay]), /* @__PURE__ */ s$2.createElement(Presence, { present: t2 || l2 }, /* @__PURE__ */ s$2.createElement(b$1, _extends$4({ "data-state": l2 ? "visible" : "hidden" }, o2, { ref: r2 })));
}), w$2 = /* @__PURE__ */ s$2.forwardRef((r2, t2) => {
  const _a = r2, { forceMount: o2 } = _a, n2 = __objRest(_a, ["forceMount"]), l2 = h$4("ScrollAreaScrollbar", r2.__scopeScrollArea), i2 = r2.orientation === "horizontal", c2 = z$1(() => p2("SCROLL_END"), 100), [d2, p2] = (f2 = "hidden", m2 = { hidden: { SCROLL: "scrolling" }, scrolling: { SCROLL_END: "idle", POINTER_ENTER: "interacting" }, interacting: { SCROLL: "interacting", POINTER_LEAVE: "idle" }, idle: { HIDE: "hidden", SCROLL: "scrolling", POINTER_ENTER: "interacting" } }, s$2.useReducer((e2, r3) => {
    const t3 = m2[e2][r3];
  ...
  }, [d2, l2.scrollHideDelay, p2]), s$2.useEffect(() => {
  ...
  }, [l2.viewport, i2, p2, c2]), /* @__PURE__ */ s$2.createElement(Presence, { present: o2 || d2 !== "hidden" }, /* @__PURE__ */ s$2.createElement(v$1, _extends$4({ "data-state": d2 === "hidden" ? "hidden" : "visible" }, n2, { ref: t2, onPointerEnter: composeEventHandlers(r2.onPointerEnter, () => p2("POINTER_ENTER")), onPointerLeave: composeEventHandlers(r2.onPointerLeave, () => p2("POINTER_LEAVE")) })));
}), b$1 = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const t2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), _a = e2, { forceMount: o2 } = _a, n2 = __objRest(_a, ["forceMount"]), [l2, i2] = s$2.useState(false), c2 = e2.orientation === "horizontal", d2 = z$1(() => {
    if (t2.viewport) {
      const e3 = t2.viewport.offsetWidth < t2.viewport.scrollWidth, r3 = t2.viewport.offsetHeight < t2.viewport.scrollHeight;
      i2(c2 ? e3 : r3);
    }
  }, 10);
  return H(t2.viewport, d2), H(t2.content, d2), /* @__PURE__ */ s$2.createElement(Presence, { present: o2 || l2 }, /* @__PURE__ */ s$2.createElement(v$1, _extends$4({ "data-state": l2 ? "visible" : "hidden" }, n2, { ref: r2 })));
}), v$1 = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { orientation: t2 = "vertical" } = _a, o2 = __objRest(_a, ["orientation"]), n2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), l2 = s$2.useRef(null), i2 = s$2.useRef(0), [a2, c2] = s$2.useState({ content: 0, viewport: 0, scrollbar: { size: 0, paddingStart: 0, paddingEnd: 0 } }), d2 = x$2(a2.viewport, a2.content), p2 = __spreadProps(__spreadValues({}, o2), { sizes: a2, onSizesChange: c2, hasThumb: Boolean(d2 > 0 && d2 < 1), onThumbChange: (e3) => l2.current = e3, onThumbPointerUp: () => i2.current = 0, onThumbPointerDown: (e3) => i2.current = e3 });
  function f2(e3, r3) {
  ...
  return t2 === "horizontal" ? /* @__PURE__ */ s$2.createElement(S, _extends$4({}, p2, { ref: r2, onThumbPositionChange: () => {
  ...
  } })) : t2 === "vertical" ? /* @__PURE__ */ s$2.createElement(g$4, _extends$4({}, p2, { ref: r2, onThumbPositionChange: () => {
    if (n2.viewport && l2.current) {
...
}), S = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { sizes: t2, onSizesChange: o2 } = _a, n2 = __objRest(_a, ["sizes", "onSizesChange"]), i2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), [a2, c2] = s$2.useState(), d2 = s$2.useRef(null), p2 = useComposedRefs(r2, d2, i2.onScrollbarXChange);
  return s$2.useEffect(() => {
    d2.current && c2(getComputedStyle(d2.current));
  }, [d2]), /* @__PURE__ */ s$2.createElement(T, _extends$4({ "data-orientation": "horizontal" }, n2, { ref: p2, sizes: t2, style: __spreadValues({ bottom: 0, left: i2.dir === "rtl" ? "var(--radix-scroll-area-corner-width)" : 0, right: i2.dir === "ltr" ? "var(--radix-scroll-area-corner-width)" : 0, "--radix-scroll-area-thumb-width": R$1(t2) + "px" }, e2.style), onThumbPointerDown: (r3) => e2.onThumbPointerDown(r3.x), onDragScroll: (r3) => e2.onDragScroll(r3.x), onWheelScroll: (r3, t3) => {
    if (i2.viewport) {
      const o3 = i2.viewport.scrollLeft + r3.deltaX;
      e2.onWheelScroll(o3), _(o3, t3) && r3.preventDefault();
    }
  }, onResize: () => {
    d2.current && i2.viewport && a2 && o2({ content: i2.viewport.scrollWidth, viewport: i2.viewport.offsetWidth, scrollbar: { size: d2.current.clientWidth, paddingStart: A$2(a2.paddingLeft), paddingEnd: A$2(a2.paddingRight) } });
  } }));
}), g$4 = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { sizes: t2, onSizesChange: o2 } = _a, n2 = __objRest(_a, ["sizes", "onSizesChange"]), i2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), [a2, c2] = s$2.useState(), d2 = s$2.useRef(null), p2 = useComposedRefs(r2, d2, i2.onScrollbarYChange);
  return s$2.useEffect(() => {
    d2.current && c2(getComputedStyle(d2.current));
    ...
    d2.current && i2.viewport && a2 && o2({ content: i2.viewport.scrollHeight, viewport: i2.viewport.offsetHeight, scrollbar: { size: d2.current.clientHeight, paddingStart: A$2(a2.paddingTop), paddingEnd: A$2(a2.paddingBottom) } });
  } }));
}), [E$1, C$1] = d$1("ScrollAreaScrollbar"), T = /* @__PURE__ */ s$2.forwardRef((r2, t2) => {
  const _a = r2, { __scopeScrollArea: o2, sizes: i2, hasThumb: a2, onThumbChange: d2, onThumbPointerUp: p2, onThumbPointerDown: f2, onThumbPositionChange: m2, onDragScroll: w2, onWheelScroll: b2, onResize: v2 } = _a, S2 = __objRest(_a, ["__scopeScrollArea", "sizes", "hasThumb", "onThumbChange", "onThumbPointerUp", "onThumbPointerDown", "onThumbPositionChange", "onDragScroll", "onWheelScroll", "onResize"]), g2 = h$4("ScrollAreaScrollbar", o2), [C2, T2] = s$2.useState(null), y2 = useComposedRefs(t2, (e2) => T2(e2)), A2 = s$2.useRef(null), x2 = s$2.useRef(""), R2 = g2.viewport, P2 = i2.content - i2.viewport, L2 = useCallbackRef$1(b2), _2 = useCallbackRef$1(m2), D2 = z$1(v2, 10);
  function W(e2) {
    if (A2.current) {
  ...
  }, [R2, C2, P2, L2]), s$2.useEffect(_2, [i2, _2]), H(C2, D2), H(g2.content, D2), /* @__PURE__ */ s$2.createElement(E$1, { scope: o2, scrollbar: C2, hasThumb: a2, onThumbChange: useCallbackRef$1(d2), onThumbPointerUp: useCallbackRef$1(p2), onThumbPositionChange: _2, onThumbPointerDown: useCallbackRef$1(f2) }, /* @__PURE__ */ s$2.createElement(Primitive.div, _extends$4({}, S2, { ref: y2, style: __spreadValues({ position: "absolute" }, S2.style), onPointerDown: composeEventHandlers(r2.onPointerDown, (e2) => {
    if (e2.button === 0) {
...
const ScrollAreaThumb = /* @__PURE__ */ s$2.forwardRef((r2, t2) => {
  const _a = r2, { __scopeScrollArea: o2, style: n2 } = _a, i2 = __objRest(_a, ["__scopeScrollArea", "style"]), a2 = h$4("ScrollbarThumb", o2), d2 = C$1("ScrollbarThumb", o2), { onThumbPositionChange: p2 } = d2, f2 = useComposedRefs(t2, (e2) => d2.onThumbChange(e2)), m2 = s$2.useRef(), w2 = z$1(() => {
  ...
  }, [a2.viewport, w2, p2]), d2.hasThumb ? /* @__PURE__ */ s$2.createElement(Primitive.div, _extends$4({}, i2, { ref: f2, style: __spreadValues({ width: "var(--radix-scroll-area-thumb-width)", height: "var(--radix-scroll-area-thumb-height)" }, n2), onPointerDownCapture: composeEventHandlers(r2.onPointerDownCapture, (e2) => {
...
function z$1(e2, r2) {
  const t2 = useCallbackRef$1(e2), o2 = s$2.useRef(0);
  return s$2.useEffect(() => () => window.clearTimeout(o2.current), []), s$2.useCallback(() => {
...
const x$1 = l$1(), [h$3, E] = C("Popover");
const Popover$1 = (e2) => {
  const { __scopePopover: o2, children: t2, open: n2, defaultOpen: c2, onOpenChange: a2, modal: s2 = false } = e2, i2 = x$1(o2), u2 = s$2.useRef(null), [d2, m2] = s$2.useState(false), [f2 = false, P2] = useControllableState({ prop: n2, defaultProp: c2, onChange: a2 });
  return s$2.createElement(Root$2, i2, /* @__PURE__ */ s$2.createElement(h$3, { scope: o2, contentId: useId(), triggerRef: u2, open: f2, onOpenChange: P2, onOpenToggle: s$2.useCallback(() => P2((e3) => !e3), [P2]), hasCustomAnchor: d2, onCustomAnchorAdd: s$2.useCallback(() => m2(true), []), onCustomAnchorRemove: s$2.useCallback(() => m2(false), []), modal: s2 }, t2));
};
const PopoverTrigger = /* @__PURE__ */ s$2.forwardRef((e2, o2) => {
  const _a = e2, { __scopePopover: r2 } = _a, n2 = __objRest(_a, ["__scopePopover"]), c2 = E("PopoverTrigger", r2), a2 = x$1(r2), s2 = useComposedRefs(o2, c2.triggerRef), i2 = /* @__PURE__ */ s$2.createElement(Primitive.button, _extends$4({ type: "button", "aria-haspopup": "dialog", "aria-expanded": c2.open, "aria-controls": c2.contentId, "data-state": w$1(c2.open) }, n2, { ref: s2, onClick: composeEventHandlers(e2.onClick, c2.onOpenToggle) }));
  return c2.hasCustomAnchor ? i2 : /* @__PURE__ */ s$2.createElement(Anchor, _extends$4({ asChild: true }, a2), i2);
});
const PopoverContent$1 = /* @__PURE__ */ s$2.forwardRef((e2, o2) => {
  const _a = e2, { forceMount: r2 } = _a, t2 = __objRest(_a, ["forceMount"]), c2 = E("PopoverContent", e2.__scopePopover);
  return s$2.createElement(Presence, { present: r2 || c2.open }, c2.modal ? /* @__PURE__ */ s$2.createElement(A$1, _extends$4({}, t2, { ref: o2 })) : /* @__PURE__ */ s$2.createElement(O, _extends$4({}, t2, { ref: o2 })));
});
const A$1 = /* @__PURE__ */ s$2.forwardRef((r2, t2) => {
  const _a = r2, { allowPinchZoom: n2, portalled: c2 = true } = _a, s2 = __objRest(_a, ["allowPinchZoom", "portalled"]), i2 = E("PopoverContent", r2.__scopePopover), p2 = s$2.useRef(null), u2 = useComposedRefs(t2, p2), l2 = s$2.useRef(false);
  s$2.useEffect(() => {
    const o2 = p2.current;
    if (o2)
      return hideOthers(o2);
  }, []);
  const d2 = c2 ? Portal : s$2.Fragment;
  return s$2.createElement(d2, null, /* @__PURE__ */ s$2.createElement(o$3, { allowPinchZoom: n2 }, /* @__PURE__ */ s$2.createElement(R, _extends$4({}, s2, { ref: u2, trapFocus: i2.open, disableOutsidePointerEvents: true, onCloseAutoFocus: composeEventHandlers(r2.onCloseAutoFocus, (e2) => {
    var o2;
...
}), O = /* @__PURE__ */ s$2.forwardRef((e2, o2) => {
  const _a = e2, { portalled: r2 = true } = _a, t2 = __objRest(_a, ["portalled"]), n2 = E("PopoverContent", e2.__scopePopover), c2 = s$2.useRef(false), s2 = r2 ? Portal : s$2.Fragment;
  return s$2.createElement(s2, null, /* @__PURE__ */ s$2.createElement(R, _extends$4({}, t2, { ref: o2, trapFocus: false, disableOutsidePointerEvents: false, onCloseAutoFocus: (o3) => {
    var r3, t3;
...
}), R = /* @__PURE__ */ s$2.forwardRef((e2, o2) => {
  ...
  return useFocusGuards(), /* @__PURE__ */ s$2.createElement(FocusScope, { asChild: true, loop: true, trapped: t2, onMountAutoFocus: n2, onUnmountAutoFocus: a2 }, /* @__PURE__ */ s$2.createElement(DismissableLayer, { asChild: true, disableOutsidePointerEvents: u2, onInteractOutside: f2, onEscapeKeyDown: l2, onPointerDownOutside: d2, onFocusOutside: m2, onDismiss: () => g2.onOpenChange(false) }, /* @__PURE__ */ s$2.createElement(Content$1, _extends$4({ "data-state": w$1(g2.open), role: "dialog", id: g2.contentId }, h, C2, { ref: o2, style: __spreadProps(__spreadValues({}, C2.style), { "--radix-popover-content-transform-origin": "var(--radix-popper-transform-origin)" }) }))));
});
function w$1(e2) {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f$1$1 = s__default, g$1$1 = 60103;
reactJsxRuntime_production_min$1.Fragment = 60107;
if (typeof Symbol === "function" && Symbol.for) {
  var h$1$1 = Symbol.for;
  g$1$1 = h$1$1("react.element");
  reactJsxRuntime_production_min$1.Fragment = h$1$1("react.fragment");
}
var m$1$1 = f$1$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, n$1$1 = Object.prototype.hasOwnProperty, p$1$1 = { key: true, ref: true, __self: true, __source: true };
function q$1$1(c2, a2, k2) {
  var b2, d2 = {}, e2 = null, l2 = null;
  k2 !== void 0 && (e2 = "" + k2);
  a2.key !== void 0 && (e2 = "" + a2.key);
  a2.ref !== void 0 && (l2 = a2.ref);
  for (b2 in a2)
    n$1$1.call(a2, b2) && !p$1$1.hasOwnProperty(b2) && (d2[b2] = a2[b2]);
  if (c2 && c2.defaultProps)
    for (b2 in a2 = c2.defaultProps, a2)
      d2[b2] === void 0 && (d2[b2] = a2[b2]);
  return { $$typeof: g$1$1, type: c2, key: e2, ref: l2, props: d2, _owner: m$1$1.current };
}
reactJsxRuntime_production_min$1.jsx = q$1$1;
reactJsxRuntime_production_min$1.jsxs = q$1$1;
{
...
function Switch(props) {
  ...
  return /* @__PURE__ */ jsx$1(SwitchRaw, __spreadProps2(__spreadValues2(__spreadValues2({}, field), props), {
...
const Separator = s__default.forwardRef((_C, ref) => {
  ...
  return /* @__PURE__ */ jsx$1(Root$3, __spreadProps2(__spreadValues2({
    ref
  }, props), {
    asChild: true,
...
function Input(props) {
  ...
  return /* @__PURE__ */ jsx$1(InputRaw, __spreadProps2(__spreadValues2(__spreadValues2({}, field), props), {
    ...
    var runInContext = function runInContext2(context) {
      ...
      function baseSet(object2, path, value, customizer) {
        ...
        while (nested != null && ++index < length2) {
          ...
          if (index != lastIndex) {
            ...
            if (newValue === undefined$1) {
              newValue = isObject22(objValue) ? objValue : isIndex2(path[index + 1]) ? [] : {};
            }
          }
      ...
      function createCtor(Ctor) {
        return function() {
          ...
          return isObject22(result2) ? result2 : thisBinding;
        };
      }
      ...
      function mixin2(object2, source, options) {
        ...
        var chain2 = !(isObject22(options) && "chain" in options) || !!options.chain, isFunc = isFunction2(object2);
...
const ReactComponent$3 = (props) => /* @__PURE__ */ s$2.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
  viewBox: "0 0 15 15"
}, props), /* @__PURE__ */ s$2.createElement("path", {
  d: "M-158.762,87.6l1.484,4.019h2.125l1.391-4.019Z",
  transform: "translate(163.762 -86.099)",
  fill: "currentColor"
}), /* @__PURE__ */ s$2.createElement("path", {
...
const ReactComponent$2 = (props) => /* @__PURE__ */ s$2.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
...
}), /* @__PURE__ */ s$2.createElement("rect", {
  id: "Rettangolo_1",
...
const ReactComponent$1 = (props) => /* @__PURE__ */ s$2.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
  viewBox: "0 0 15 15",
  fill: "currentColor"
}, props), /* @__PURE__ */ s$2.createElement("rect", {
  id: "Rettangolo_1",
  "data-name": "Rettangolo 1",
  width: 7,
  height: 7,
...
const ReactComponent = (props) => /* @__PURE__ */ s$2.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
...
reactIs_production_min.isValidElementType = function(a2) {
  return typeof a2 === "string" || typeof a2 === "function" || a2 === e || a2 === m$1 || a2 === g$1 || a2 === f$1 || a2 === p$1 || a2 === q$1 || typeof a2 === "object" && a2 !== null && (a2.$$typeof === t || a2.$$typeof === r || a2.$$typeof === h$1 || a2.$$typeof === k || a2.$$typeof === n$1 || a2.$$typeof === w || a2.$$typeof === x || a2.$$typeof === y || a2.$$typeof === v);
};
...
__assign(__assign({}, DEFAULT_INTL_CONFIG), { textComponent: s$2.Fragment });
var IntlContext = s$2.createContext(null);
IntlContext.Consumer;
IntlContext.Provider;
var Context = IntlContext;
function useIntl() {
  var intl = s$2.useContext(Context);
