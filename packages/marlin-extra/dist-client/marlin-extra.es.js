...
import { ChevronRightIcon, CaretDownIcon, QuestionMarkCircledIcon, Cross2Icon } from "@radix-ui/react-icons";
import * as s$2 from "react";
import s__default, { createContext as createContext$1, forwardRef, createElement, useContext, useState, useMemo } from "react";
...
const Slot = /* @__PURE__ */ s$2.forwardRef((e2, o2) => {
  ...
  return s$2.Children.toArray(a2).some(l$3) ? /* @__PURE__ */ s$2.createElement(s$2.Fragment, null, s$2.Children.map(a2, (e3) => l$3(e3) ? /* @__PURE__ */ s$2.createElement(n$8, _extends$4({}, s2, { ref: o2 }), e3.props.children) : e3)) : /* @__PURE__ */ s$2.createElement(n$8, _extends$4({}, s2, { ref: o2 }), a2);
});
...
const r$4 = s$2["useId".toString()] || (() => {
});
let n$7 = 0;
function useId(o2) {
  const [u2, i2] = s$2.useState(r$4());
...
const [l$2, u$2] = createContextScope("Switch");
const [p$6, m$6] = l$2("Switch");
const Switch = /* @__PURE__ */ s$2.forwardRef((r2, o2) => {
  ...
  }) })), P2 && /* @__PURE__ */ s$2.createElement(b$2, { control: y2, bubbles: !T2.current, name: u2, value: w2, checked: _2, required: x2, disabled: k2, style: { transform: "translateX(-100%)" } }));
});
 ...
 */
var b$1 = typeof Symbol === "function" && Symbol.for, c$4 = b$1 ? Symbol.for("react.element") : 60103, d$4 = b$1 ? Symbol.for("react.portal") : 60106, e$3 = b$1 ? Symbol.for("react.fragment") : 60107, f$6 = b$1 ? Symbol.for("react.strict_mode") : 60108, g$5 = b$1 ? Symbol.for("react.profiler") : 60114, h$5 = b$1 ? Symbol.for("react.provider") : 60109, k = b$1 ? Symbol.for("react.context") : 60110, l$1 = b$1 ? Symbol.for("react.async_mode") : 60111, m$5 = b$1 ? Symbol.for("react.concurrent_mode") : 60111, n$6 = b$1 ? Symbol.for("react.forward_ref") : 60112, p$5 = b$1 ? Symbol.for("react.suspense") : 60113, q$3 = b$1 ? Symbol.for("react.suspense_list") : 60120, r$3 = b$1 ? Symbol.for("react.memo") : 60115, t$3 = b$1 ? Symbol.for("react.lazy") : 60116, v$1 = b$1 ? Symbol.for("react.block") : 60121, w$2 = b$1 ? Symbol.for("react.fundamental") : 60117, x$2 = b$1 ? Symbol.for("react.responder") : 60118, y = b$1 ? Symbol.for("react.scope") : 60119;
function z$1(a2) {
...
reactIs_production_min.isValidElementType = function(a2) {
  return typeof a2 === "string" || typeof a2 === "function" || a2 === e$3 || a2 === m$5 || a2 === g$5 || a2 === f$6 || a2 === p$5 || a2 === q$3 || typeof a2 === "object" && a2 !== null && (a2.$$typeof === t$3 || a2.$$typeof === r$3 || a2.$$typeof === h$5 || a2.$$typeof === k || a2.$$typeof === n$6 || a2.$$typeof === w$2 || a2.$$typeof === x$2 || a2.$$typeof === y || a2.$$typeof === v$1);
};
...
var SideCar$1 = function(_a) {
  ...
  return s$2.createElement(Target, __assign({}, rest));
};
...
var ReactRemoveScroll = s$2.forwardRef(function(props, ref) {
  return s$2.createElement(RemoveScroll, __assign$1({}, props, { ref, sideCar: SideCar }));
});
...
const Portal = /* @__PURE__ */ s$2.forwardRef((a2, i2) => {
  ...
  return useLayoutEffect(() => {
    f2({});
  }, []), m2 ? /* @__PURE__ */ e$4.createPortal(/* @__PURE__ */ s$2.createElement(Primitive.div, _extends$4({ "data-radix-portal": "" }, c2, { ref: i2, style: m2 === document.body ? __spreadValues({ position: "absolute", top: 0, left: 0, zIndex: 2147483647 }, u2) : void 0 })), m2) : null;
});
...
const PopperAnchor = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const _a = e2, { __scopePopper: t2, virtualRef: n2 } = _a, p2 = __objRest(_a, ["__scopePopper", "virtualRef"]), c2 = d$1("PopperAnchor", t2), l2 = s$2.useRef(null), f2 = useComposedRefs(r2, l2);
  return s$2.useEffect(() => {
...
const ScrollAreaScrollbar = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  ...
  }), [a2, l2, i2]), n2.type === "hover" ? /* @__PURE__ */ s$2.createElement(m$3, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "scroll" ? /* @__PURE__ */ s$2.createElement(w$1, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "auto" ? /* @__PURE__ */ s$2.createElement(b, _extends$4({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "always" ? /* @__PURE__ */ s$2.createElement(v, _extends$4({}, o2, { ref: r2 })) : null;
});
const m$3 = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  ...
  }, [n2.scrollArea, n2.scrollHideDelay]), /* @__PURE__ */ s$2.createElement(Presence, { present: t2 || l2 }, /* @__PURE__ */ s$2.createElement(b, _extends$4({ "data-state": l2 ? "visible" : "hidden" }, o2, { ref: r2 })));
}), w$1 = /* @__PURE__ */ s$2.forwardRef((r2, t2) => {
  const _a = r2, { forceMount: o2 } = _a, n2 = __objRest(_a, ["forceMount"]), l2 = h$4("ScrollAreaScrollbar", r2.__scopeScrollArea), i2 = r2.orientation === "horizontal", c2 = z(() => p2("SCROLL_END"), 100), [d2, p2] = (f2 = "hidden", m2 = { hidden: { SCROLL: "scrolling" }, scrolling: { SCROLL_END: "idle", POINTER_ENTER: "interacting" }, interacting: { SCROLL: "interacting", POINTER_LEAVE: "idle" }, idle: { HIDE: "hidden", SCROLL: "scrolling", POINTER_ENTER: "interacting" } }, s$2.useReducer((e2, r3) => {
    const t3 = m2[e2][r3];
  ...
  }, [l2.viewport, i2, p2, c2]), /* @__PURE__ */ s$2.createElement(Presence, { present: o2 || d2 !== "hidden" }, /* @__PURE__ */ s$2.createElement(v, _extends$4({ "data-state": d2 === "hidden" ? "hidden" : "visible" }, n2, { ref: t2, onPointerEnter: composeEventHandlers(r2.onPointerEnter, () => p2("POINTER_ENTER")), onPointerLeave: composeEventHandlers(r2.onPointerLeave, () => p2("POINTER_LEAVE")) })));
}), b = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
  const t2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), _a = e2, { forceMount: o2 } = _a, n2 = __objRest(_a, ["forceMount"]), [l2, i2] = s$2.useState(false), c2 = e2.orientation === "horizontal", d2 = z(() => {
    if (t2.viewport) {
      const e3 = t2.viewport.offsetWidth < t2.viewport.scrollWidth, r3 = t2.viewport.offsetHeight < t2.viewport.scrollHeight;
      i2(c2 ? e3 : r3);
    }
  }, 10);
  return H(t2.viewport, d2), H(t2.content, d2), /* @__PURE__ */ s$2.createElement(Presence, { present: o2 || l2 }, /* @__PURE__ */ s$2.createElement(v, _extends$4({ "data-state": l2 ? "visible" : "hidden" }, n2, { ref: r2 })));
}), v = /* @__PURE__ */ s$2.forwardRef((e2, r2) => {
...
}), [E$1, C$1] = d("ScrollAreaScrollbar"), T = /* @__PURE__ */ s$2.forwardRef((r2, t2) => {
...
const ScrollAreaThumb = /* @__PURE__ */ s$2.forwardRef((r2, t2) => {
  const _a = r2, { __scopeScrollArea: o2, style: n2 } = _a, i2 = __objRest(_a, ["__scopeScrollArea", "style"]), a2 = h$4("ScrollbarThumb", o2), d2 = C$1("ScrollbarThumb", o2), { onThumbPositionChange: p2 } = d2, f2 = useComposedRefs(t2, (e2) => d2.onThumbChange(e2)), m2 = s$2.useRef(), w2 = z(() => {
...
const Popover$1 = (e2) => {
  const { __scopePopover: o2, children: t2, open: n2, defaultOpen: c2, onOpenChange: a2, modal: s2 = false } = e2, i2 = x(o2), u2 = s$2.useRef(null), [d2, m2] = s$2.useState(false), [f2 = false, P2] = useControllableState({ prop: n2, defaultProp: c2, onChange: a2 });
...
const PopoverContent$1 = /* @__PURE__ */ s$2.forwardRef((e2, o2) => {
  ...
  return s$2.createElement(Presence, { present: r2 || c2.open }, c2.modal ? /* @__PURE__ */ s$2.createElement(A, _extends$4({}, t2, { ref: o2 })) : /* @__PURE__ */ s$2.createElement(O, _extends$4({}, t2, { ref: o2 })));
});
const A = /* @__PURE__ */ s$2.forwardRef((r2, t2) => {
  ...
  return useFocusGuards(), /* @__PURE__ */ s$2.createElement(FocusScope, { asChild: true, loop: true, trapped: t2, onMountAutoFocus: n2, onUnmountAutoFocus: a2 }, /* @__PURE__ */ s$2.createElement(DismissableLayer, { asChild: true, disableOutsidePointerEvents: u2, onInteractOutside: f2, onEscapeKeyDown: l2, onPointerDownOutside: d2, onFocusOutside: m2, onDismiss: () => g2.onOpenChange(false) }, /* @__PURE__ */ s$2.createElement(Content$1, _extends$4({ "data-state": w(g2.open), role: "dialog", id: g2.contentId }, h, C2, { ref: o2, style: __spreadProps(__spreadValues({}, C2.style), { "--radix-popover-content-transform-origin": "var(--radix-popper-transform-origin)" }) }))));
});
function w(e2) {
