...
import React__default, { useContext, createContext, forwardRef, createElement, useState, useMemo } from "react";
...
function GRBLMoveWidget() {
  const {
    device
  } = useDeviceContext();
  function handleMove() {
    console.log("Requesting move");
    socket$1.emit("move:x", device.id, 123, (res) => {
