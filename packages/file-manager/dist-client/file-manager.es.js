...
import * as s$4 from "react";
import s__default, { useMemo, useContext, createContext, forwardRef, createElement, useState, useEffect, useRef } from "react";
import { useIntl } from "react-intl";
import { ChevronRightIcon, CaretDownIcon, QuestionMarkCircledIcon, ChevronDownIcon, FileIcon, DownloadIcon, TrashIcon, Share2Icon, DotsVerticalIcon, Cross2Icon, FilePlusIcon, CardStackIcon } from "@radix-ui/react-icons";
...
for (var i$8 = 0; i$8 < chars$1.length; i$8++) {
  lookup$3[chars$1.charCodeAt(i$8)] = i$8;
}
...
var alphabet$1 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), length$1 = 64, map$2 = {}, seed$1 = 0, i$7 = 0, prev$1;
...
function decode$2(str) {
  var decoded = 0;
  for (i$7 = 0; i$7 < str.length; i$7++) {
    decoded = decoded * length$1 + map$2[str.charAt(i$7)];
  }
  return decoded;
}
function yeast$1() {
...
for (; i$7 < length$1; i$7++)
  map$2[alphabet$1[i$7]] = i$7;
...
const AppContext = s__default.createContext();
...
const DeviceContext = s__default.createContext();
...
function usePlugin(nameOrURL) {
  ...
  return useMemo((_2) => plugins.find((plugin) => plugin.url == nameOrURL || plugin.name === nameOrURL), [nameOrURL, plugins]);
}
 ...
 */
var f$9 = s__default, g$7 = 60103;
reactJsxRuntime_production_min$3.Fragment = 60107;
if (typeof Symbol === "function" && Symbol.for) {
  var h$6 = Symbol.for;
  g$7 = h$6("react.element");
  reactJsxRuntime_production_min$3.Fragment = h$6("react.fragment");
}
var m$9 = f$9.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, n$a = Object.prototype.hasOwnProperty, p$9 = { key: true, ref: true, __self: true, __source: true };
function q$4(c2, a2, k2) {
  var b2, d2 = {}, e2 = null, l2 = null;
  k2 !== void 0 && (e2 = "" + k2);
  a2.key !== void 0 && (e2 = "" + a2.key);
  a2.ref !== void 0 && (l2 = a2.ref);
  for (b2 in a2)
    n$a.call(a2, b2) && !p$9.hasOwnProperty(b2) && (d2[b2] = a2[b2]);
  if (c2 && c2.defaultProps)
    for (b2 in a2 = c2.defaultProps, a2)
      d2[b2] === void 0 && (d2[b2] = a2[b2]);
  return { $$typeof: g$7, type: c2, key: e2, ref: l2, props: d2, _owner: m$9.current };
}
reactJsxRuntime_production_min$3.jsx = q$4;
reactJsxRuntime_production_min$3.jsxs = q$4;
{
  jsxRuntime$3.exports = reactJsxRuntime_production_min$3;
}
jsxRuntime$3.exports.jsx;
function useCallbackRef$1(r2) {
  const t2 = s$4.useRef(r2);
  return s$4.useEffect(() => {
    t2.current = r2;
  }), s$4.useMemo(() => (...e2) => {
    var r3;
...
function useComposedRefs(...e2) {
  return s$4.useCallback(composeRefs(...e2), e2);
}
function _extends() {
...
const Slot = /* @__PURE__ */ s$4.forwardRef((e2, o2) => {
  const _a = e2, { children: a2 } = _a, s2 = __objRest(_a, ["children"]);
  return s$4.Children.toArray(a2).some(l$5) ? /* @__PURE__ */ s$4.createElement(s$4.Fragment, null, s$4.Children.map(a2, (e3) => l$5(e3) ? /* @__PURE__ */ s$4.createElement(n$9, _extends({}, s2, { ref: o2 }), e3.props.children) : e3)) : /* @__PURE__ */ s$4.createElement(n$9, _extends({}, s2, { ref: o2 }), a2);
});
Slot.displayName = "Slot";
const n$9 = /* @__PURE__ */ s$4.forwardRef((r2, n2) => {
  const _a = r2, { children: l2 } = _a, a2 = __objRest(_a, ["children"]);
  return s$4.isValidElement(l2) ? /* @__PURE__ */ s$4.cloneElement(l2, __spreadProps(__spreadValues({}, o$5(a2, l2.props)), { ref: composeRefs(n2, l2.ref) })) : s$4.Children.count(l2) > 1 ? s$4.Children.only(null) : null;
});
n$9.displayName = "SlotClone";
const Slottable = ({ children: e2 }) => /* @__PURE__ */ s$4.createElement(s$4.Fragment, null, e2);
function l$5(e2) {
  return s$4.isValidElement(e2) && e2.type === Slottable;
}
function o$5(e2, t2) {
...
const Primitive = ["a", "button", "div", "h2", "h3", "img", "li", "nav", "ol", "p", "span", "svg", "ul"].reduce((o2, i2) => __spreadProps(__spreadValues({}, o2), { [i2]: /* @__PURE__ */ s$4.forwardRef((o3, m2) => {
  const _a = o3, { asChild: a2 } = _a, s2 = __objRest(_a, ["asChild"]), n2 = a2 ? Slot : i2;
  return s$4.useEffect(() => {
    window[Symbol.for("radix-ui")] = true;
  }, []), /* @__PURE__ */ s$4.createElement(n2, _extends({}, s2, { ref: m2 }));
}) }), {});
...
const useLayoutEffect = Boolean(globalThis === null || globalThis === void 0 ? void 0 : globalThis.document) ? s$4.useLayoutEffect : () => {
};
const r$4 = s$4["useId".toString()] || (() => {
});
let n$8 = 0;
function useId(o2) {
  const [u2, i2] = s$4.useState(r$4());
  return useLayoutEffect(() => {
    o2 || i2((t2) => t2 != null ? t2 : String(n$8++));
  }, [o2]), o2 || (u2 ? `radix-${u2}` : "");
}
function createContextScope(n2, o2 = []) {
  let r2 = [];
  const c2 = () => {
    const t2 = r2.map((t3) => /* @__PURE__ */ s$4.createContext(t3));
    return function(o3) {
      const r3 = (o3 == null ? void 0 : o3[n2]) || t2;
      return s$4.useMemo(() => ({ [`__scope${n2}`]: __spreadProps(__spreadValues({}, o3), { [n2]: r3 }) }), [o3, r3]);
    };
  };
  return c2.scopeName = n2, [function(t2, o3) {
    const c3 = /* @__PURE__ */ s$4.createContext(o3), u2 = r2.length;
    function s2(t3) {
      const _a = t3, { scope: o4, children: r3 } = _a, s3 = __objRest(_a, ["scope", "children"]), i2 = (o4 == null ? void 0 : o4[n2][u2]) || c3, a2 = s$4.useMemo(() => s3, Object.values(s3));
      return s$4.createElement(i2.Provider, { value: a2 }, r3);
    }
    return r2 = [...r2, o3], s2.displayName = t2 + "Provider", [s2, function(r3, s3) {
      const i2 = (s3 == null ? void 0 : s3[n2][u2]) || c3, a2 = s$4.useContext(i2);
      if (a2)
        return a2;
      if (o3 !== void 0)
        return o3;
...
function t$4(...t2) {
  ...
  const o2 = () => {
    ...
    return function(t3) {
      ...
      return s$4.useMemo(() => ({ [`__scope${n2.scopeName}`]: r2 }), [r2]);
    };
  };
...
function createCollection(c2) {
  const n2 = c2 + "CollectionProvider", [l2, i2] = createContextScope(n2), [f2, a2] = l2(n2, { collectionRef: { current: null }, itemMap: /* @__PURE__ */ new Map() }), u2 = (e2) => {
    const { scope: r2, children: t2 } = e2, c3 = s__default.useRef(null), n3 = s__default.useRef(/* @__PURE__ */ new Map()).current;
    return s__default.createElement(f2, { scope: r2, itemMap: n3, collectionRef: c3 }, t2);
  }, m2 = c2 + "CollectionSlot", s2 = /* @__PURE__ */ s__default.forwardRef((t2, c3) => {
    const { scope: n3, children: l3 } = t2, i3 = a2(m2, n3), f3 = useComposedRefs(c3, i3.collectionRef);
    return s__default.createElement(Slot, { ref: f3 }, l3);
  }), p2 = c2 + "CollectionItemSlot", d2 = "data-radix-collection-item", R2 = /* @__PURE__ */ s__default.forwardRef((t2, c3) => {
    const _a = t2, { scope: n3, children: l3 } = _a, i3 = __objRest(_a, ["scope", "children"]), f3 = s__default.useRef(null), u3 = useComposedRefs(c3, f3), m3 = a2(p2, n3);
    return s__default.useEffect(() => (m3.itemMap.set(f3, __spreadValues({ ref: f3 }, i3)), () => {
      m3.itemMap.delete(f3);
    })), /* @__PURE__ */ s__default.createElement(Slot, { [d2]: "", ref: u3 }, l3);
  });
  return [{ Provider: u2, Slot: s2, ItemSlot: R2 }, function(e2) {
    const r2 = a2(c2 + "CollectionConsumer", e2);
    return s__default.useCallback(() => {
...
const f$8 = { bubbles: false, cancelable: true }, [p$8, l$4, m$8] = createCollection("RovingFocusGroup"), [d$6, v$2] = createContextScope("RovingFocusGroup", [m$8]);
const [g$6, F$1] = d$6("RovingFocusGroup");
const RovingFocusGroup = /* @__PURE__ */ s$4.forwardRef((e2, o2) => /* @__PURE__ */ s$4.createElement(p$8.Provider, { scope: e2.__scopeRovingFocusGroup }, /* @__PURE__ */ s$4.createElement(p$8.Slot, { scope: e2.__scopeRovingFocusGroup }, /* @__PURE__ */ s$4.createElement(w$3, _extends({}, e2, { ref: o2 })))));
const w$3 = /* @__PURE__ */ s$4.forwardRef((t2, n2) => {
  const _a = t2, { __scopeRovingFocusGroup: c2, orientation: p2, dir: m2 = "ltr", loop: d2 = false, currentTabStopId: v2, defaultCurrentTabStopId: F2, onCurrentTabStopIdChange: w2, onEntryFocus: b2 } = _a, x2 = __objRest(_a, ["__scopeRovingFocusGroup", "orientation", "dir", "loop", "currentTabStopId", "defaultCurrentTabStopId", "onCurrentTabStopIdChange", "onEntryFocus"]), E2 = s$4.useRef(null), I2 = useComposedRefs(n2, E2), [G2 = null, h] = useControllableState({ prop: v2, defaultProp: F2, onChange: w2 }), [T2, A2] = s$4.useState(false), y2 = useCallbackRef$1(b2), D2 = l$4(c2), S2 = s$4.useRef(false);
  return s$4.useEffect(() => {
    const e2 = E2.current;
    if (e2)
      return e2.addEventListener("rovingFocusGroup.onEntryFocus", y2), () => e2.removeEventListener("rovingFocusGroup.onEntryFocus", y2);
  }, [y2]), /* @__PURE__ */ s$4.createElement(g$6, { scope: c2, orientation: p2, dir: m2, loop: d2, currentTabStopId: G2, onItemFocus: s$4.useCallback((e2) => h(e2), [h]), onItemShiftTab: s$4.useCallback(() => A2(true), []) }, /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({ tabIndex: T2 ? -1 : 0, "data-orientation": p2 }, x2, { ref: I2, style: __spreadValues({ outline: "none" }, t2.style), onMouseDown: composeEventHandlers(t2.onMouseDown, () => {
    S2.current = true;
  }), onFocus: composeEventHandlers(t2.onFocus, (e2) => {
    const o2 = !S2.current;
    if (e2.target === e2.currentTarget && o2 && !T2) {
      const o3 = new Event("rovingFocusGroup.onEntryFocus", f$8);
...
const RovingFocusGroupItem = /* @__PURE__ */ s$4.forwardRef((e2, o2) => {
  const _a = e2, { __scopeRovingFocusGroup: n2, focusable: i2 = true, active: c2 = false } = _a, f2 = __objRest(_a, ["__scopeRovingFocusGroup", "focusable", "active"]), m2 = useId(), d2 = F$1("RovingFocusGroupItem", n2), v2 = d2.currentTabStopId === m2, g2 = l$4(n2);
  return s$4.createElement(p$8.ItemSlot, { scope: n2, id: m2, focusable: i2, active: c2 }, /* @__PURE__ */ s$4.createElement(Primitive.span, _extends({ tabIndex: v2 ? 0 : -1, "data-orientation": d2.orientation }, f2, { ref: o2, onMouseDown: composeEventHandlers(e2.onMouseDown, (e3) => {
...
const Root$7 = RovingFocusGroup;
const Item$3 = RovingFocusGroupItem;
function useSize(r2) {
  const [i2, t2] = s$4.useState(void 0);
  return s$4.useEffect(() => {
    if (r2) {
...
function useDirection(t2, n2) {
  const [r2, o2] = s$4.useState("ltr"), [i2, u2] = s$4.useState(), c2 = s$4.useRef(0);
  return s$4.useEffect(() => {
    if (n2 === void 0 && t2 != null && t2.parentElement) {
      const e2 = getComputedStyle(t2.parentElement);
      u2(e2);
    }
  }, [t2, n2]), s$4.useEffect(() => (n2 === void 0 && function e2() {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var b$2 = typeof Symbol === "function" && Symbol.for, c$5 = b$2 ? Symbol.for("react.element") : 60103, d$5 = b$2 ? Symbol.for("react.portal") : 60106, e$3 = b$2 ? Symbol.for("react.fragment") : 60107, f$7 = b$2 ? Symbol.for("react.strict_mode") : 60108, g$5 = b$2 ? Symbol.for("react.profiler") : 60114, h$5 = b$2 ? Symbol.for("react.provider") : 60109, k$1 = b$2 ? Symbol.for("react.context") : 60110, l$3 = b$2 ? Symbol.for("react.async_mode") : 60111, m$7 = b$2 ? Symbol.for("react.concurrent_mode") : 60111, n$7 = b$2 ? Symbol.for("react.forward_ref") : 60112, p$7 = b$2 ? Symbol.for("react.suspense") : 60113, q$3 = b$2 ? Symbol.for("react.suspense_list") : 60120, r$3 = b$2 ? Symbol.for("react.memo") : 60115, t$3 = b$2 ? Symbol.for("react.lazy") : 60116, v$1 = b$2 ? Symbol.for("react.block") : 60121, w$2 = b$2 ? Symbol.for("react.fundamental") : 60117, x$4 = b$2 ? Symbol.for("react.responder") : 60118, y$1 = b$2 ? Symbol.for("react.scope") : 60119;
function z$1(a2) {
...
reactIs_production_min.Element = c$5;
...
reactIs_production_min.Portal = d$5;
reactIs_production_min.Profiler = g$5;
reactIs_production_min.StrictMode = f$7;
reactIs_production_min.Suspense = p$7;
reactIs_production_min.isAsyncMode = function(a2) {
  return A$3(a2) || z$1(a2) === l$3;
};
...
reactIs_production_min.isElement = function(a2) {
  return typeof a2 === "object" && a2 !== null && a2.$$typeof === c$5;
};
...
reactIs_production_min.isValidElementType = function(a2) {
  return typeof a2 === "string" || typeof a2 === "function" || a2 === e$3 || a2 === m$7 || a2 === g$5 || a2 === f$7 || a2 === p$7 || a2 === q$3 || typeof a2 === "object" && a2 !== null && (a2.$$typeof === t$3 || a2.$$typeof === r$3 || a2.$$typeof === h$5 || a2.$$typeof === k$1 || a2.$$typeof === n$7 || a2.$$typeof === w$2 || a2.$$typeof === x$4 || a2.$$typeof === y$1 || a2.$$typeof === v$1);
};
...
var SideCar$1 = function(_a) {
  ...
  return s$4.createElement(Target, __assign({}, rest));
};
...
var RemoveScroll = s$4.forwardRef(function(props, parentRef) {
  var ref = s$4.useRef(null);
  var _a = s$4.useState({
  ...
  return s$4.createElement(s$4.Fragment, null, enabled && s$4.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref }), forwardProps ? s$4.cloneElement(s$4.Children.only(children), __assign$1({}, containerProps, { ref: containerRef })) : s$4.createElement(Container, __assign$1({}, containerProps, { className, ref: containerRef }), children));
});
...
var RemoveScrollBar = function(props) {
  var _a = s$4.useState(getGapWidth(props.gapMode)), gap = _a[0], setGap = _a[1];
  s$4.useEffect(function() {
    setGap(getGapWidth(props.gapMode));
  }, [props.gapMode]);
  var noRelative = props.noRelative, noImportant = props.noImportant, _b = props.gapMode, gapMode = _b === void 0 ? "margin" : _b;
  return s$4.createElement(Style, { styles: getStyles(gap, !noRelative, gapMode, !noImportant ? "!important" : "") });
};
...
function RemoveScrollSideCar(props) {
  var shouldPreventQueue = s$4.useRef([]);
  var touchStartRef = s$4.useRef([0, 0]);
  var activeAxis = s$4.useRef();
  var id = s$4.useState(idCounter++)[0];
  var Style2 = s$4.useState(function() {
    return styleSingleton();
  })[0];
  var lastProps = s$4.useRef(props);
  s$4.useEffect(function() {
  ...
  var shouldCancelEvent = s$4.useCallback(function(event, parent) {
  ...
  var shouldPrevent = s$4.useCallback(function(_event) {
    var event = _event;
  ...
  var shouldCancel = s$4.useCallback(function(name, delta, target, should) {
  ...
  var scrollTouchStart = s$4.useCallback(function(event) {
    touchStartRef.current = getTouchXY(event);
    activeAxis.current = void 0;
  }, []);
  var scrollWheel = s$4.useCallback(function(event) {
    shouldCancel(event.type, getDeltaXY(event), event.target, shouldCancelEvent(event, props.lockRef.current));
  }, []);
  var scrollTouchMove = s$4.useCallback(function(event) {
  ...
  return s$4.createElement(s$4.Fragment, null, inert ? s$4.createElement(Style2, { styles: generateStyle(id) }) : null, removeScrollBar ? s$4.createElement(RemoveScrollBar, { gapMode: "margin" }) : null);
}
var SideCar = exportSidecar(effectCar, RemoveScrollSideCar);
var ReactRemoveScroll = s$4.forwardRef(function(props, ref) {
  return s$4.createElement(RemoveScroll, __assign$1({}, props, { ref, sideCar: SideCar }));
});
...
function useFocusGuards() {
  s$4.useEffect(() => {
    ...
    return document.body.insertAdjacentElement("afterbegin", (e2 = r2[0]) !== null && e2 !== void 0 ? e2 : o$3()), document.body.insertAdjacentElement("beforeend", (n2 = r2[1]) !== null && n2 !== void 0 ? n2 : o$3()), t$2++, () => {
...
const Presence = (u2) => {
  const { present: o2, children: i2 } = u2, s2 = function(n2) {
    const [u3, o3] = s$4.useState(), i3 = s$4.useRef({}), s3 = s$4.useRef(n2), c3 = s$4.useRef("none"), a3 = n2 ? "mounted" : "unmounted", [d2, m2] = function(e2, n3) {
      return s$4.useReducer((e3, t2) => {
        const r2 = n3[e3][t2];
    ...
    return s$4.useEffect(() => {
      ...
      m2("ANIMATION_END");
    }, [u3, m2]), { isPresent: ["mounted", "unmountSuspended"].includes(d2), ref: s$4.useCallback((e2) => {
      e2 && (i3.current = getComputedStyle(e2)), o3(e2);
    }, []) };
  }(o2), c2 = typeof i2 == "function" ? i2({ present: s2.isPresent }) : s$4.Children.only(i2), a2 = useComposedRefs(s2.ref, c2.ref);
  return typeof i2 == "function" || s2.isPresent ? /* @__PURE__ */ s$4.cloneElement(c2, { ref: a2 }) : null;
};
function r$2(e2) {
  return (e2 == null ? void 0 : e2.animationName) || "none";
}
Presence.displayName = "Presence";
const Portal = /* @__PURE__ */ s$4.forwardRef((a2, i2) => {
  var n2, d2;
  const _a = a2, { containerRef: s2, style: u2 } = _a, c2 = __objRest(_a, ["containerRef", "style"]), m2 = (n2 = s2 == null ? void 0 : s2.current) !== null && n2 !== void 0 ? n2 : globalThis === null || globalThis === void 0 || (d2 = globalThis.document) === null || d2 === void 0 ? void 0 : d2.body, [, f2] = s$4.useState({});
  return useLayoutEffect(() => {
    f2({});
  }, []), m2 ? /* @__PURE__ */ e$4.createPortal(/* @__PURE__ */ s$4.createElement(Primitive.div, _extends({ "data-radix-portal": "" }, c2, { ref: i2, style: m2 === document.body ? __spreadValues({ position: "absolute", top: 0, left: 0, zIndex: 2147483647 }, u2) : void 0 })), m2) : null;
});
const c$4 = { bubbles: false, cancelable: true };
const FocusScope = /* @__PURE__ */ s$4.forwardRef((i2, f2) => {
  const _a = i2, { loop: l2 = false, trapped: m2 = false, onMountAutoFocus: p2, onUnmountAutoFocus: v2 } = _a, E2 = __objRest(_a, ["loop", "trapped", "onMountAutoFocus", "onUnmountAutoFocus"]), [F2, S2] = s$4.useState(null), b2 = useCallbackRef$1(p2), T2 = useCallbackRef$1(v2), y2 = s$4.useRef(null), L2 = useComposedRefs(f2, (e2) => S2(e2)), h = s$4.useRef({ paused: false, pause() {
    this.paused = true;
  }, resume() {
    this.paused = false;
  } }).current;
    ...
    if (m2) {
      let e2 = function(e3) {
        if (h.paused || !F2)
          return;
        const t3 = e3.target;
        F2.contains(t3) ? y2.current = t3 : a$1(y2.current, { select: true });
      }, t2 = function(e3) {
        !h.paused && F2 && (F2.contains(e3.relatedTarget) || a$1(y2.current, { select: true }));
      };
  ...
  }, [m2, F2, h.paused]), s$4.useEffect(() => {
    if (F2) {
      d$4.add(h);
      const t2 = document.activeElement;
      if (!F2.contains(t2)) {
        const n2 = new Event("focusScope.autoFocusOnMount", c$4);
        F2.addEventListener("focusScope.autoFocusOnMount", b2), F2.dispatchEvent(n2), n2.defaultPrevented || (!function(e3, { select: t3 = false } = {}) {
          ...
          for (const o2 of e3)
            if (a$1(o2, { select: t3 }), document.activeElement !== n3)
              return;
        }((e2 = r$1(F2), e2.filter((e3) => e3.tagName !== "A")), { select: true }), document.activeElement === t2 && a$1(F2));
      }
      return () => {
        F2.removeEventListener("focusScope.autoFocusOnMount", b2), setTimeout(() => {
          const e3 = new Event("focusScope.autoFocusOnUnmount", c$4);
          F2.addEventListener("focusScope.autoFocusOnUnmount", T2), F2.dispatchEvent(e3), e3.defaultPrevented || a$1(t2 != null ? t2 : document.body, { select: true }), F2.removeEventListener("focusScope.autoFocusOnUnmount", T2), d$4.remove(h);
        }, 0);
      };
    }
    var e2;
  }, [F2, b2, T2, h]);
  const N = s$4.useCallback((e2) => {
    if (!l2 && !m2)
      return;
    if (h.paused)
      return;
    ...
    if (t2 && n2) {
      const t3 = e2.currentTarget, [o2, u2] = function(e3) {
        const t4 = r$1(e3), n3 = s$3(t4, e3), o3 = s$3(t4.reverse(), e3);
        return [n3, o3];
      }(t3);
  ...
  return s$4.createElement(Primitive.div, _extends({ tabIndex: -1 }, E2, { ref: L2, onKeyDown: N }));
});
function r$1(e2) {
...
function useBodyPointerEvents({ disabled: r2 }) {
  const i2 = s$4.useRef(false);
  useLayoutEffect(() => {
    if (r2) {
      let e2 = function() {
        o$2--, o$2 === 0 && (document.body.style.pointerEvents = n$6);
      }, t2 = function(e3) {
        i2.current = e3.pointerType !== "mouse";
      };
      return o$2 === 0 && (n$6 = document.body.style.pointerEvents), document.body.style.pointerEvents = "none", o$2++, document.addEventListener("pointerup", t2), () => {
        i2.current ? document.addEventListener("click", e2, { once: true }) : e2(), document.removeEventListener("pointerup", t2);
      };
    }
  }, [r2]);
}
const u$2 = /* @__PURE__ */ s$4.createContext({ layers: /* @__PURE__ */ new Set(), layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(), branches: /* @__PURE__ */ new Set() });
const DismissableLayer = /* @__PURE__ */ s$4.forwardRef((l2, m2) => {
  const _a = l2, { disableOutsidePointerEvents: f2 = false, onEscapeKeyDown: p2, onPointerDownOutside: v2, onFocusOutside: b2, onInteractOutside: E2, onDismiss: y2 } = _a, w2 = __objRest(_a, ["disableOutsidePointerEvents", "onEscapeKeyDown", "onPointerDownOutside", "onFocusOutside", "onInteractOutside", "onDismiss"]), h = s$4.useContext(u$2), [D2, x2] = s$4.useState(null), [, C2] = s$4.useState({}), L2 = useComposedRefs(m2, (e2) => x2(e2)), P2 = Array.from(h.layers), [O2] = [...h.layersWithOutsidePointerEventsDisabled].slice(-1), g2 = P2.indexOf(O2), B2 = D2 ? P2.indexOf(D2) : -1, R2 = h.layersWithOutsidePointerEventsDisabled.size > 0, F2 = B2 >= g2, S2 = function(e2) {
    const n2 = useCallbackRef$1(e2), r2 = s$4.useRef(false);
    return s$4.useEffect(() => {
      const e3 = (e4) => {
        if (e4.target && !r2.current) {
          d$3("dismissableLayer.pointerDownOutside", n2, { originalEvent: e4 });
        }
        r2.current = false;
    ...
    return s$4.useEffect(() => {
      const e3 = (e4) => {
        if (e4.target && !r2.current) {
          d$3("dismissableLayer.focusOutside", n2, { originalEvent: e4 });
        }
      };
  ...
  return useEscapeKeydown((e2) => {
    B2 === h.layers.size - 1 && (p2 == null || p2(e2), e2.defaultPrevented || y2 == null || y2());
  }), useBodyPointerEvents({ disabled: f2 }), s$4.useEffect(() => {
    D2 && (f2 && h.layersWithOutsidePointerEventsDisabled.add(D2), h.layers.add(D2), c$3());
  }, [D2, f2, h]), s$4.useEffect(() => () => {
    D2 && (h.layers.delete(D2), h.layersWithOutsidePointerEventsDisabled.delete(D2), c$3());
  }, [D2, h]), s$4.useEffect(() => {
    const e2 = () => C2({});
    return document.addEventListener("dismissableLayer.update", e2), () => document.removeEventListener("dismissableLayer.update", e2);
  }, []), /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({}, w2, { ref: L2, style: __spreadValues({ pointerEvents: R2 ? F2 ? "auto" : "none" : void 0 }, l2.style), onFocusCapture: composeEventHandlers(l2.onFocusCapture, W.onFocusCapture), onBlurCapture: composeEventHandlers(l2.onBlurCapture, W.onBlurCapture), onPointerDownCapture: composeEventHandlers(l2.onPointerDownCapture, S2.onPointerDownCapture) }));
});
function c$3() {
...
const e$2 = "horizontal", n$5 = ["horizontal", "vertical"];
const Separator$3 = /* @__PURE__ */ s$4.forwardRef((n2, a2) => {
  const _a = n2, { decorative: p2, orientation: l2 = e$2 } = _a, c2 = __objRest(_a, ["decorative", "orientation"]), s2 = i$5(l2) ? l2 : e$2, u2 = p2 ? { role: "none" } : { "aria-orientation": s2 === "vertical" ? s2 : void 0, role: "separator" };
  return s$4.createElement(Primitive.div, _extends({ "data-orientation": s2 }, u2, c2, { ref: a2 }));
});
function i$5(r2) {
  return n$5.includes(r2);
}
Separator$3.propTypes = { orientation(r2, o2, t2) {
  const n2 = r2[o2], a2 = String(n2);
  return n2 && !i$5(n2) ? new Error(function(r3, o3) {
...
const Root$6 = Separator$3;
function observeElementRect(n2, o2) {
  const i2 = e$1.get(n2);
  return i2 === void 0 ? (e$1.set(n2, { rect: {}, callbacks: [o2] }), e$1.size === 1 && (t$1 = requestAnimationFrame(c$2))) : (i2.callbacks.push(o2), o2(n2.getBoundingClientRect())), () => {
    const c2 = e$1.get(n2);
    if (c2 === void 0)
      return;
...
function c$2() {
  ...
  }), t$1 = requestAnimationFrame(c$2);
}
function useRect(e2) {
  const [o2, c2] = s$4.useState();
  return s$4.useEffect(() => {
    if (e2) {
...
function getPlacementData({ anchorRect: p2, popperSize: c2, arrowSize: f2, arrowOffset: l2 = 0, side: d2, sideOffset: h = 0, align: x2, alignOffset: g2 = 0, shouldAvoidCollisions: u2 = true, collisionBoundariesRect: w2, collisionTolerance: m2 = 0 }) {
  if (!p2 || !c2 || !w2)
    return { popperStyles: o$1, arrowStyles: n$4 };
  ...
  if (u2 === false) {
    const t2 = e(b2);
    let o2 = n$4;
    f2 && (o2 = i$4({ popperSize: c2, arrowSize: f2, arrowOffset: l2, side: d2, align: x2 }));
  ...
  var O2, z2;
  const R2 = s$2(S2, $), M = y2[a(d2)][x2], D2 = function(t2, e2, r2) {
    const o2 = a(t2);
    return e2[t2] && !r2[o2] ? o2 : t2;
  }(d2, R2, s$2(DOMRect.fromRect(__spreadValues(__spreadValues({}, c2), M)), $)), A2 = function(t2, e2, r2, o2, n2) {
  ...
  let C2 = n$4;
  f2 && (C2 = i$4({ popperSize: c2, arrowSize: f2, arrowOffset: l2, side: D2, align: A2 }));
  return { popperStyles: __spreadProps(__spreadValues({}, I2), { "--radix-popper-transform-origin": r(c2, D2, A2, l2, f2) }), arrowStyles: C2, placedSide: D2, placedAlign: A2 };
}
function t(t2, e2, r2) {
...
const o$1 = { position: "fixed", top: 0, left: 0, opacity: 0, transform: "translate3d(0, -200%, 0)" }, n$4 = { position: "absolute", opacity: 0 };
function i$4({ popperSize: t2, arrowSize: e2, arrowOffset: r2, side: o2, align: n2 }) {
  const i2 = (t2.width - e2.width) / 2, a2 = (t2.height - e2.width) / 2, s2 = { top: 0, right: 90, bottom: 180, left: -90 }[o2], c2 = Math.max(e2.width, e2.height), f2 = { width: `${c2}px`, height: `${c2}px`, transform: `rotate(${s2}deg)`, willChange: "transform", position: "absolute", [o2]: "100%", direction: p$6(o2, n2) };
...
const [c$1, l$2] = createContextScope("Popper");
const [f$5, d$2] = c$1("Popper");
const Popper = (e2) => {
  const { __scopePopper: o2, children: r2 } = e2, [t2, n2] = s$4.useState(null);
  return s$4.createElement(f$5, { scope: o2, anchor: t2, onAnchorChange: n2 }, r2);
};
const PopperAnchor = /* @__PURE__ */ s$4.forwardRef((e2, r2) => {
  const _a = e2, { __scopePopper: t2, virtualRef: n2 } = _a, p2 = __objRest(_a, ["__scopePopper", "virtualRef"]), c2 = d$2("PopperAnchor", t2), l2 = s$4.useRef(null), f2 = useComposedRefs(r2, l2);
  return s$4.useEffect(() => {
    c2.onAnchorChange((n2 == null ? void 0 : n2.current) || l2.current);
  }), n2 ? null : /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({}, p2, { ref: f2 }));
});
const [u$1, m$6] = c$1("PopperContent");
const PopperContent = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopePopper: c2, side: l2 = "bottom", sideOffset: f2, align: m2 = "center", alignOffset: w2, collisionTolerance: h, avoidCollisions: x2 = true } = _a, v2 = __objRest(_a, ["__scopePopper", "side", "sideOffset", "align", "alignOffset", "collisionTolerance", "avoidCollisions"]), P2 = d$2("PopperContent", c2), [A2, g2] = s$4.useState(), E2 = useRect(P2.anchor), [y2, C2] = s$4.useState(null), S2 = useSize(y2), [R2, O2] = s$4.useState(null), _2 = useSize(R2), b2 = useComposedRefs(n2, (e3) => C2(e3)), z2 = function() {
    const [e3, o2] = s$4.useState(void 0);
    return s$4.useEffect(() => {
      let e4;
      function r2() {
  ...
  }(), T2 = z2 ? DOMRect.fromRect(__spreadProps(__spreadValues({}, z2), { x: 0, y: 0 })) : void 0, { popperStyles: k2, arrowStyles: L2, placedSide: B2, placedAlign: D2 } = getPlacementData({ anchorRect: E2, popperSize: S2, arrowSize: _2, arrowOffset: A2, side: l2, sideOffset: f2, align: m2, alignOffset: w2, shouldAvoidCollisions: x2, collisionBoundariesRect: T2, collisionTolerance: h }), H2 = B2 !== void 0;
  return s$4.createElement("div", { style: k2, "data-radix-popper-content-wrapper": "" }, /* @__PURE__ */ s$4.createElement(u$1, { scope: c2, arrowStyles: L2, onArrowChange: O2, onArrowOffsetChange: g2 }, /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({ "data-side": B2, "data-align": D2 }, v2, { style: __spreadProps(__spreadValues({}, v2.style), { animation: H2 ? void 0 : "none" }), ref: b2 }))));
});
const Root$5 = Popper;
const Anchor$1 = PopperAnchor;
const Content$3 = PopperContent;
const x$3 = ["Enter", " "], b$1 = ["ArrowUp", "PageDown", "End"], R$2 = ["ArrowDown", "PageUp", "Home", ...b$1], _$1 = { ltr: [...x$3, "ArrowRight"], rtl: [...x$3, "ArrowLeft"] }, y = { ltr: ["ArrowLeft"], rtl: ["ArrowRight"] }, [I, k, P$1] = createCollection("Menu"), [D$1, S$1] = createContextScope("Menu", [P$1, l$2, v$2]);
const O$1 = l$2(), T$1 = v$2(), [L$1, A$2] = D$1("Menu");
const Menu = (e2) => {
  const { __scopeMenu: n2, open: o2 = false, children: u2, onOpenChange: c2, modal: i2 = true } = e2, s2 = O$1(n2), [l2, d2] = s$4.useState(null), p2 = s$4.useRef(false), f2 = useCallbackRef$1(c2), m2 = useDirection(l2, e2.dir);
  return s$4.useEffect(() => {
    const e3 = () => {
      p2.current = true, document.addEventListener("pointerdown", n3, { capture: true, once: true }), document.addEventListener("pointermove", n3, { capture: true, once: true });
    }, n3 = () => p2.current = false;
    return document.addEventListener("keydown", e3, { capture: true }), () => {
      document.removeEventListener("keydown", e3, { capture: true }), document.removeEventListener("pointerdown", n3, { capture: true }), document.removeEventListener("pointermove", n3, { capture: true });
    };
  }, []), /* @__PURE__ */ s$4.createElement(Root$5, s2, /* @__PURE__ */ s$4.createElement(L$1, { scope: n2, isSubmenu: false, isUsingKeyboardRef: p2, dir: m2, open: o2, onOpenChange: f2, content: l2, onContentChange: d2, onRootClose: s$4.useCallback(() => f2(false), [f2]), modal: i2 }, u2));
};
const MenuSub = (n2) => {
  const { __scopeMenu: r2, children: o2, open: u2 = false, onOpenChange: c2 } = n2, i2 = A$2("MenuSub", r2), s2 = O$1(r2), [l2, d2] = s$4.useState(null), [p2, f2] = s$4.useState(null), m2 = useCallbackRef$1(c2);
  return s$4.useEffect(() => (i2.open === false && m2(false), () => m2(false)), [i2.open, m2]), /* @__PURE__ */ s$4.createElement(Root$5, s2, /* @__PURE__ */ s$4.createElement(L$1, { scope: r2, isSubmenu: true, isUsingKeyboardRef: i2.isUsingKeyboardRef, dir: i2.dir, open: u2, onOpenChange: m2, content: p2, onContentChange: f2, onRootClose: i2.onRootClose, contentId: useId(), trigger: l2, onTriggerChange: d2, triggerId: useId(), modal: false }, o2));
};
const MenuAnchor = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeMenu: t2 } = _a, r2 = __objRest(_a, ["__scopeMenu"]), o2 = O$1(t2);
  return s$4.createElement(Anchor$1, _extends({}, o2, r2, { ref: n2 }));
});
const [F, K] = D$1("MenuContent");
const MenuContent$1 = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { forceMount: t2 } = _a, r2 = __objRest(_a, ["forceMount"]), o2 = A$2("MenuContent", e2.__scopeMenu);
  return s$4.createElement(I.Provider, { scope: e2.__scopeMenu }, /* @__PURE__ */ s$4.createElement(Presence, { present: t2 || o2.open }, /* @__PURE__ */ s$4.createElement(I.Slot, { scope: e2.__scopeMenu }, o2.isSubmenu ? /* @__PURE__ */ s$4.createElement(X, _extends({}, r2, { ref: n2 })) : /* @__PURE__ */ s$4.createElement(G, _extends({}, r2, { ref: n2 })))));
});
const G = /* @__PURE__ */ s$4.forwardRef((e2, n2) => A$2("MenuContent", e2.__scopeMenu).modal ? /* @__PURE__ */ s$4.createElement(U, _extends({}, e2, { ref: n2 })) : /* @__PURE__ */ s$4.createElement(V, _extends({}, e2, { ref: n2 }))), U = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const t2 = A$2("MenuContent", e2.__scopeMenu), r2 = s$4.useRef(null), o2 = useComposedRefs(n2, r2);
  return s$4.useEffect(() => {
    const e3 = r2.current;
    if (e3)
      return hideOthers(e3);
  }, []), /* @__PURE__ */ s$4.createElement(B, _extends({}, e2, { ref: o2, trapFocus: t2.open, disableOutsidePointerEvents: t2.open, disableOutsideScroll: true, onFocusOutside: composeEventHandlers(e2.onFocusOutside, (e3) => e3.preventDefault(), { checkForDefaultPrevented: false }), onDismiss: () => t2.onOpenChange(false) }));
}), V = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const t2 = A$2("MenuContent", e2.__scopeMenu);
  return s$4.createElement(B, _extends({}, e2, { ref: n2, trapFocus: false, disableOutsidePointerEvents: false, disableOutsideScroll: false, onDismiss: () => t2.onOpenChange(false) }));
}), X = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const t2 = A$2("MenuContent", e2.__scopeMenu), r2 = s$4.useRef(null), o2 = useComposedRefs(n2, r2);
  return t2.isSubmenu ? /* @__PURE__ */ s$4.createElement(B, _extends({ id: t2.contentId, "aria-labelledby": t2.triggerId }, e2, { ref: o2, align: "start", side: t2.dir === "rtl" ? "left" : "right", portalled: true, disableOutsidePointerEvents: false, disableOutsideScroll: false, trapFocus: false, onOpenAutoFocus: (e3) => {
    var n3;
    t2.isUsingKeyboardRef.current && ((n3 = r2.current) === null || n3 === void 0 || n3.focus()), e3.preventDefault();
  }, onCloseAutoFocus: (e3) => e3.preventDefault(), onFocusOutside: composeEventHandlers(e2.onFocusOutside, (e3) => {
    e3.target !== t2.trigger && t2.onOpenChange(false);
  }), onEscapeKeyDown: composeEventHandlers(e2.onEscapeKeyDown, t2.onRootClose), onKeyDown: composeEventHandlers(e2.onKeyDown, (e3) => {
    const n3 = e3.currentTarget.contains(e3.target), r3 = y[t2.dir].includes(e3.key);
    var o3;
    n3 && r3 && (t2.onOpenChange(false), (o3 = t2.trigger) === null || o3 === void 0 || o3.focus(), e3.preventDefault());
  }) })) : null;
}), B = /* @__PURE__ */ s$4.forwardRef((e2, t2) => {
  const _a = e2, { __scopeMenu: r2, loop: u2 = false, trapFocus: i2, onOpenAutoFocus: s2, onCloseAutoFocus: l2, disableOutsidePointerEvents: f2, onEscapeKeyDown: v2, onPointerDownOutside: g2, onFocusOutside: h, onInteractOutside: x2, onDismiss: _2, disableOutsideScroll: y2, allowPinchZoom: I2, portalled: P2 } = _a, D2 = __objRest(_a, ["__scopeMenu", "loop", "trapFocus", "onOpenAutoFocus", "onCloseAutoFocus", "disableOutsidePointerEvents", "onEscapeKeyDown", "onPointerDownOutside", "onFocusOutside", "onInteractOutside", "onDismiss", "disableOutsideScroll", "allowPinchZoom", "portalled"]), S2 = A$2("MenuContent", r2), L2 = O$1(r2), K2 = T$1(r2), G2 = k(r2), [U2, V2] = s$4.useState(null), X2 = s$4.useRef(null), B2 = useComposedRefs(t2, X2, S2.onContentChange), Y2 = s$4.useRef(0), Z = s$4.useRef(""), z2 = s$4.useRef(0), H2 = s$4.useRef(null), W = s$4.useRef("right"), q2 = s$4.useRef(0), N = P2 ? Portal : s$4.Fragment, Q = y2 ? o$4 : s$4.Fragment, $ = y2 ? { allowPinchZoom: I2 } : void 0, ee = (e3) => {
    var n2, t3;
    const r3 = Z.current + e3, o2 = G2().filter((e4) => !e4.disabled), u3 = document.activeElement, c2 = (n2 = o2.find((e4) => e4.ref.current === u3)) === null || n2 === void 0 ? void 0 : n2.textValue, a2 = function(e4, n3, t4) {
      const r4 = n3.length > 1 && Array.from(n3).every((e5) => e5 === n3[0]) ? n3[0] : n3, o3 = t4 ? e4.indexOf(t4) : -1;
      let u4 = (c3 = e4, a3 = Math.max(o3, 0), c3.map((e5, n4) => c3[(a3 + n4) % c3.length]));
      var c3, a3;
      r4.length === 1 && (u4 = u4.filter((e5) => e5 !== t4));
      const i4 = u4.find((e5) => e5.toLowerCase().startsWith(r4.toLowerCase()));
      return i4 !== t4 ? i4 : void 0;
    }(o2.map((e4) => e4.textValue), r3, c2), i3 = (t3 = o2.find((e4) => e4.textValue === a2)) === null || t3 === void 0 ? void 0 : t3.ref.current;
    !function e4(n3) {
      Z.current = n3, window.clearTimeout(Y2.current), n3 !== "" && (Y2.current = window.setTimeout(() => e4(""), 1e3));
    }(r3), i3 && setTimeout(() => i3.focus());
  };
  s$4.useEffect(() => () => window.clearTimeout(Y2.current), []), useFocusGuards();
  const ne = s$4.useCallback((e3) => {
    var n2, t3;
    return W.current === ((n2 = H2.current) === null || n2 === void 0 ? void 0 : n2.side) && function(e4, n3) {
      if (!n3)
        return false;
      return function(e5, n4) {
        const { x: t4, y: r3 } = e5;
        let o2 = false;
        for (let e6 = 0, u3 = n4.length - 1; e6 < n4.length; u3 = e6++) {
          const c2 = n4[e6].x, a2 = n4[e6].y, i3 = n4[u3].x, s3 = n4[u3].y;
          a2 > r3 != s3 > r3 && t4 < (i3 - c2) * (r3 - a2) / (s3 - a2) + c2 && (o2 = !o2);
        }
        return o2;
      }({ x: e4.clientX, y: e4.clientY }, n3);
    }(e3, (t3 = H2.current) === null || t3 === void 0 ? void 0 : t3.area);
  }, []);
  return s$4.createElement(N, null, /* @__PURE__ */ s$4.createElement(Q, $, /* @__PURE__ */ s$4.createElement(F, { scope: r2, searchRef: Z, onItemEnter: s$4.useCallback((e3) => {
    ne(e3) && e3.preventDefault();
  }, [ne]), onItemLeave: s$4.useCallback((e3) => {
    var n2;
    ne(e3) || ((n2 = X2.current) === null || n2 === void 0 || n2.focus(), V2(null));
  }, [ne]), onTriggerLeave: s$4.useCallback((e3) => {
    ne(e3) && e3.preventDefault();
  }, [ne]), pointerGraceTimerRef: z2, onPointerGraceIntentChange: s$4.useCallback((e3) => {
    H2.current = e3;
  }, []) }, /* @__PURE__ */ s$4.createElement(FocusScope, { asChild: true, trapped: i2, onMountAutoFocus: composeEventHandlers(s2, (e3) => {
    var n2;
    e3.preventDefault(), (n2 = X2.current) === null || n2 === void 0 || n2.focus();
  }), onUnmountAutoFocus: l2 }, /* @__PURE__ */ s$4.createElement(DismissableLayer, { asChild: true, disableOutsidePointerEvents: f2, onEscapeKeyDown: v2, onPointerDownOutside: g2, onFocusOutside: h, onInteractOutside: x2, onDismiss: _2 }, /* @__PURE__ */ s$4.createElement(Root$7, _extends({ asChild: true }, K2, { dir: S2.dir, orientation: "vertical", loop: u2, currentTabStopId: U2, onCurrentTabStopIdChange: V2, onEntryFocus: (e3) => {
    S2.isUsingKeyboardRef.current || e3.preventDefault();
  } }), /* @__PURE__ */ s$4.createElement(Content$3, _extends({ role: "menu", "aria-orientation": "vertical", "data-state": j(S2.open), dir: S2.dir }, L2, D2, { ref: B2, style: __spreadValues({ outline: "none" }, D2.style), onKeyDown: composeEventHandlers(D2.onKeyDown, (e3) => {
    const n2 = e3.target, t3 = e3.currentTarget.contains(n2), r3 = e3.ctrlKey || e3.altKey || e3.metaKey, o2 = e3.key.length === 1;
    t3 && (e3.key === "Tab" && e3.preventDefault(), !r3 && o2 && ee(e3.key));
    const u3 = X2.current;
    if (e3.target !== u3)
      return;
    if (!R$2.includes(e3.key))
      return;
    e3.preventDefault();
    const c2 = G2().filter((e4) => !e4.disabled).map((e4) => e4.ref.current);
    b$1.includes(e3.key) && c2.reverse(), function(e4) {
      const n3 = document.activeElement;
      for (const t4 of e4) {
        if (t4 === n3)
          return;
        if (t4.focus(), document.activeElement !== n3)
          return;
      }
    }(c2);
  }), onBlur: composeEventHandlers(e2.onBlur, (e3) => {
    e3.currentTarget.contains(e3.target) || (window.clearTimeout(Y2.current), Z.current = "");
  }), onPointerMove: composeEventHandlers(e2.onPointerMove, J((e3) => {
    const n2 = e3.target, t3 = q2.current !== e3.clientX;
    if (e3.currentTarget.contains(n2) && t3) {
      const n3 = e3.clientX > q2.current ? "right" : "left";
      W.current = n3, q2.current = e3.clientX;
    }
  })) }))))))));
});
const MenuItem = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { disabled: t2 = false, onSelect: r2 } = _a, o2 = __objRest(_a, ["disabled", "onSelect"]), u2 = s$4.useRef(null), c2 = A$2("MenuItem", e2.__scopeMenu), a2 = K("MenuItem", e2.__scopeMenu), i2 = useComposedRefs(n2, u2), s2 = s$4.useRef(false);
  return s$4.createElement(Y, _extends({}, o2, { ref: i2, disabled: t2, onClick: composeEventHandlers(e2.onClick, () => {
    const e3 = u2.current;
    if (!t2 && e3) {
      const n3 = new Event("menu.itemSelect", { bubbles: true, cancelable: true });
      e3.addEventListener("menu.itemSelect", (e4) => r2 == null ? void 0 : r2(e4), { once: true }), e3.dispatchEvent(n3), n3.defaultPrevented ? s2.current = false : c2.onRootClose();
    }
  }), onPointerDown: (n3) => {
    var t3;
    (t3 = e2.onPointerDown) === null || t3 === void 0 || t3.call(e2, n3), s2.current = true;
  }, onPointerUp: composeEventHandlers(e2.onPointerUp, (e3) => {
    var n3;
    s2.current || (n3 = e3.currentTarget) === null || n3 === void 0 || n3.click();
  }), onKeyDown: composeEventHandlers(e2.onKeyDown, (e3) => {
    const n3 = a2.searchRef.current !== "";
    t2 || n3 && e3.key === " " || x$3.includes(e3.key) && (e3.currentTarget.click(), e3.preventDefault());
  }) }));
});
const MenuSubTrigger = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const t2 = A$2("MenuSubTrigger", e2.__scopeMenu), r2 = K("MenuSubTrigger", e2.__scopeMenu), o2 = s$4.useRef(null), { pointerGraceTimerRef: u2, onPointerGraceIntentChange: c2 } = r2, a2 = { __scopeMenu: e2.__scopeMenu }, i2 = s$4.useCallback(() => {
    o2.current && window.clearTimeout(o2.current), o2.current = null;
  }, []);
  return s$4.useEffect(() => i2, [i2]), s$4.useEffect(() => {
    const e3 = u2.current;
    return () => {
      window.clearTimeout(e3), c2(null);
    };
  }, [u2, c2]), t2.isSubmenu ? /* @__PURE__ */ s$4.createElement(MenuAnchor, _extends({ asChild: true }, a2), /* @__PURE__ */ s$4.createElement(Y, _extends({ id: t2.triggerId, "aria-haspopup": "menu", "aria-expanded": t2.open, "aria-controls": t2.contentId, "data-state": j(t2.open) }, e2, { ref: composeRefs(n2, t2.onTriggerChange), onClick: (n3) => {
    var r3;
    (r3 = e2.onClick) === null || r3 === void 0 || r3.call(e2, n3), e2.disabled || n3.defaultPrevented || (n3.currentTarget.focus(), t2.open || t2.onOpenChange(true));
  }, onPointerMove: composeEventHandlers(e2.onPointerMove, J((n3) => {
    r2.onItemEnter(n3), n3.defaultPrevented || e2.disabled || t2.open || o2.current || (r2.onPointerGraceIntentChange(null), o2.current = window.setTimeout(() => {
      t2.onOpenChange(true), i2();
    }, 100));
  })), onPointerLeave: composeEventHandlers(e2.onPointerLeave, J((e3) => {
    var n3;
    i2();
    const o3 = (n3 = t2.content) === null || n3 === void 0 ? void 0 : n3.getBoundingClientRect();
    if (o3) {
      var c3;
      const n4 = (c3 = t2.content) === null || c3 === void 0 ? void 0 : c3.dataset.side, a3 = n4 === "right", i3 = a3 ? -5 : 5, s2 = o3[a3 ? "left" : "right"], l2 = o3[a3 ? "right" : "left"];
      r2.onPointerGraceIntentChange({ area: [{ x: e3.clientX + i3, y: e3.clientY }, { x: s2, y: o3.top }, { x: l2, y: o3.top }, { x: l2, y: o3.bottom }, { x: s2, y: o3.bottom }], side: n4 }), window.clearTimeout(u2.current), u2.current = window.setTimeout(() => r2.onPointerGraceIntentChange(null), 300);
    } else {
      if (r2.onTriggerLeave(e3), e3.defaultPrevented)
        return;
      r2.onPointerGraceIntentChange(null);
    }
  })), onKeyDown: composeEventHandlers(e2.onKeyDown, (n3) => {
    const o3 = r2.searchRef.current !== "";
    var u3;
    e2.disabled || o3 && n3.key === " " || _$1[t2.dir].includes(n3.key) && (t2.onOpenChange(true), (u3 = t2.content) === null || u3 === void 0 || u3.focus(), n3.preventDefault());
  }) }))) : null;
});
const Y = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeMenu: t2, disabled: r2 = false, textValue: u2 } = _a, c2 = __objRest(_a, ["__scopeMenu", "disabled", "textValue"]), a2 = K("MenuItem", t2), i2 = T$1(t2), l2 = s$4.useRef(null), d2 = useComposedRefs(n2, l2), [p2, f2] = s$4.useState("");
  return s$4.useEffect(() => {
    const e3 = l2.current;
    var n3;
    e3 && f2(((n3 = e3.textContent) !== null && n3 !== void 0 ? n3 : "").trim());
  }, [c2.children]), /* @__PURE__ */ s$4.createElement(I.ItemSlot, { scope: t2, disabled: r2, textValue: u2 != null ? u2 : p2 }, /* @__PURE__ */ s$4.createElement(Item$3, _extends({ asChild: true }, i2, { focusable: !r2 }), /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({ role: "menuitem", "aria-disabled": r2 || void 0, "data-disabled": r2 ? "" : void 0 }, c2, { ref: d2, onPointerMove: composeEventHandlers(e2.onPointerMove, J((e3) => {
    if (r2)
      a2.onItemLeave(e3);
    else if (a2.onItemEnter(e3), !e3.defaultPrevented) {
      e3.currentTarget.focus();
    }
  })), onPointerLeave: composeEventHandlers(e2.onPointerLeave, J((e3) => a2.onItemLeave(e3))) }))));
});
D$1("MenuRadioGroup", { value: void 0, onValueChange: () => {
} });
D$1("MenuItemIndicator", { checked: false });
const MenuSeparator = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeMenu: t2 } = _a, r2 = __objRest(_a, ["__scopeMenu"]);
  return s$4.createElement(Primitive.div, _extends({ role: "separator", "aria-orientation": "horizontal" }, r2, { ref: n2 }));
});
function j(e2) {
  return e2 ? "open" : "closed";
}
function J(e2) {
  return (n2) => n2.pointerType === "mouse" ? e2(n2) : void 0;
}
const Root$4 = Menu;
const Sub = MenuSub;
const Anchor = MenuAnchor;
const SubTrigger = MenuSubTrigger;
const Content$2 = MenuContent$1;
const Item$2 = MenuItem;
const Separator$2 = MenuSeparator;
const [n$3, o] = createContextScope("Progress");
const [s$1, i$3] = n$3("Progress");
const Progress$1 = /* @__PURE__ */ s$4.forwardRef((r2, n2) => {
  const _a = r2, { __scopeProgress: o2, value: i2, max: d2, getValueLabel: v2 = u } = _a, f2 = __objRest(_a, ["__scopeProgress", "value", "max", "getValueLabel"]), x2 = p$5(d2) ? d2 : 100, g2 = c(i2, x2) ? i2 : null, P2 = m$5(g2) ? v2(g2, x2) : void 0;
  return s$4.createElement(s$1, { scope: o2, value: g2, max: x2 }, /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({ "aria-valuemax": x2, "aria-valuemin": 0, "aria-valuenow": m$5(g2) ? g2 : void 0, "aria-valuetext": P2, role: "progressbar", "data-state": l$1(g2, x2), "data-value": g2 != null ? g2 : void 0, "data-max": x2 }, f2, { ref: n2 })));
});
Progress$1.propTypes = { max(e2, r2, t2) {
  const a2 = e2[r2], n2 = String(a2);
  return a2 && !p$5(a2) ? new Error(function(e3, r3) {
    return `Invalid prop \`max\` of value \`${e3}\` supplied to \`${r3}\`. Only numbers greater than 0 are valid max values. Defaulting to \`100\`.`;
  }(n2, t2)) : null;
}, value(e2, r2, t2) {
  const a2 = e2[r2], n2 = String(a2), o2 = p$5(e2.max) ? e2.max : 100;
  return a2 == null || c(a2, o2) ? null : new Error(function(e3, r3) {
    return `Invalid prop \`value\` of value \`${e3}\` supplied to \`${r3}\`. The \`value\` prop must be:
  - a positive number
...
const ProgressIndicator = /* @__PURE__ */ s$4.forwardRef((r2, n2) => {
  var o2;
  const _a = r2, { __scopeProgress: s2 } = _a, u2 = __objRest(_a, ["__scopeProgress"]), m2 = i$3("ProgressIndicator", s2);
  return s$4.createElement(Primitive.div, _extends({ "data-state": l$1(m2.value, m2.max), "data-value": (o2 = m2.value) !== null && o2 !== void 0 ? o2 : void 0, "data-max": m2.max }, u2, { ref: n2 }));
});
function u(e2, r2) {
  return `${Math.round(e2 / r2 * 100)}%`;
}
function l$1(e2, r2) {
  return e2 == null ? "indeterminate" : e2 === r2 ? "complete" : "loading";
}
function m$5(e2) {
  return typeof e2 == "number";
}
function p$5(e2) {
  return m$5(e2) && !isNaN(e2) && e2 > 0;
}
function c(e2, r2) {
  return m$5(e2) && !isNaN(e2) && e2 <= r2 && e2 >= 0;
}
const Root$3 = Progress$1;
const Indicator = ProgressIndicator;
const [d$1, p$4] = createContextScope("ScrollArea");
const [f$4, h$4] = d$1("ScrollArea");
const ScrollArea$1 = /* @__PURE__ */ s$4.forwardRef((e2, r2) => {
  const _a = e2, { __scopeScrollArea: t2, type: n2 = "hover", scrollHideDelay: i2 = 600 } = _a, a2 = __objRest(_a, ["__scopeScrollArea", "type", "scrollHideDelay"]), [d2, p2] = s$4.useState(null), [h, m2] = s$4.useState(null), [w2, b2] = s$4.useState(null), [v2, S2] = s$4.useState(null), [g2, E2] = s$4.useState(null), [C2, T2] = s$4.useState(0), [y2, A2] = s$4.useState(0), [x2, R2] = s$4.useState(false), [P2, L2] = s$4.useState(false), _2 = useComposedRefs(r2, (e3) => p2(e3)), D2 = useDirection(d2, a2.dir);
  return s$4.createElement(f$4, { scope: t2, type: n2, dir: D2, scrollHideDelay: i2, scrollArea: d2, viewport: h, onViewportChange: m2, content: w2, onContentChange: b2, scrollbarX: v2, onScrollbarXChange: S2, scrollbarXEnabled: x2, onScrollbarXEnabledChange: R2, scrollbarY: g2, onScrollbarYChange: E2, scrollbarYEnabled: P2, onScrollbarYEnabledChange: L2, onCornerWidthChange: T2, onCornerHeightChange: A2 }, /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({}, a2, { ref: _2, style: __spreadValues({ position: "relative", "--radix-scroll-area-corner-width": C2 + "px", "--radix-scroll-area-corner-height": y2 + "px" }, e2.style) })));
});
const ScrollAreaViewport = /* @__PURE__ */ s$4.forwardRef((e2, r2) => {
  const _a = e2, { __scopeScrollArea: t2, children: o2 } = _a, n2 = __objRest(_a, ["__scopeScrollArea", "children"]), i2 = h$4("ScrollAreaViewport", t2), a2 = s$4.useRef(null), d2 = useComposedRefs(r2, a2, i2.onViewportChange);
  return s$4.createElement(s$4.Fragment, null, /* @__PURE__ */ s$4.createElement("style", { dangerouslySetInnerHTML: { __html: "[data-radix-scroll-area-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-radix-scroll-area-viewport]::-webkit-scrollbar{display:none}" } }), /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({ "data-radix-scroll-area-viewport": "" }, n2, { ref: d2, style: __spreadValues({ overflowX: i2.scrollbarXEnabled ? "scroll" : "hidden", overflowY: i2.scrollbarYEnabled ? "scroll" : "hidden" }, e2.style) }), /* @__PURE__ */ s$4.createElement("div", { ref: i2.onContentChange, style: { minWidth: "100%", display: "table" } }, o2)));
});
const ScrollAreaScrollbar = /* @__PURE__ */ s$4.forwardRef((e2, r2) => {
  ...
  return s$4.useEffect(() => (a2 ? l2(true) : i2(true), () => {
    a2 ? l2(false) : i2(false);
  }), [a2, l2, i2]), n2.type === "hover" ? /* @__PURE__ */ s$4.createElement(m$4, _extends({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "scroll" ? /* @__PURE__ */ s$4.createElement(w$1, _extends({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "auto" ? /* @__PURE__ */ s$4.createElement(b, _extends({}, o2, { ref: r2, forceMount: t2 })) : n2.type === "always" ? /* @__PURE__ */ s$4.createElement(v, _extends({}, o2, { ref: r2 })) : null;
});
const m$4 = /* @__PURE__ */ s$4.forwardRef((e2, r2) => {
  const _a = e2, { forceMount: t2 } = _a, o2 = __objRest(_a, ["forceMount"]), n2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), [l2, i2] = s$4.useState(false);
  return s$4.useEffect(() => {
  ...
  }, [n2.scrollArea, n2.scrollHideDelay]), /* @__PURE__ */ s$4.createElement(Presence, { present: t2 || l2 }, /* @__PURE__ */ s$4.createElement(b, _extends({ "data-state": l2 ? "visible" : "hidden" }, o2, { ref: r2 })));
}), w$1 = /* @__PURE__ */ s$4.forwardRef((r2, t2) => {
  const _a = r2, { forceMount: o2 } = _a, n2 = __objRest(_a, ["forceMount"]), l2 = h$4("ScrollAreaScrollbar", r2.__scopeScrollArea), i2 = r2.orientation === "horizontal", c2 = z(() => p2("SCROLL_END"), 100), [d2, p2] = (f2 = "hidden", m2 = { hidden: { SCROLL: "scrolling" }, scrolling: { SCROLL_END: "idle", POINTER_ENTER: "interacting" }, interacting: { SCROLL: "interacting", POINTER_LEAVE: "idle" }, idle: { HIDE: "hidden", SCROLL: "scrolling", POINTER_ENTER: "interacting" } }, s$4.useReducer((e2, r3) => {
    const t3 = m2[e2][r3];
  ...
  }, [d2, l2.scrollHideDelay, p2]), s$4.useEffect(() => {
  ...
  }, [l2.viewport, i2, p2, c2]), /* @__PURE__ */ s$4.createElement(Presence, { present: o2 || d2 !== "hidden" }, /* @__PURE__ */ s$4.createElement(v, _extends({ "data-state": d2 === "hidden" ? "hidden" : "visible" }, n2, { ref: t2, onPointerEnter: composeEventHandlers(r2.onPointerEnter, () => p2("POINTER_ENTER")), onPointerLeave: composeEventHandlers(r2.onPointerLeave, () => p2("POINTER_LEAVE")) })));
}), b = /* @__PURE__ */ s$4.forwardRef((e2, r2) => {
  const t2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), _a = e2, { forceMount: o2 } = _a, n2 = __objRest(_a, ["forceMount"]), [l2, i2] = s$4.useState(false), c2 = e2.orientation === "horizontal", d2 = z(() => {
    if (t2.viewport) {
      const e3 = t2.viewport.offsetWidth < t2.viewport.scrollWidth, r3 = t2.viewport.offsetHeight < t2.viewport.scrollHeight;
      i2(c2 ? e3 : r3);
    }
  }, 10);
  return H(t2.viewport, d2), H(t2.content, d2), /* @__PURE__ */ s$4.createElement(Presence, { present: o2 || l2 }, /* @__PURE__ */ s$4.createElement(v, _extends({ "data-state": l2 ? "visible" : "hidden" }, n2, { ref: r2 })));
}), v = /* @__PURE__ */ s$4.forwardRef((e2, r2) => {
  const _a = e2, { orientation: t2 = "vertical" } = _a, o2 = __objRest(_a, ["orientation"]), n2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), l2 = s$4.useRef(null), i2 = s$4.useRef(0), [a2, c2] = s$4.useState({ content: 0, viewport: 0, scrollbar: { size: 0, paddingStart: 0, paddingEnd: 0 } }), d2 = x$2(a2.viewport, a2.content), p2 = __spreadProps(__spreadValues({}, o2), { sizes: a2, onSizesChange: c2, hasThumb: Boolean(d2 > 0 && d2 < 1), onThumbChange: (e3) => l2.current = e3, onThumbPointerUp: () => i2.current = 0, onThumbPointerDown: (e3) => i2.current = e3 });
  function f2(e3, r3) {
  ...
  return t2 === "horizontal" ? /* @__PURE__ */ s$4.createElement(S, _extends({}, p2, { ref: r2, onThumbPositionChange: () => {
  ...
  } })) : t2 === "vertical" ? /* @__PURE__ */ s$4.createElement(g$4, _extends({}, p2, { ref: r2, onThumbPositionChange: () => {
    if (n2.viewport && l2.current) {
...
}), g$4 = /* @__PURE__ */ s$4.forwardRef((e2, r2) => {
  const _a = e2, { sizes: t2, onSizesChange: o2 } = _a, n2 = __objRest(_a, ["sizes", "onSizesChange"]), i2 = h$4("ScrollAreaScrollbar", e2.__scopeScrollArea), [a2, c2] = s$4.useState(), d2 = s$4.useRef(null), p2 = useComposedRefs(r2, d2, i2.onScrollbarYChange);
  return s$4.useEffect(() => {
    d2.current && c2(getComputedStyle(d2.current));
  ...
  }, [R2, C2, P2, L2]), s$4.useEffect(_2, [i2, _2]), H(C2, D2), H(g2.content, D2), /* @__PURE__ */ s$4.createElement(E$1, { scope: o2, scrollbar: C2, hasThumb: a2, onThumbChange: useCallbackRef$1(d2), onThumbPointerUp: useCallbackRef$1(p2), onThumbPositionChange: _2, onThumbPointerDown: useCallbackRef$1(f2) }, /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({}, S2, { ref: y2, style: __spreadValues({ position: "absolute" }, S2.style), onPointerDown: composeEventHandlers(r2.onPointerDown, (e2) => {
    if (e2.button === 0) {
...
const ScrollAreaThumb = /* @__PURE__ */ s$4.forwardRef((r2, t2) => {
  const _a = r2, { __scopeScrollArea: o2, style: n2 } = _a, i2 = __objRest(_a, ["__scopeScrollArea", "style"]), a2 = h$4("ScrollbarThumb", o2), d2 = C$2("ScrollbarThumb", o2), { onThumbPositionChange: p2 } = d2, f2 = useComposedRefs(t2, (e2) => d2.onThumbChange(e2)), m2 = s$4.useRef(), w2 = z(() => {
  ...
  }, [a2.viewport, w2, p2]), d2.hasThumb ? /* @__PURE__ */ s$4.createElement(Primitive.div, _extends({}, i2, { ref: f2, style: __spreadValues({ width: "var(--radix-scroll-area-thumb-width)", height: "var(--radix-scroll-area-thumb-height)" }, n2), onPointerDownCapture: composeEventHandlers(r2.onPointerDownCapture, (e2) => {
...
function R$1(e2) {
  const r2 = x$2(e2.viewport, e2.content), t2 = e2.scrollbar.paddingStart + e2.scrollbar.paddingEnd, o2 = (e2.scrollbar.size - t2) * r2;
...
function z(e2, r2) {
  const t2 = useCallbackRef$1(e2), o2 = s$4.useRef(0);
  return s$4.useEffect(() => () => window.clearTimeout(o2.current), []), s$4.useCallback(() => {
...
const Root$2 = ScrollArea$1;
const Viewport = ScrollAreaViewport;
const Scrollbar = ScrollAreaScrollbar;
const [C$1, g$3] = createContextScope("Popover", [l$2]);
const x$1 = l$2(), [h$3, E] = C$1("Popover");
const Popover$1 = (e2) => {
  const { __scopePopover: o2, children: t2, open: n2, defaultOpen: c2, onOpenChange: a2, modal: s2 = false } = e2, i2 = x$1(o2), u2 = s$4.useRef(null), [d2, m2] = s$4.useState(false), [f2 = false, P2] = useControllableState({ prop: n2, defaultProp: c2, onChange: a2 });
  return s$4.createElement(Root$5, i2, /* @__PURE__ */ s$4.createElement(h$3, { scope: o2, contentId: useId(), triggerRef: u2, open: f2, onOpenChange: P2, onOpenToggle: s$4.useCallback(() => P2((e3) => !e3), [P2]), hasCustomAnchor: d2, onCustomAnchorAdd: s$4.useCallback(() => m2(true), []), onCustomAnchorRemove: s$4.useCallback(() => m2(false), []), modal: s2 }, t2));
};
const PopoverTrigger = /* @__PURE__ */ s$4.forwardRef((e2, o2) => {
  const _a = e2, { __scopePopover: r2 } = _a, n2 = __objRest(_a, ["__scopePopover"]), c2 = E("PopoverTrigger", r2), a2 = x$1(r2), s2 = useComposedRefs(o2, c2.triggerRef), i2 = /* @__PURE__ */ s$4.createElement(Primitive.button, _extends({ type: "button", "aria-haspopup": "dialog", "aria-expanded": c2.open, "aria-controls": c2.contentId, "data-state": w(c2.open) }, n2, { ref: s2, onClick: composeEventHandlers(e2.onClick, c2.onOpenToggle) }));
  return c2.hasCustomAnchor ? i2 : /* @__PURE__ */ s$4.createElement(Anchor$1, _extends({ asChild: true }, a2), i2);
});
const PopoverContent$1 = /* @__PURE__ */ s$4.forwardRef((e2, o2) => {
  const _a = e2, { forceMount: r2 } = _a, t2 = __objRest(_a, ["forceMount"]), c2 = E("PopoverContent", e2.__scopePopover);
  return s$4.createElement(Presence, { present: r2 || c2.open }, c2.modal ? /* @__PURE__ */ s$4.createElement(A, _extends({}, t2, { ref: o2 })) : /* @__PURE__ */ s$4.createElement(O, _extends({}, t2, { ref: o2 })));
});
const A = /* @__PURE__ */ s$4.forwardRef((r2, t2) => {
  const _a = r2, { allowPinchZoom: n2, portalled: c2 = true } = _a, s2 = __objRest(_a, ["allowPinchZoom", "portalled"]), i2 = E("PopoverContent", r2.__scopePopover), p2 = s$4.useRef(null), u2 = useComposedRefs(t2, p2), l2 = s$4.useRef(false);
  s$4.useEffect(() => {
    const o2 = p2.current;
    if (o2)
      return hideOthers(o2);
  }, []);
  const d2 = c2 ? Portal : s$4.Fragment;
  return s$4.createElement(d2, null, /* @__PURE__ */ s$4.createElement(o$4, { allowPinchZoom: n2 }, /* @__PURE__ */ s$4.createElement(R, _extends({}, s2, { ref: u2, trapFocus: i2.open, disableOutsidePointerEvents: true, onCloseAutoFocus: composeEventHandlers(r2.onCloseAutoFocus, (e2) => {
    var o2;
...
}), O = /* @__PURE__ */ s$4.forwardRef((e2, o2) => {
  const _a = e2, { portalled: r2 = true } = _a, t2 = __objRest(_a, ["portalled"]), n2 = E("PopoverContent", e2.__scopePopover), c2 = s$4.useRef(false), s2 = r2 ? Portal : s$4.Fragment;
  return s$4.createElement(s2, null, /* @__PURE__ */ s$4.createElement(R, _extends({}, t2, { ref: o2, trapFocus: false, disableOutsidePointerEvents: false, onCloseAutoFocus: (o3) => {
    var r3, t3;
...
}), R = /* @__PURE__ */ s$4.forwardRef((e2, o2) => {
  const _a = e2, { __scopePopover: r2, trapFocus: t2, onOpenAutoFocus: n2, onCloseAutoFocus: a2, disableOutsidePointerEvents: u2, onEscapeKeyDown: l2, onPointerDownOutside: d2, onFocusOutside: m2, onInteractOutside: f2 } = _a, C2 = __objRest(_a, ["__scopePopover", "trapFocus", "onOpenAutoFocus", "onCloseAutoFocus", "disableOutsidePointerEvents", "onEscapeKeyDown", "onPointerDownOutside", "onFocusOutside", "onInteractOutside"]), g2 = E("PopoverContent", r2), h = x$1(r2);
  return useFocusGuards(), /* @__PURE__ */ s$4.createElement(FocusScope, { asChild: true, loop: true, trapped: t2, onMountAutoFocus: n2, onUnmountAutoFocus: a2 }, /* @__PURE__ */ s$4.createElement(DismissableLayer, { asChild: true, disableOutsidePointerEvents: u2, onInteractOutside: f2, onEscapeKeyDown: l2, onPointerDownOutside: d2, onFocusOutside: m2, onDismiss: () => g2.onOpenChange(false) }, /* @__PURE__ */ s$4.createElement(Content$3, _extends({ "data-state": w(g2.open), role: "dialog", id: g2.contentId }, h, C2, { ref: o2, style: __spreadProps(__spreadValues({}, C2.style), { "--radix-popover-content-transform-origin": "var(--radix-popper-transform-origin)" }) }))));
});
function w(e2) {
  return e2 ? "open" : "closed";
}
const Root$1 = Popover$1;
const Trigger$1 = PopoverTrigger;
const Content$1 = PopoverContent$1;
const [s, i$2] = createContextScope("ContextMenu", [S$1]);
const x = S$1(), [p$3, C] = s("ContextMenu");
const ContextMenu$1 = (n2) => {
  const { __scopeContextMenu: o2, children: r2, onOpenChange: c2, dir: s2, modal: i2 = true } = n2, [C2, m2] = s$4.useState(false), f2 = l("ContextMenu", o2), d2 = x(o2), M = useCallbackRef$1(c2), R2 = s$4.useCallback((e2) => {
    m2(e2), M(e2);
  }, [M]);
  return f2.isInsideContent ? /* @__PURE__ */ s$4.createElement(p$3, { scope: o2, isRootMenu: false, open: C2, onOpenChange: R2, modal: i2 }, /* @__PURE__ */ s$4.createElement(Sub, _extends({}, d2, { open: C2, onOpenChange: R2 }), r2)) : /* @__PURE__ */ s$4.createElement(p$3, { scope: o2, isRootMenu: true, open: C2, onOpenChange: R2, modal: i2 }, /* @__PURE__ */ s$4.createElement(Root$4, _extends({}, d2, { dir: s2, open: C2, onOpenChange: R2, modal: i2 }), r2));
};
const ContextMenuTrigger = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeContextMenu: r2 } = _a, s2 = __objRest(_a, ["__scopeContextMenu"]), i2 = C("ContextMenuTrigger", r2), p2 = x(r2), l2 = s$4.useRef({ x: 0, y: 0 }), f2 = s$4.useRef({ getBoundingClientRect: () => DOMRect.fromRect(__spreadValues({ width: 0, height: 0 }, l2.current)) }), M = s$4.useRef(0), R2 = s$4.useCallback(() => window.clearTimeout(M.current), []), _2 = (e3) => {
    l2.current = { x: e3.clientX, y: e3.clientY }, i2.onOpenChange(true);
  };
  return s$4.useEffect(() => R2, [R2]), /* @__PURE__ */ s$4.createElement(m$3, { scope: r2, isInsideContent: false }, /* @__PURE__ */ s$4.createElement(Anchor, _extends({}, p2, { virtualRef: f2 })), /* @__PURE__ */ s$4.createElement(Primitive.span, _extends({}, s2, { ref: n2, style: __spreadValues({ WebkitTouchCallout: "none" }, e2.style), onContextMenu: composeEventHandlers(e2.onContextMenu, (e3) => {
    R2(), e3.preventDefault(), _2(e3);
  }), onPointerDown: composeEventHandlers(e2.onPointerDown, d((e3) => {
    R2(), M.current = window.setTimeout(() => _2(e3), 700);
  })), onPointerMove: composeEventHandlers(e2.onPointerMove, d(R2)), onPointerCancel: composeEventHandlers(e2.onPointerCancel, d(R2)), onPointerUp: composeEventHandlers(e2.onPointerUp, d(R2)) })));
});
const [m$3, l] = s("ContextMenuContent", { isInsideContent: false });
const ContextMenuContent = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeContextMenu: o2 } = _a, r2 = __objRest(_a, ["__scopeContextMenu"]), c2 = C("ContextMenuContent", o2), s2 = x(o2), i2 = __spreadProps(__spreadValues({}, r2), { style: __spreadProps(__spreadValues({}, e2.style), { "--radix-context-menu-content-transform-origin": "var(--radix-popper-transform-origin)" }) });
  return s$4.createElement(m$3, { scope: o2, isInsideContent: true }, c2.isRootMenu ? /* @__PURE__ */ s$4.createElement(f$3, _extends({ __scopeContextMenu: o2 }, i2, { ref: n2 })) : /* @__PURE__ */ s$4.createElement(Content$2, _extends({}, s2, i2, { ref: n2 })));
});
const f$3 = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeContextMenu: o2 } = _a, r2 = __objRest(_a, ["__scopeContextMenu"]), c2 = C("ContextMenuContent", o2), s2 = x(o2), i2 = s$4.useRef(false);
  return s$4.createElement(Content$2, _extends({}, s2, r2, { ref: n2, portalled: true, side: "right", sideOffset: 2, align: "start", onCloseAutoFocus: (t2) => {
    var n3;
    (n3 = e2.onCloseAutoFocus) === null || n3 === void 0 || n3.call(e2, t2), !t2.defaultPrevented && i2.current && t2.preventDefault(), i2.current = false;
  }, onInteractOutside: (t2) => {
    var n3;
    (n3 = e2.onInteractOutside) === null || n3 === void 0 || n3.call(e2, t2), t2.defaultPrevented || c2.modal || (i2.current = true);
  } }));
});
const ContextMenuItem = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeContextMenu: o2 } = _a, r2 = __objRest(_a, ["__scopeContextMenu"]), c2 = x(o2);
  return s$4.createElement(Item$2, _extends({}, c2, r2, { ref: n2 }));
});
const ContextMenuTriggerItem = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeContextMenu: o2 } = _a, r2 = __objRest(_a, ["__scopeContextMenu"]), c2 = x(o2);
  return s$4.createElement(SubTrigger, _extends({}, c2, r2, { ref: n2 }));
});
const ContextMenuSeparator = /* @__PURE__ */ s$4.forwardRef((e2, n2) => {
  const _a = e2, { __scopeContextMenu: o2 } = _a, r2 = __objRest(_a, ["__scopeContextMenu"]), c2 = x(o2);
  return s$4.createElement(Separator$2, _extends({}, c2, r2, { ref: n2 }));
});
function d(e2) {
...
const Item$1 = ContextMenuItem;
const TriggerItem = ContextMenuTriggerItem;
const Separator$1 = ContextMenuSeparator;
var link$1 = {};
var router$1 = {};
...
var _react$3 = _interopRequireDefault$2(s__default);
...
var _react$2 = _interopRequireDefault$1(s__default);
...
(function(exports) {
  ...
  var _react2 = _interopRequireDefault2(s__default);
...
var _react = _interopRequireDefault(s__default);
...
const Widget = s__default.forwardRef((_c, ref) => {
  var _d = _c, {
    title,
    version,
    full = false,
...
const Button = s__default.forwardRef((_g, ref) => {
  var _h = _g, {
    as = "button",
    squared,
    rounded,
...
const Separator = s__default.forwardRef((_C, ref) => {
  var props = __objRest2(_C, []);
  return /* @__PURE__ */ jsx$1(Root$6, __spreadProps2(__spreadValues2({
    ref
  }, props), {
    asChild: true,
...
function Progress(props) {
  ...
  const progress = useMemo((_2) => {
    return value / max * 100;
  }, [value, max]);
  return /* @__PURE__ */ jsx$1(Root$3, __spreadProps2(__spreadValues2({}, props), {
    value,
    max,
...
const ListContext = s__default.createContext();
function List(_T) {
  var _U = _T, {
    size = "normal",
    divide = true,
    className
  } = _U, props = __objRest2(_U, [
    "size",
    "divide",
    "className"
  ]);
  return /* @__PURE__ */ jsx$1("ul", {
    ...
    children: /* @__PURE__ */ jsx$1(ListContext.Provider, {
      value: {
        size,
        divide
      },
...
function Item(_V) {
  var _W = _V, {
    className
  } = _W, props = __objRest2(_W, [
    "className"
  ]);
  const {
    size
  } = useContext(ListContext);
  return /* @__PURE__ */ jsx$1("li", __spreadValues2({
...
List.Item = Item;
s__default.createContext();
const ScrollArea = s__default.forwardRef((_ba, ref) => {
  var _ca = _ba, {
    type = "scroll",
    onScroll,
    children
  ...
  return /* @__PURE__ */ jsxs$1(Root$2, __spreadProps2(__spreadValues2({
    ref,
    type
  }, props), {
...
function PopoverContent(_da) {
  ...
  return /* @__PURE__ */ jsx$1(Content$1, __spreadProps2(__spreadValues2({
    sideOffset: 3
  }, props), {
...
const MenuContent = s__default.forwardRef((_fa, ref) => {
...
const MenuItem$1 = s__default.forwardRef((_ha, ref) => {
  var _ia = _ha, {
    item,
    children
...
function ContextMenu(_na) {
  ...
  let TriggerItem$1 = asSubmenu ? TriggerItem : Trigger;
  const [open, setOpen] = useState(false);
  function handlePointerDown(e2) {
    onPointerDown == null ? void 0 : onPointerDown(e2);
  }
  function handlePointerDownOutside(e2) {
    onPointerDownOutside == null ? void 0 : onPointerDownOutside(e2);
  }
  return /* @__PURE__ */ jsxs$1(Root, {
    modal,
    onOpenChange: setOpen,
    children: [/* @__PURE__ */ jsx$1(TriggerItem$1, {
      asChild: asSubmenu,
      onPointerDown: handlePointerDown,
      children: props.children
    }), /* @__PURE__ */ jsx$1(Content, {
      onPointerDownOutside: handlePointerDownOutside,
      asChild: true,
      children: /* @__PURE__ */ jsx$1(MenuContent, {
        children: items == null ? void 0 : items.map((item, i2) => {
          if (typeof item == "object") {
            if (item.items) {
              return /* @__PURE__ */ jsx$1(ContextMenu, {
                asSubmenu: true,
                items: item.items,
                children: /* @__PURE__ */ jsx$1(MenuItem$1, {
                  item
                })
              }, `menu-item-${i2}`);
            } else {
              return /* @__PURE__ */ jsx$1(Item$1, {
                asChild: true,
            ...
            return /* @__PURE__ */ jsx$1(Separator$1, {
              asChild: true,
              children: /* @__PURE__ */ jsx$1(Separator, {
                className: "my-1"
              })
            }, `menu-item-${i2}`);
          } else {
...
const ReactComponent$3 = (props) => /* @__PURE__ */ s$4.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
  viewBox: "0 0 15 15"
}, props), /* @__PURE__ */ s$4.createElement("path", {
  d: "M-158.762,87.6l1.484,4.019h2.125l1.391-4.019Z",
  transform: "translate(163.762 -86.099)",
  fill: "currentColor"
}), /* @__PURE__ */ s$4.createElement("path", {
...
const ReactComponent$2 = (props) => /* @__PURE__ */ s$4.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
...
}), /* @__PURE__ */ s$4.createElement("rect", {
  id: "Rettangolo_1",
...
const ReactComponent$1 = (props) => /* @__PURE__ */ s$4.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
  viewBox: "0 0 15 15",
  fill: "currentColor"
}, props), /* @__PURE__ */ s$4.createElement("rect", {
  id: "Rettangolo_1",
  "data-name": "Rettangolo 1",
  width: 7,
  height: 7,
...
const ReactComponent = (props) => /* @__PURE__ */ s$4.createElement("svg", __spreadValues2({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  width: 15,
  height: 15,
...
const SidebarMenuItem = s__default.forwardRef((_Sa, ref) => {
  var _Ta = _Sa, {
    icon: Icon,
    iconClassName,
    href
...
const DevicePickerTrigger = s__default.forwardRef((_Ua, ref) => {
  var _Va = _Ua, {
    device,
    open
...
const FileManagerContext = s__default.createContext();
...
function FileManagerProvider(props) {
  ...
  useEffect((_2) => {
    ...
    return (_22) => coreSocket.off("file:added", listener);
  }, []);
...
function DirectoryItem(_a) {
  ...
  const isFocused = useMemo((_2) => item.path == focusItemPath, [focusItemPath, item]);
...
function FileItem(_c) {
  ...
  const isFocused = useMemo((_2) => item.path == focusItemPath, [item, focusItemPath]);
  ...
  return /* @__PURE__ */ jsx(List, {
    ...
    children: items == null ? void 0 : items.map((item, i2) => {
      return item.isDir ? /* @__PURE__ */ jsx(DirectoryItem, {
        ...
        dirname: path,
        item
      }, `list-item-${i2}`) : /* @__PURE__ */ jsx(FileItem, {
        "data-path": item.path,
        item,
        onSelect: setFile,
...
function FileManagerWidgetContextMenu(_i) {
  ...
  function handlePointerDown(e2) {
    ...
    e2.preventDefault();
    e2.stopPropagation();
    let itemPath = (_a = e2.target.dataset) == null ? void 0 : _a.path;
    if (!itemPath)
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx(Group, {
      ...
      children: /* @__PURE__ */ jsx("ul", {
        ...
        children: metadata && Object.keys(metadata).map((key, i2) => {
...
function FileManagerTabTopBar() {
  ...
  function handleChangedFile(e2) {
    setPendingFiles((files) => [...files, ...e2.target.files]);
    let filesArray = [...e2.target.files];
    filesArray.forEach((file, i2) => {
      coreSocket.emit("file:add", {
        filename: file.name,
        data: file
      }, (file2) => {
        setPendingFiles((files) => files.splice(i2, 1));
      });
    });
  }
...
class FileManagerClientPlugin extends ClientPlugin$1 {
  components() {
    return {
      tab: IndexPage
    };
