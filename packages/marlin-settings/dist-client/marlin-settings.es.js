...
for (var i$6 = 0; i$6 < chars$1.length; i$6++) {
  lookup$3[chars$1.charCodeAt(i$6)] = i$6;
}
...
var alphabet$1 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), length$1 = 64, map$2 = {}, seed$1 = 0, i$5 = 0, prev$1;
...
function decode$2(str) {
  var decoded = 0;
  for (i$5 = 0; i$5 < str.length; i$5++) {
    decoded = decoded * length$1 + map$2[str.charAt(i$5)];
  }
  return decoded;
}
function yeast$1() {
...
for (; i$5 < length$1; i$5++)
  map$2[alphabet$1[i$5]] = i$5;
...
const Widget = React__default.forwardRef((_c, ref) => {
  ...
  return /* @__PURE__ */ jsxs("div", __spreadProps2(__spreadValues2({
    ref
  }, props), {
...
const ScrollArea = React__default.forwardRef((_ba, ref) => {
  ...
  return /* @__PURE__ */ jsxs(Root$1, __spreadProps2(__spreadValues2({
    ref,
    type
  }, props), {
...
const SidebarMenuItem = React__default.forwardRef((_Sa, ref) => {
  ...
  const contents = /* @__PURE__ */ jsxs(Fragment$1, {
...
class MarlinSettingsClientPlugin extends ClientPlugin$1 {
  deviceComponents(device) {
    return {
      page: {
